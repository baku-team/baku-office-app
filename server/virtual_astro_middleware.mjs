...
import { masterKeySource, masterKeyCtx, getToken } from "./chunks/client_CyzvxOBO.mjs";
...
import { sameOrigin, getSession } from "./chunks/auth_D-SE8ibz.mjs";
import { n as needsConsent } from "./chunks/consent_C9pinaEx.mjs";
import { fileBelongsTo, getFile, saveFile, storageMode } from "./chunks/storage_DxmBTHf3.mjs";
import { b as summarizeTranscript, c as extractInvoiceData, m as makeDocument, w as webSearch, t as transcribeAudio } from "./chunks/media-ai_yvXyejFD.mjs";
import { googleFetch } from "./chunks/google_BfCDtMxp.mjs";
import { r as runAgent } from "./chunks/agent_DnogXGSR.mjs";
import { d as decryptField } from "./chunks/stripe_r-RFTlbb.mjs";
import { verifyPassword } from "./chunks/users_BznQBGZY.mjs";
import { detectProfile } from "./chunks/profiles_D3vLhBYo.mjs";
import { makeAppsApi } from "./chunks/apps_HNyx-taB.mjs";
import "./chunks/index_CpMSUaak.mjs";
...
function cfAgent(ctx) {
  return {
    run: (i) => runAgent(ctx, i.owner, i.text, i.image, i.baseUrl ?? "", i.role ?? "member", { history: i.history, model: i.model, waModel: i.waModel })
  };
}
