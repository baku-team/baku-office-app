...
import { e as defineMiddleware, s as sequence } from "./chunks/sequence_2tuU57vh.mjs";
import { masterKeySource, masterKeyCtx, getToken } from "./chunks/client_DNkcBUdZ.mjs";
import { e as ensureSchema } from "./chunks/migrate_V7u_vL88.mjs";
import { kvPut } from "./chunks/kv_HFVc6CJO.mjs";
import { logDiag } from "./chunks/diag_B7sefss8.mjs";
import { sameOrigin, getSession } from "./chunks/auth_CwvcOiF1.mjs";
import { n as needsConsent } from "./chunks/consent_-MySEBoU.mjs";
import { j as cfMessaging, k as cfAgent, e as cfEgressGateway, m as cfKnowledge, o as cfNotify, q as cfGoogle, t as cfAi, u as cfStorage, v as cfSqlStore } from "./chunks/cf-adapter_EVoG7B4q.mjs";
import { d as decryptField } from "./chunks/stripe_r-RFTlbb.mjs";
import { verifyPassword } from "./chunks/users_0NnH3aXT.mjs";
import { detectProfile } from "./chunks/profiles_D3vLhBYo.mjs";
import { makeAppsApi } from "./chunks/apps_t7uZkVIe.mjs";
import "./chunks/index_C9K-32fF.mjs";
import { r as resolveError, b as appendCode } from "./chunks/errors_DHxjqjD7.mjs";
...
function buildCtx(env2) {
  const ctx = { profile: detectProfile(env2).id, env: env2, db: cfSqlStore(env2), storage: cfStorage(env2), ai: cfAi(env2), google: cfGoogle(env2), notify: cfNotify(env2), messaging: cfMessaging(env2), knowledge: cfKnowledge(env2), egress: { fetch: (req) => cfEgressGateway(env2).appFetch(req) } };
...
function withSec(res, frame = "none") {
  res.headers.set("Content-Security-Policy", frame === "embed" ? CSP_EMBED : frame === "self" ? CSP_PREVIEW : CSP);
...
const onRequest$1 = defineMiddleware(async (context, next) => {
  ...
  try {
    ...
    if (exempt) return withSec(await next(), embeddable ? "embed" : "none");
    ...
    return withSec(await next(), isAdminPreview ? "self" : "none");
  } catch (e) {
