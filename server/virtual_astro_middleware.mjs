...
import { masterKeySource, masterKeyCtx, getToken } from "./chunks/client_BbGjOLTN.mjs";
import { e as ensureSchema } from "./chunks/migrate_BJLPas86.mjs";
import { kvPut } from "./chunks/kv_DEgX1LMf.mjs";
import { logDiag } from "./chunks/diag_DOeJQ78v.mjs";
import { sameOrigin, getSession } from "./chunks/auth_BGTIef-m.mjs";
import { n as needsConsent } from "./chunks/consent_C9pinaEx.mjs";
import { fileBelongsTo, getFile, saveFile, storageMode } from "./chunks/storage_S4P08Enk.mjs";
import { b as summarizeTranscript, c as extractInvoiceData, m as makeDocument, w as webSearch, t as transcribeAudio } from "./chunks/media-ai_BEp2P1pr.mjs";
import { googleFetch } from "./chunks/google_DmyO49bx.mjs";
import { r as runAgent } from "./chunks/agent_D9YR20xg.mjs";
import { d as decryptField } from "./chunks/stripe_r-RFTlbb.mjs";
import { verifyPassword } from "./chunks/users_DsrUvgx3.mjs";
import { detectProfile } from "./chunks/profiles_D3vLhBYo.mjs";
import { makeAppsApi } from "./chunks/apps_DV1esmHZ.mjs";
import "./chunks/index_BvPbBcDJ.mjs";
...
function cfAgent(ctx) {
  return {
    run: (i) => runAgent(ctx, i.owner, i.text, i.image, i.baseUrl ?? "", i.role ?? "member", { history: i.history, model: i.model, waModel: i.waModel, onEvent: i.onEvent })
  };
}
