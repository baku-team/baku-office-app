...
import { masterKeySource, masterKeyCtx, getToken } from "./chunks/client_C23diL6K.mjs";
import { e as ensureSchema } from "./chunks/migrate_BPi7LZPX.mjs";
import { kvPut } from "./chunks/kv_DEgX1LMf.mjs";
import { logDiag } from "./chunks/diag_ul3h80Zr.mjs";
import { sameOrigin, getSession } from "./chunks/auth_CO6Q4ahN.mjs";
import { n as needsConsent } from "./chunks/consent_C9pinaEx.mjs";
import { fileBelongsTo, getFile, saveFile, storageMode } from "./chunks/storage_XAs8LXvN.mjs";
import { b as summarizeTranscript, c as extractInvoiceData, m as makeDocument, w as webSearch, t as transcribeAudio, i as inferApp } from "./chunks/media-ai_BMVK6MY_.mjs";
import { googleFetch } from "./chunks/google_C5gaPtIE.mjs";
import { r as runAgent } from "./chunks/agent_DfoJtlZZ.mjs";
import { d as decryptField } from "./chunks/stripe_r-RFTlbb.mjs";
import { verifyPassword } from "./chunks/users_DtIPLfad.mjs";
import { detectProfile } from "./chunks/profiles_D3vLhBYo.mjs";
import { makeAppsApi } from "./chunks/apps_BVCI0C7p.mjs";
import "./chunks/index_ByOZSNRu.mjs";
...
function cfAi(env2) {
  return {
    infer: (prompt, opts) => inferApp(env2, prompt, opts ?? {}),
...
function cfAgent(ctx) {
  return {
    run: (i) => runAgent(ctx, i.owner, i.text, i.image, i.baseUrl ?? "", i.role ?? "member", { history: i.history, model: i.model, modelId: i.modelId, onEvent: i.onEvent })
  };
}
...
const GUEST_PREFIXES = ["/my-events", "/event", "/lp/", "/site", "/legal"];
const CSP = [
  "default-src 'self'",
