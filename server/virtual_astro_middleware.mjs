...
import { masterKeySource, getToken } from "./chunks/client_CtDgLyHf.mjs";
import { e as ensureSchema } from "./chunks/migrate_CsnaFDdj.mjs";
import { kvPut } from "./chunks/kv_DEN7iKIl.mjs";
import { logDiag } from "./chunks/diag_BjrAYDQX.mjs";
import { sameOrigin, getSession } from "./chunks/auth_CS3Dw_M5.mjs";
import { n as needsConsent } from "./chunks/consent_Cl4WhRHU.mjs";
import { E as buildCtx } from "./chunks/ctx_lLyugAHU.mjs";
...
const onRequest$1 = defineMiddleware(async (context, next) => {
  ...
  try {
    ...
    const r = await next();
    return withSec(r, isAdminPreview ? "self" : "none", context.locals.cspStrict ? strictScriptSrc(context.locals.cspNonce) : void 0);
  } catch (e) {
