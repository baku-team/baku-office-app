...
import { googleStatus, SCOPE_GROUPS } from "./google_Cd9kHlGa.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DYtEz2tN.mjs";
import { getRetentionDays } from "./storage_SJF4hL77.mjs";
const LIMITED_USE = [
