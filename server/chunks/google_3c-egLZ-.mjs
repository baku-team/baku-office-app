...
import { disconnectGoogle, googleStatus, setGoogleGroups, grantedScopeString } from "./google_3FbN9iX7.mjs";
import { getServiceAccountInfo, saveServiceAccount, saveWifConfig, testServiceAccount } from "./google-sa_B2CQeuLi.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "probe") {
    ...
    const { probeGoogleApis } = await import("./google-probe_CxxmR_zn.mjs");
