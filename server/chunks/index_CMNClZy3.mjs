...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_CtcYt0T4.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_BTk_99GX.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_DCf21T5d.mjs"),
    import("./scheduled-tasks_CMqY4YWh.mjs")
  ]);
