...
import { validateDefinition } from "./appdef_CEv9frOa.mjs";
import { g as getAppDesign } from "./external-apps_BP0r-k3z.mjs";
import { p as preflight } from "./preflight_QCmUE_bV.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_kOdKtsGm.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BP0r-k3z.mjs").then((n) => n.B)).recheckDraft(ctx, draftId);
  } catch {
  }
