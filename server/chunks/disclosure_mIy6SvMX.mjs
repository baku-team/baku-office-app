...
import { googleStatus, SCOPE_GROUPS } from "./google_D7EmPNoL.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_VUAIig5T.mjs";
import { getRetentionDays } from "./storage_CbXVbpHY.mjs";
const LIMITED_USE = [
