...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BOITous_.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_AtsJmc9G.mjs";
const SCOPE_GROUPS = {
  calendar: {
