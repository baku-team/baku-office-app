...
import { APP_SCHEMA, validateDefinition } from "./appdef_DpVz8lTO.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_CRTeJApz.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_DE3oxZSo.mjs");
