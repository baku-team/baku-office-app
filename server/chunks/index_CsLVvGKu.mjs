...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { getSession } = await import("./auth_Uj77DqF4.mjs");
  const ses = await getSession(env, Astro2.request);
  if (!ses) return Astro2.redirect("/login", 302);
  const { cachedEntitlement, hasApiKey } = await import("./client_CZasnwOK.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_D1cpdn3R.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_BFYcvNMO.mjs"),
    import("./scheduled-tasks_BZwIxANr.mjs")
  ]);
  ...
  await import("./index_6IcBz0fb.mjs");
