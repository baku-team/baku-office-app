...
import { googleStatus, SCOPE_GROUPS } from "./google_oBiJ_GTh.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_CrHf1MAm.mjs";
import { getRetentionDays } from "./storage_CKfFiifC.mjs";
const LIMITED_USE = [
