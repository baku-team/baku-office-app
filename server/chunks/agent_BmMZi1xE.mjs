...
import { entitlementForGate, getApiKey } from "./client_DQhV0ghx.mjs";
...
import { permissionCatalogText } from "./apps_B4dUPQYx.mjs";
import { A as APP_SCHEMA, o as opCatalogText, j as createDraft, k as installedAppDefs } from "./external-apps_CNvt3_XH.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_q6vBOFl_.mjs";
import { searchDirectory } from "./directory_DzssYF05.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_DoEqeUTS.mjs";
...
import "./index_BqlS6zMg.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_C2VkwvHq.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_DXOAX9me.mjs";
import { r as runInstalledApp } from "./app-runtime_DaCpiG4_.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_Dd3pbF5m.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_C0o2RuAe.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_QpBMzvM_.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_DQhV0ghx.mjs");
