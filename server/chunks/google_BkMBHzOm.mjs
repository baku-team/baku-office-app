...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_RgvQ0ags.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_Clyp4VjA.mjs";
const SCOPE_GROUPS = {
  calendar: {
