...
import { setMaxUploadMb, setRetentionDays } from "./storage_CICsYpDX.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_Dug2zd29.mjs";
import { setStorageLimits } from "./storage-usage_ENs9MHUo.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_DNFPezsI.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_DC71iAvm.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_4RWwxnco.mjs");
