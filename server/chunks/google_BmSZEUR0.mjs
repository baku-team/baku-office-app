...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_Dkd4XO8R.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_C6YZN_C9.mjs";
const SCOPE_GROUPS = {
  calendar: {
