...
import { getToken, hostFetch, getVerifyJwk } from "./client_kiIL6iv0.mjs";
import { r as randomId, v as verifyEnvelope, i as importVerifyKey, p as payloadOf } from "./stripe_r-RFTlbb.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { p as preflight, i as isRunnableDefinition } from "./preflight_CAdpD9_o.mjs";
import { sanitizeRenderHtml, validateDefinition } from "./appdef_Co7mLGGh.mjs";
const MAX_TAGS = 8;
...
async function installLocalApp(ctx, draftId, by) {
  ...
  if (d.definition) {
    try {
      const jsErr = (await import("./appdef_Co7mLGGh.mjs")).checkRenderScripts(JSON.parse(d.definition).render?.html ?? "");
