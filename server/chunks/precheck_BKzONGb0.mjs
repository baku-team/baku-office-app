...
import { validateDefinition } from "./appdef_Dcv8eDih.mjs";
import { g as getAppDesign } from "./external-apps_D8PNCsk4.mjs";
import { p as preflight } from "./preflight_UiodjAm8.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_BtXM-kRu.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_D8PNCsk4.mjs").then((n) => n.B)).recheckDraft(ctx, draftId);
  } catch {
  }
