...
import { googleStatus, SCOPE_GROUPS } from "./google_BkDU5COj.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_B4Wt0CUx.mjs";
import { getRetentionDays } from "./storage_CPYUMyFX.mjs";
const LIMITED_USE = [
