...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_F7ZfSNZF.mjs";
import { n as nowSec } from "./accounting_CtvChRxg.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_8EIe9B3w.mjs";
const SCOPE_GROUPS = {
  calendar: {
