...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_dimZBE3u.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_9RFhZMXX.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_CmsgeHAl.mjs"),
    import("./scheduled-tasks_BZZpr_GR.mjs")
  ]);
