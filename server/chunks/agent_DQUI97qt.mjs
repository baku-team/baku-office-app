...
import { entitlementForGate, getApiKey } from "./client_C0wNwuGo.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_ClbtVSaV.mjs";
import { searchDirectory } from "./directory_DXHs1gfy.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_BFl8qM-S.mjs";
...
import "./index_DbT-Uvf1.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_QvVgNfN0.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_Dav8kQnp.mjs";
import { createDraft } from "./external-apps_K1jUIQ3-.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_B2Rjigaq.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_C0o2RuAe.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_C49hODrk.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_C0wNwuGo.mjs");
