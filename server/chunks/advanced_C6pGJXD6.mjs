...
const $$Advanced = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const entitlement = await (await import("./client_F7ZfSNZF.mjs")).cachedEntitlement(env);
  ...
  const { getAutonomyConfig, ghDeviceAvailable } = await import("./autonomy_BKV_3WZ8.mjs");
  ...
  const { hasApiKey } = await import("./client_F7ZfSNZF.mjs");
  ...
  const { storageMode, maxUploadMb } = await import("./storage_DLqwZ1zD.mjs");
