...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_D6vmRoWk.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_DXN-cGzH.mjs";
const SCOPE_GROUPS = {
  calendar: {
