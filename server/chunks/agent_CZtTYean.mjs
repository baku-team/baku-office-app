...
import { entitlementForGate, getApiKey } from "./client_DuhUR81K.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_jqrfnEGa.mjs";
import { searchDirectory } from "./directory_DwCMH3np.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_DDctJAsU.mjs";
...
import "./index_CFlgHdOa.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_DzDixnY_.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_DMT3ewI0.mjs";
import { createDraft } from "./external-apps_D4Ylp6ZT.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_XTwNNyG7.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_DHyTXnfY.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_BlvwATsr.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_DuhUR81K.mjs");
