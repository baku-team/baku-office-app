...
import { validateDefinition } from "./appdef_CtwKFZ_L.mjs";
import { g as getAppDesign } from "./external-apps_DB-xHIgj.mjs";
import { p as preflight } from "./preflight_BC4pw_bA.mjs";
import { r as runDraftApp } from "./app-runtime_CihOtHn3.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_DB-xHIgj.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
