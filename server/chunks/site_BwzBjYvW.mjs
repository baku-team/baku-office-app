...
import { updatePageMeta, setSitePassword, clearLayout, restoreLayoutVersion, listLayoutVersions, publishLayout, saveLayoutDraft, deleteSite, upsertSite } from "./sites_CIeXjt8a.mjs";
import { r as randomId } from "./stripe_r-RFTlbb.mjs";
import { blockDef } from "./defs_C7dN86-U.mjs";
import { audit } from "./storage_lxsY0y5P.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  switch (b._action) {
    ...
    case "ai_layout": {
      ...
      if (b.ref?.dataB64) {
        const { prepareDevAttachment } = await import("./chat-flow_DR2wzQvS.mjs");
      ...
      const { generateSiteLayout } = await import("./site-ai_DQMTgGJZ.mjs");
