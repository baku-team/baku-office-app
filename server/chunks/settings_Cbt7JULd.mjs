...
import { setMaxUploadMb, setRetentionDays } from "./storage_-SHcSCdW.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_Dst-rRxs.mjs";
import { setStorageLimits } from "./storage-usage_fOWEZwYt.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_D3EAGfGS.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_DrovB8Nb.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_yKbvv-JH.mjs");
