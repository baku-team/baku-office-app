...
import { cachedEntitlement, getApiKey } from "./client_BsuDyowk.mjs";
import { DiscordInbound } from "./discord_QiT67BSn.mjs";
import { r as randomId } from "./stripe_r-RFTlbb.mjs";
import { a as atLeast } from "./types_BVJxqWI9.mjs";
import { joinWithInvite } from "./users_BdDsp2o8.mjs";
import { F as transcribeAudio, G as enqueueSummary, H as verifyLineSignature, I as fetchLineImage, J as lineReply, g as cfEgressGateway } from "./ctx_D0PzYluR.mjs";
import { saveFile } from "./storage_CqwoO7zq.mjs";
...
${t}` : t;
  ...
  if (prompt || msg.image) {
    ...
    const clean = absolutizeInternalLinks(answer.replace(/<!--\s*bo-[\s\S]*?-->/g, "").trim(), baseUrl);
