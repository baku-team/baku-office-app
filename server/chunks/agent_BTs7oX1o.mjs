...
import { entitlementForGate, getApiKey } from "./client_D8olaOjQ.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_BSE9CkvB.mjs";
import { searchDirectory } from "./directory_DnlhvHcs.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_D8dAr5Of.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_B6CIgG92.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_Cy9OjWs1.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_b04y6mfs.mjs";
import { createDraft } from "./external-apps_CG72iIkm.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_BVmuqN4R.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage__IUbXlIy.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_DvFN1iel.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_D8olaOjQ.mjs");
