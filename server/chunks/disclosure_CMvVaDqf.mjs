...
import { googleStatus, SCOPE_GROUPS } from "./google_D4oYGlLh.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_PVO28pUh.mjs";
import { getRetentionDays } from "./storage_DJmKJuaK.mjs";
const LIMITED_USE = [
