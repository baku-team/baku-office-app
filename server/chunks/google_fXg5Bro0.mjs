...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_C6i3Usi3.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_D5xrn4Xr.mjs";
const SCOPE_GROUPS = {
  calendar: {
