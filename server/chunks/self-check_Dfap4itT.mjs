...
import { APP_SCHEMA, validateDefinition } from "./appdef_CEv9frOa.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_7tMaKadi.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_B0LtoEmz.mjs");
