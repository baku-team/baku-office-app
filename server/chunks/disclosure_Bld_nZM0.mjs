...
import { googleStatus, SCOPE_GROUPS } from "./google_SQBWdaD4.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_CUSmsEak.mjs";
import { getRetentionDays } from "./storage_aIMHFm6C.mjs";
const LIMITED_USE = [
