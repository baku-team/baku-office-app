...
import { getSession, canDevelopApps } from "./auth_BgvE5w_L.mjs";
import { l as loadDraft, c as checkDefinition, a as checkTransitions, b as checkSandbox, d as checkFabrication, e as checkRun, f as finalizePrecheck } from "./precheck_Ckv6W-DW.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BZsna514.mjs").then((n) => n.D)).recheckDraft(ctx, draftId);
  } catch {
  }
