...
import { disconnectGoogle, googleStatus, setGoogleGroups, grantedScopeString } from "./google_TofNzP0i.mjs";
import { getServiceAccountInfo, saveServiceAccount, saveWifConfig, testServiceAccount } from "./google-sa_D1D8V9ss.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "probe") {
    ...
    const { probeGoogleApis } = await import("./google-probe_BJovIX9p.mjs");
