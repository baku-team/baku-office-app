...
import { googleStatus, SCOPE_GROUPS } from "./google_BmSZEUR0.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DyaJ2J6C.mjs";
import { getRetentionDays } from "./storage_B3AGfRzZ.mjs";
const LIMITED_USE = [
