...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_DNkcBUdZ.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_CB8w5Olt.mjs";
const SCOPE_GROUPS = {
  calendar: {
