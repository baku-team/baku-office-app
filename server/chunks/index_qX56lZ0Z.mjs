...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_v-7HzW5v.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_Ba681ROT.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_CKIhhc_3.mjs"),
    import("./scheduled-tasks_lXG_EmZ2.mjs")
  ]);
  ...
  const { disabledBuiltins } = await import("./client_v-7HzW5v.mjs");
