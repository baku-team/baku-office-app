...
import { googleStatus, SCOPE_GROUPS } from "./google_DQsk9lPb.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_B2Rjigaq.mjs";
import { getRetentionDays } from "./storage_DLy4Ktsu.mjs";
const LIMITED_USE = [
