...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_DPM1hhZa.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_DtjrdmcF.mjs";
const SCOPE_GROUPS = {
  calendar: {
