...
import { entitlementForGate, getApiKey } from "./client_DpHFYvTj.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_CO0-qhwz.mjs";
import { searchDirectory } from "./directory_CrM7MqJZ.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_Dug2zd29.mjs";
...
import "./index_CNa1iP31.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_6HMFxFSx.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_kLvm90f0.mjs";
import { createDraft } from "./external-apps_DC71iAvm.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_DCLaAb_Q.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_C0o2RuAe.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_4RWwxnco.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_DpHFYvTj.mjs");
