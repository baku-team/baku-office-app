...
import { r as renderTemplate, a as addAttribute, b as renderHead } from "./sequence_I_kcixDX.mjs";
import { env } from "cloudflare:workers";
import { getSession } from "./auth_Ds5bvcuY.mjs";
import { n as needsConsent, H as HOST_TERMS, a as HOST_PRIVACY, I as IMPORTANT_NOTES, C as CONSENT_VERSION } from "./consent_C9pinaEx.mjs";
...
const $$Consent = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (!ses || ses.ctx !== "org" || ses.role !== "admin") return Astro2.redirect("/", 302);
