...
import { googleStatus, SCOPE_GROUPS } from "./google_OVBncGEN.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_B6PpBwOt.mjs";
import { getRetentionDays } from "./storage_Ckp1uovh.mjs";
const LIMITED_USE = [
