...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_DIsDv6Hl.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_Da1iIwW9.mjs";
const SCOPE_GROUPS = {
  calendar: {
