...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { buildLogs } = await import("./diag_-P_u6Fn4.mjs");
...
}, "/home/runner/work/baku-office/baku-office/apps/client/src/pages/settings/build-log/[id].astro", void 0);
const $$file = "/home/runner/work/baku-office/baku-office/apps/client/src/pages/settings/build-log/[id].astro";
