...
import { v as validateDefinition } from "./appdef_CRQzZn2a.mjs";
import { g as getAppDesign } from "./external-apps_CSNxZelj.mjs";
import { p as preflight } from "./preflight_CdN8K1wC.mjs";
import { r as runDraftApp } from "./app-runtime_CLx0S4o8.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_CSNxZelj.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
