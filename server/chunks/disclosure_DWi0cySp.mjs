...
import { googleStatus, SCOPE_GROUPS } from "./google_CMbGNO0m.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BVmno2Ww.mjs";
import { getRetentionDays } from "./storage_lGr9bQlm.mjs";
const LIMITED_USE = [
