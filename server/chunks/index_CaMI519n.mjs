...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const homeActions = isOrg ? [
    ...
    { href: "/personal", label: "メモ", sub: "メモ・領収書・予定", icon: "M12 12a4 4 0 100-8 4 4 0 000 8M4 21a8 8 0 0116 0" },
    { href: "/schedule", label: "予定", sub: "行事・スケジュール", icon: "M4 5h16v15H4zM4 9h16M8 3v4M16 3v4" },
  ...
  const { pollHost, cachedEntitlement, APP_VERSION, nowSec } = await import("./client_BAAgke-T.mjs");
  const { cmpVersion } = await import("./update_Dt5BlIcQ.mjs");
  await import("./index_k1VqsgsM.mjs");
  const { appCatalog, installedAppIds } = await import("./apps_BwnhvvcL.mjs");
  const { getStorageUsage, fmtBytes } = await import("./storage-usage_PTDr3Md4.mjs");
  ...
  const { reviewQueue } = await import("./users_BDmrB2DE.mjs");
  const { backupAlert } = await import("./backup_UAehrS_0.mjs");
