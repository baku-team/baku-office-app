...
import { googleStatus, SCOPE_GROUPS } from "./google_B7zMXAiG.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_CSnBmSgE.mjs";
import { getRetentionDays } from "./storage_D75KjaIu.mjs";
const LIMITED_USE = [
