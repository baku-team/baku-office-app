...
import { $ as $$MoneyTabs } from "./MoneyTabs_BW0_K0jr.mjs";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_DmR_wS5Q.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_C_1axsCz.mjs");
  ...
  const reg = await import("./register_DU3PxBq_.mjs");
