...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_CPa2Fh_W.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_CBzcH790.mjs");
  ...
  const reg = await import("./register_BA6nKCwP.mjs");
