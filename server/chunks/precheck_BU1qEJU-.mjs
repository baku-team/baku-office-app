...
import { validateDefinition } from "./appdef_BJ9kCwMY.mjs";
import { g as getAppDesign } from "./external-apps_Ish93S4w.mjs";
import { p as preflight } from "./preflight_3Vuphe9D.mjs";
import { r as runDraftApp } from "./app-runtime_BZEpu5BE.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_Ish93S4w.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
