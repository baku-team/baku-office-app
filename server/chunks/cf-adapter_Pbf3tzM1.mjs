...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_B9Y_ZULI.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_CI5PBJIR.mjs";
import { googleFetch } from "./google_C21LUKSj.mjs";
import { getApiKey, entitlementForGate } from "./client_CDsrEXRz.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_C3ejEHDJ.mjs";
import { validateDefinition, APP_SCHEMA, RENDER_HTML_MAX, opCatalogText } from "./appdef_1-F7SXGY.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_DXyqh1lj.mjs";
import { searchDirectory } from "./directory_BaxXSRUb.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_CRY8g1ph.mjs";
import { logDiag } from "./diag_Cu0HTcAn.mjs";
import { i as isRunnableDefinition } from "./preflight_CcnkXJfr.mjs";
...
import { g as getAppDesign, m as createDraft, n as repairOutputLiterals, o as getAppMeta, q as setAppMeta, t as suggestAppMeta, v as setAppAllowedRoles, b as listExternalApps, w as installedAppDefs, x as appsBrief } from "./external-apps_B8UBajsg.mjs";
...
import "./index_Cx5zbqbt.mjs";
import { listSkills, runSkill, generateSkill, searchSkills } from "./skills_Di93qhON.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_Bx_tsk5y.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_1ZlBbWQC.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_DN6pGBs1.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_DTOVMTzh.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_C8FDAgNl.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_BFR1GNfp.mjs";
import { p as pushToUser } from "./push_C5nksUjo.mjs";
...
検証エラー：${issueText}`;
  ...
  const finalMsg = `修正案を作成しました（版 ${def.version}・下書き・${phases.length > 1 ? `${doneCount}/${phases.length}工程・` : ""}）。` + (failed.length ? `
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_CDsrEXRz.mjs");
