...
import { $ as $$MoneyTabs } from "./MoneyTabs_BTMUttzf.mjs";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_5TQEU5l1.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_dTyIbTCR.mjs");
  ...
  const reg = await import("./register_Bz-kYCYN.mjs");
