...
import { validateDefinition } from "./appdef_BSsmpZ_I.mjs";
import { g as getAppDesign } from "./external-apps_DahLZ_Ik.mjs";
import { p as preflight } from "./preflight_Bi8TWovV.mjs";
import { r as runDraftApp } from "./app-runtime_C7NQvNhc.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_DahLZ_Ik.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
