...
import { validateDefinition } from "./appdef_glfdKzNP.mjs";
import { g as getAppDesign } from "./external-apps_CbPM17XJ.mjs";
import { p as preflight } from "./preflight_B6xvoL8Q.mjs";
import { r as runDraftApp } from "./app-runtime_CPBwrnUp.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_CbPM17XJ.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
