...
import { googleStatus, SCOPE_GROUPS } from "./google_7flxi-jE.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_xwffYkn2.mjs";
import { getRetentionDays } from "./storage_DD2sf3yv.mjs";
const LIMITED_USE = [
