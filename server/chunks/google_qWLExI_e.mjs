...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_92mF-n-g.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_DexzhZmn.mjs";
const SCOPE_GROUPS = {
  calendar: {
