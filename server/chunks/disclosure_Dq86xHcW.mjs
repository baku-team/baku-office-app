...
import { googleStatus, SCOPE_GROUPS } from "./google_CORWPjcQ.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_Cd55fW6c.mjs";
import { getRetentionDays } from "./storage_CLCFzk9N.mjs";
const LIMITED_USE = [
