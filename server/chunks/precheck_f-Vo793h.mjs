...
import { validateDefinition } from "./appdef_DpVz8lTO.mjs";
import { g as getAppDesign } from "./external-apps_qrcuL6Wt.mjs";
import { p as preflight } from "./preflight_DUmdlXPs.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_xX7P5fP2.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_qrcuL6Wt.mjs").then((n) => n.B)).recheckDraft(ctx, draftId);
  } catch {
  }
