...
import { googleStatus, SCOPE_GROUPS } from "./google_LDFRfhIk.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DK4CePgC.mjs";
import { getRetentionDays } from "./storage_BF4jK8tm.mjs";
const LIMITED_USE = [
