...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_kiIL6iv0.mjs");
  ...
  const agentName = await (await import("./settings_D2rjJD-A.mjs")).getAgentName(env).catch(() => "相棒");
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    import("./settings_D2rjJD-A.mjs"),
    import("./skills_nV6-0Rrb.mjs"),
    import("./scheduled-tasks_BNCTguxx.mjs")
  ]);
