...
import { e as enabledPartIds, r as registeredParts, s as setEnabledPartIds, a as scopeCtx } from "./parts_DlPNdOxI.mjs";
import { disabledBuiltins } from "./client_Cmhn0ct_.mjs";
const PERMISSIONS = [
