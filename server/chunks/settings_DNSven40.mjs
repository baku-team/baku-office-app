...
import { setMaxUploadMb, setRetentionDays } from "./storage_BFo4z168.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_DZAXMsjG.mjs";
import { setStorageLimits } from "./storage-usage_LB-iVO2N.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_ClgaNh4b.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_XyIZEFAM.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_DvQzobx_.mjs");
