...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_Cm6c2326.mjs";
import { n as nowSec } from "./accounting_BipJ8jvJ.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_DevSuP0Z.mjs";
const SCOPE_GROUPS = {
  calendar: {
