...
import { entitlementForGate, getApiKey } from "./client_D9LOZLIb.mjs";
...
import { permissionCatalogText } from "./apps_DXHaPAC7.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_CO4Dwgsd.mjs";
import { searchDirectory } from "./directory_BF_A6aUq.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_Dtnm4DVK.mjs";
...
import "./index_Dwg_RGlI.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_DGeM4o6C.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_DM-2sHgh.mjs";
import { createDraft } from "./external-apps_CbE-JzAr.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_BVmno2Ww.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_C0o2RuAe.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_COkpBDeE.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_D9LOZLIb.mjs");
