...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { getSession } = await import("./auth_rKb6N0iG.mjs");
  const ses = await getSession(env, Astro2.request);
  if (!ses) return Astro2.redirect("/login", 302);
  const { cachedEntitlement, hasApiKey } = await import("./client_BwbWPyEb.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_CrHf1MAm.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_TD47l7Iq.mjs"),
    import("./scheduled-tasks_VwtiR2PL.mjs")
  ]);
  ...
  await import("./index_P1oP4Wh_.mjs");
