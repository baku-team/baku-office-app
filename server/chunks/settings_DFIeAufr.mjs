...
import { setMaxUploadMb, setRetentionDays } from "./storage_yFW5rSlV.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_BvIeCoUM.mjs";
import { setStorageLimits } from "./storage-usage_Cvwo98fW.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_CompEXry.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_Dzh2gxAI.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_Co1PlYfh.mjs");
