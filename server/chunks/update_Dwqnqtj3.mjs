...
const $$Update = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { pollHost, APP_VERSION } = await import("./client_DcvmK-U8.mjs");
  const { hasDeployHook, cmpVersion, getAutoUpdate, getAutoUpdateStatus } = await import("./update_BaY8k7XO.mjs");
