...
import { a as runTriggeredApp } from "./app-runtime_CC00lJRu.mjs";
import { claimEventRun, endEventRun, listTriggeredApps } from "./app-events_DO_v758Y.mjs";
import { a as activeAppDefinition } from "./external-apps_DdRsAqqg.mjs";
...
async function pollGoogleTrigger(env, ctx, appId, t, opts) {
  ...
  for (const item of items) {
    ...
    try {
      const res = await runTriggeredApp(ctx, appId, buildGoogleInputs(t, item), "org", t.screenId, void 0);
