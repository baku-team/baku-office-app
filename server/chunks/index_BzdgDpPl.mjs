...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_G-wMh__R.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_BMo1S9wt.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_B8d7qTgy.mjs"),
    import("./scheduled-tasks_D_uOQ7TC.mjs")
  ]);
