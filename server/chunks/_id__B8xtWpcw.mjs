...
import { c as renderHead, r as renderTemplate, a as addAttribute } from "./sequence_2tuU57vh.mjs";
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { getProject, projectPublicLPs } = await import("./projects_GnqKk175.mjs");
  ...
  if (project && !allowed && Astro2.url.searchParams.get("preview") === "1") {
    const { getSession, canDevelopApps } = await import("./auth_BnN5IZQs.mjs");
...
}, "/home/runner/work/baku-office/baku-office/apps/client/src/pages/hub/[id].astro", void 0);
const $$file = "/home/runner/work/baku-office/baku-office/apps/client/src/pages/hub/[id].astro";
const $$url = "/hub/[id]";
