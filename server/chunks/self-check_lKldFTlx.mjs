...
import { APP_SCHEMA, validateDefinition } from "./appdef_Dcv8eDih.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_DGZitt3L.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_BwbWPyEb.mjs");
