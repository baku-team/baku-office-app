...
import { APP_SCHEMA, validateDefinition } from "./appdef_Bi9EyADK.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_CW76H0U6.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_BZYsk0AP.mjs");
