...
import { googleStatus, SCOPE_GROUPS } from "./google_S8JQkCgN.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BcGgaiPh.mjs";
import { getRetentionDays } from "./storage_DZ4X55g1.mjs";
const LIMITED_USE = [
