...
import { recordUsage, recordTokens } from "./usage__IUbXlIy.mjs";
import { geminiModelId, claudeModelId } from "./config_BOdbJfMp.mjs";
...
${input}` }]
    ...
    await recordTokens(env, "claude", { inputTokens: data2.usage?.input_tokens ?? 0, outputTokens: data2.usage?.output_tokens ?? 0 });
