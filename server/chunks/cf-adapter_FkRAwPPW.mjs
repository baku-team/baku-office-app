...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_D0LOgaub.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_B-wx7836.mjs";
import { googleFetch } from "./google_Bl_9epKM.mjs";
import { getApiKey, entitlementForGate } from "./client_D6vmRoWk.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_WMo-71Y0.mjs";
import { validateDefinition, APP_SCHEMA, RENDER_HTML_MAX, opCatalogText, checkRenderScripts, checkRenderHandlers } from "./appdef_BI745MGV.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_DgCwzRq3.mjs";
import { searchDirectory } from "./directory_F_alVDvv.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_1ohCtSbs.mjs";
import { logDiag } from "./diag_Cu0HTcAn.mjs";
import { i as isRunnableDefinition } from "./preflight_DtMXxocF.mjs";
...
import { g as getAppDesign, m as createDraft, n as repairOutputLiterals, o as getAppMeta, q as setAppMeta, t as suggestAppMeta, i as installLocalApp, v as setAppAllowedRoles, b as listExternalApps, w as installedAppDefs, x as appsBrief } from "./external-apps_B2coGmfm.mjs";
...
import "./index_BVkqyb6o.mjs";
import { listSkills, runSkill, generateSkill, searchSkills } from "./skills_CIogLveV.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_CAbRJv9S.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_BOUdAXoN.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_DN6pGBs1.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_DK0xNjzl.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_DpXA8U-f.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_CQl3wiTL.mjs";
import { p as pushToUser } from "./push_9b3TAHXH.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_D6vmRoWk.mjs");
