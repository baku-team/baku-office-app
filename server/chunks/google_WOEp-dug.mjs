...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_CQaGQZPz.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_B6QIkQei.mjs";
const SCOPE_GROUPS = {
  calendar: {
