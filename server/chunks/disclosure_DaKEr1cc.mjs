...
import { googleStatus, SCOPE_GROUPS } from "./google_D-yhVFDl.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_D4FpV5BK.mjs";
import { getRetentionDays } from "./storage_-SHcSCdW.mjs";
const LIMITED_USE = [
