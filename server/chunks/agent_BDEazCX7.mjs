...
import { entitlementForGate, getApiKey } from "./client_mUx62QP1.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_TSl46Pys.mjs";
import { searchDirectory } from "./directory_Cw_P-SLl.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_3GTpunft.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_BEVH8lA1.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_Rar9cBLH.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_Jlja8b2w.mjs";
import { createDraft } from "./external-apps_Cegz1wdy.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_-lD-XsCx.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage__IUbXlIy.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_Dw9j8Q0j.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_mUx62QP1.mjs");
