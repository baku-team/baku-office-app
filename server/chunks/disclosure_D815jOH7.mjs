...
import { googleStatus, SCOPE_GROUPS } from "./google_Da3nYgjn.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_UVhG5pcl.mjs";
import { getRetentionDays } from "./storage_TBpzvJRs.mjs";
const LIMITED_USE = [
