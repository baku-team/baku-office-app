...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_kiIL6iv0.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_8Vm3zjrx.mjs";
const SCOPE_GROUPS = {
  calendar: {
