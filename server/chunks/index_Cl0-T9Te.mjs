...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_rF0xK8SJ.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_Cvi4mZz2.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_BCPChsQq.mjs"),
    import("./scheduled-tasks__el4Qtq0.mjs")
  ]);
