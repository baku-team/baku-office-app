...
const $$Diagnostics = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { recentDiagnostics, hasRecentLimitError } = await import("./diag_ul3h80Zr.mjs");
  const { listReplies } = await import("./reports_BS_DOKU5.mjs");
