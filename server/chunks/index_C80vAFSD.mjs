...
import { $ as $$MoneyTabs } from "./MoneyTabs_DwTMWpeb.mjs";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_TPDi1U5M.mjs");
  ...
  const { cachedEntitlement } = await import("./client_v-7HzW5v.mjs");
  ...
  const reg = await import("./register_BlDXkx_I.mjs");
