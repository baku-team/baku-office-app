...
import { r as renderComponent, s as spreadAttributes } from "./worker-entry_Dmq6Pkc7.mjs";
...
const $$Membership = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { listMembers, memberStats, FEE_STATUSES, FEE_LABEL } = await import("./membership_CHJIZtTa.mjs");
