...
import { entitlementForGate, getApiKey } from "./client_C9EMiQbG.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_wN1uk3yP.mjs";
import { searchDirectory } from "./directory_D4LUoi2x.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_3J2h8SOe.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_GEt0WlwX.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_B3D8kpxy.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_DKh8jUAh.mjs";
import { createDraft } from "./external-apps_5dY7k4Fx.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_Cu8t67mA.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_DRZj-Rgu.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_C9EMiQbG.mjs");
