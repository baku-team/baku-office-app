...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_dCjt0lxN.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_BrsTwPyF.mjs";
import { googleFetch } from "./google_lTlgwG8J.mjs";
import { getApiKey, entitlementForGate } from "./client_Cl9NskZP.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_CNzxAd3z.mjs";
import { v as validateDefinition, A as APP_SCHEMA, R as RENDER_HTML_MAX, o as opCatalogText } from "./appdef_BaB2Dvgo.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_DsiowxV2.mjs";
import { searchDirectory } from "./directory_cCb5LH-L.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_BfCMTvMN.mjs";
import { logDiag } from "./diag_B7sefss8.mjs";
import { i as isRunnableDefinition } from "./preflight_BCVR172e.mjs";
...
import { m as createDraft, g as getAppDesign, n as getAppMeta, o as setAppMeta, q as suggestAppMeta, t as setAppAllowedRoles, b as listExternalApps, v as installedAppDefs, w as appsBrief } from "./external-apps_BFESc2lw.mjs";
...
import "./index_C6eAEUan.mjs";
import { listSkills, runSkill, generateSkill } from "./skills_kLIU_Fsa.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_fAYOj3g_.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_dF2ZZLH-.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_D3RuFGmp.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_DUqEihO1.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_PJWKMIit.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_BPW7649c.mjs";
import { p as pushToUser } from "./push_GfP7ecfg.mjs";
...
async function editStep(ctx, row, model) {
  ...
  if (!patch) {
    await failBuild(ctx, row, truncated ? explainStop("ai", "修正内容が大きく、AIが1回で生成しきれませんでした（出力上限到達）。", "対象を絞って（例：特定の画面・機能だけ）小分けに再依頼してください。") : explainStop("ai", "AIが修正案を生成できませんでした（応答が空または解釈不能）。", "指示を具体的にして（どの画面の何をどう変えるか）再度お試しください。別のAIモデルへの切替も有効です。"));
    return false;
  }
