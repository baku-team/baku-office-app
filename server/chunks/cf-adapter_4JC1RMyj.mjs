...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_CbXVbpHY.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_DoZ1AeBL.mjs";
import { googleFetch } from "./google_D7EmPNoL.mjs";
import { getApiKey, entitlementForGate } from "./client_BsDvhGkR.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_Bm8taPXR.mjs";
import { validateDefinition, APP_SCHEMA, RENDER_HTML_MAX, opCatalogText, checkRenderScripts, checkRenderHandlers } from "./appdef_B1qN9jxn.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_DpyOj0fu.mjs";
import { searchDirectory } from "./directory_Cjc_Zs9N.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_CW3WdOZ6.mjs";
import { logDiag } from "./diag_Cu0HTcAn.mjs";
import { i as isRunnableDefinition } from "./preflight_BivD_X5O.mjs";
...
import { g as getAppDesign, m as createDraft, n as repairOutputLiterals, o as getAppMeta, q as setAppMeta, t as suggestAppMeta, v as setAppAllowedRoles, b as listExternalApps, w as installedAppDefs, x as appsBrief } from "./external-apps_CbHDX8yf.mjs";
...
import "./index_BSxCgorH.mjs";
import { listSkills, runSkill, generateSkill, searchSkills } from "./skills_DEqinaLX.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_CdAb1bam.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_VUAIig5T.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_DN6pGBs1.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_D8lDF7ys.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_dNzXKLOU.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_Dc5DAy2v.mjs";
import { p as pushToUser } from "./push_BxG6Xc85.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_BsDvhGkR.mjs");
