...
import { getToken, hostFetch, getVerifyJwk } from "./client_BsDvhGkR.mjs";
import { r as randomId, v as verifyEnvelope, i as importVerifyKey, p as payloadOf } from "./stripe_r-RFTlbb.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { p as preflight, i as isRunnableDefinition } from "./preflight_BivD_X5O.mjs";
import { sanitizeRenderHtml, validateDefinition } from "./appdef_B1qN9jxn.mjs";
const MAX_TAGS = 8;
...
async function installLocalApp(ctx, draftId, by) {
  ...
  if (d.definition) {
    try {
      const jsErr = (await import("./appdef_B1qN9jxn.mjs")).checkRenderScripts(JSON.parse(d.definition).render?.html ?? "");
