...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_DuhUR81K.mjs";
import { n as nowSec } from "./accounting_CelDuPQg.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BxX-ApCe.mjs";
const SCOPE_GROUPS = {
  calendar: {
