...
import { validateDefinition } from "./appdef_DGh1-JGZ.mjs";
import { g as getAppDesign } from "./external-apps_2eZp4hU_.mjs";
import { p as preflight } from "./preflight_ASEHdn1V.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_bRf90QxO.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_2eZp4hU_.mjs").then((n) => n.B)).recheckDraft(ctx, draftId);
  } catch {
  }
