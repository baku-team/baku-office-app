...
import { APP_SCHEMA, validateDefinition } from "./appdef_BcH-onZm.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_X5x_Eyo3.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_BjKlgqy9.mjs");
