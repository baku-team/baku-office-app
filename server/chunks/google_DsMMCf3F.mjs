...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_CET1td35.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BziB5E_e.mjs";
const SCOPE_GROUPS = {
  calendar: {
