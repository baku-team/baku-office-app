...
import { googleStatus, SCOPE_GROUPS } from "./google_DsMMCf3F.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BEIUBc29.mjs";
import { getRetentionDays } from "./storage_2nH8kXF8.mjs";
const LIMITED_USE = [
