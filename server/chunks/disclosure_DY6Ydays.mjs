...
import { googleStatus, SCOPE_GROUPS } from "./google_2slYdheC.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_B31azrYa.mjs";
import { getRetentionDays } from "./storage_BW2B_Uds.mjs";
const LIMITED_USE = [
