...
import { m as maybeRenderHead, a as addAttribute, r as renderTemplate, u as unescapeHTML, d as defineScriptVars, F as Fragment, c as renderHead } from "./sequence_2tuU57vh.mjs";
import { r as renderComponent } from "./worker-entry_BZxNlkKO.mjs";
import { $ as $$EventPublic } from "./EventPublic_XuBsBQjh.mjs";
import { s as sanitizeHtml } from "./sanitize_jH0WNw2O.mjs";
import { $ as $$EvIcon } from "./EvIcon_D0EAs1N0.mjs";
import { env } from "cloudflare:workers";
import { $ as $$EventCard } from "./EventCard_CaWdrIBZ.mjs";
import { getPublicPage } from "./public-pages_BcZbBNtO.mjs";
...
const $$EventsBlock = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { block } = Astro2.props;
  const p = block.props;
  const { listPublishedEvents, getPublishedEventBySlug } = await import("./events_DwyrxaTw.mjs");
  let events = [];
