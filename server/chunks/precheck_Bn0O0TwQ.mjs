...
import { validateDefinition } from "./appdef_Dtsrvmbq.mjs";
import { g as getAppDesign } from "./external-apps_OSwLzA_S.mjs";
import { p as preflight } from "./preflight_Oyt6lT9S.mjs";
import { r as runDraftApp } from "./app-runtime_C1TVtNKx.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_OSwLzA_S.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
