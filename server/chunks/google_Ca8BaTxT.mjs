...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_7WfEvhS0.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_V0aCv2CF.mjs";
const SCOPE_GROUPS = {
  calendar: {
