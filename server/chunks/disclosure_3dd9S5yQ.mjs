...
import { googleStatus, SCOPE_GROUPS } from "./google_P0ImrW1X.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_Dd3pbF5m.mjs";
import { getRetentionDays } from "./storage_Dr1tD8-3.mjs";
const LIMITED_USE = [
