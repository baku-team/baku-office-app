...
import { v as validateDefinition } from "./appdef_IUYd_KVi.mjs";
import { g as getAppDesign } from "./external-apps_TTFEFEgh.mjs";
import { p as preflight } from "./preflight_CFiDajXx.mjs";
import { r as runDraftApp } from "./app-runtime_D0aGUFZo.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_TTFEFEgh.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
