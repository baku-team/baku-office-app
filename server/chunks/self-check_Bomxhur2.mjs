...
import { APP_SCHEMA, validateDefinition } from "./appdef_B8ThPYFn.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_VQTsA6SI.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_DVo9lSTr.mjs");
