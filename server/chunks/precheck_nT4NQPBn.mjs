...
import { validateDefinition } from "./appdef_BixVJR78.mjs";
import { g as getAppDesign } from "./external-apps_DtyjwiHH.mjs";
import { p as preflight } from "./preflight_DCt6xhar.mjs";
import { r as runDraftApp } from "./app-runtime_Rckm6XjG.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_DtyjwiHH.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
