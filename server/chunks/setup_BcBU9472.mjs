...
const $$Setup = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { hasApiKey } = await import("./client_BvxaQHJg.mjs");
  const { googleConfigured } = await import("./google_PgIyhE7r.mjs");
  const { getTheme } = await import("./theme_DFty9gzU.mjs");
  const { getBackupState } = await import("./backup_CicElj7l.mjs");
