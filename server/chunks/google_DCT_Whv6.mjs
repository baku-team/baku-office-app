...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_D8olaOjQ.mjs";
import { n as nowSec } from "./accounting_CelDuPQg.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BKYNHkFS.mjs";
const SCOPE_GROUPS = {
  calendar: {
