...
import { googleStatus, SCOPE_GROUPS } from "./google_BQhgr3sk.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_CJ_aE4sG.mjs";
import { getRetentionDays } from "./storage_fwjkKF34.mjs";
const LIMITED_USE = [
