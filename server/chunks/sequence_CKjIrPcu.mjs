...
export {
  ...
  collapseDuplicateSlashes as aO,
  ForbiddenRewrite as aP,
  copyRequest as aQ,
  setOriginPathname as aR,
  isRoute404 as aS,
  isRoute500 as aT,
  collapseDuplicateLeadingSlashes as aU,
  originPathnameSymbol as aV,
  generateCspDigest as aW,
  ASTRO_GENERATOR as aX,
  PrerenderClientAddressNotAvailable as aY,
  ClientAddressNotAvailable as aZ,
  StaticClientAddressNotAvailable as a_,
  ...
  renderSlot as b,
  getCustom404Route as b0,
  appSymbol as b1,
  getProps as b2,
  fetchStateSymbol as b3,
  AstroResponseHeadersReassigned as b4,
  responseSentSymbol as b5,
  getOriginPathname as b6,
  LocalsReassigned as b7,
  INTERNAL_RESPONSE_HEADERS as b8,
  escape as b9,
  isInternalPath as ba,
  collapseDuplicateTrailingSlashes as bb,
  hasFileExtension as bc,
  removeLeadingForwardSlash as bd,
  getRouteGenerator as be,
  SessionStorageInitError as bf,
  SessionStorageSaveError as bg,
  LocalsNotAnObject as bh,
  clientAddressSymbol as bi,
  fileExtension as bj,
  slash as bk,
  routeIsRedirect as bl,
  routeIsFallback as bm,
  getFallbackRoute as bn,
  findRouteToRewrite as bo,
  renderHead as c,
  defineScriptVars as d,
  createRenderInstruction as e,
  defineMiddleware as f,
