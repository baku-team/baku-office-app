...
import { getToken, hostFetch, getVerifyJwk } from "./client_ZR_ELpXg.mjs";
import { r as randomId, v as verifyEnvelope, i as importVerifyKey, p as payloadOf } from "./stripe_r-RFTlbb.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { p as preflight, i as isRunnableDefinition } from "./preflight_Ii7qouRX.mjs";
import { v as validateDefinition, s as sanitizeRenderHtml } from "./appdef_DCyAd7DY.mjs";
const MAX_TAGS = 8;
...
async function deleteLocalApp(ctx, appId, deleteData = false) {
  ...
  await (await import("./public-pages_DpfV0Ofu.mjs")).deletePublicPagesByApp(ctx.env, appId).catch(() => {
  });
...
export {
  ...
  roleCanUseApp as r,
  submitDraft as s,
  setAppAllowedRoles as t,
  uninstallExternal as u,
  installedAppDefs as v,
  appsBrief as w,
  appMeta as x,
  externalApps as y
};
