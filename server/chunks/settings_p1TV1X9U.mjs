...
import { setMaxUploadMb, setRetentionDays } from "./storage_BABOdLp1.mjs";
import { setMemberModel, setAiEngine, setWorkersAiModel, setBookkeepingMode, setCustomPrompt, setNotifyWebhook, setWorkersPaid } from "./settings_BmjoORVR.mjs";
import { setAutonomy, saveAutonomyConfig } from "./autonomy_BWOJJ7c9.mjs";
import { setStorageLimits } from "./storage-usage_Ic6IZxRr.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_BR9A7zOm.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_DeVDLtJQ.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_CLIMKLyN.mjs");
