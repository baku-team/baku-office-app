...
import { setMaxUploadMb, setRetentionDays } from "./storage_DLqwZ1zD.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_BKV_3WZ8.mjs";
import { setStorageLimits } from "./storage-usage_DDEKWLbc.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_DlWFE1gi.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_BhDWDOUK.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_C_YPyh4_.mjs");
