...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_Bp7iwF3-.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_9ZHduN7N.mjs";
const SCOPE_GROUPS = {
  calendar: {
