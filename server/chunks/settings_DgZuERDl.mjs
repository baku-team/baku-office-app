...
import { setMaxUploadMb, setRetentionDays } from "./storage_CLCFzk9N.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_Ox_ebKS-.mjs";
import { setStorageLimits } from "./storage-usage_PTDr3Md4.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_BwnhvvcL.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_CdNfcbEp.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_B7ei6hDX.mjs");
