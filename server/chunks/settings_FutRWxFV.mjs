...
import { setMaxUploadMb, setRetentionDays } from "./storage_Bz3EKlWm.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_vuCzOMhh.mjs";
import { setStorageLimits } from "./storage-usage_ycwW0EeO.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_Diahlliv.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_BQtMb2tw.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_Bp9G15Mo.mjs");
