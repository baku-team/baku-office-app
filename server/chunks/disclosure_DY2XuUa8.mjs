...
import { googleStatus, SCOPE_GROUPS } from "./google_Cr-MU0wf.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BkqwwsDM.mjs";
import { getRetentionDays } from "./storage_CxiQNFHb.mjs";
const LIMITED_USE = [
