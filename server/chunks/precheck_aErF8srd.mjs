...
import { validateDefinition } from "./appdef_Clj7O5Hr.mjs";
import { g as getAppDesign } from "./external-apps_D-px-Ku8.mjs";
import { p as preflight } from "./preflight_CXMNctSN.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_DKMa7UNX.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_D-px-Ku8.mjs").then((n) => n.A)).recheckDraft(ctx, draftId);
  } catch {
  }
