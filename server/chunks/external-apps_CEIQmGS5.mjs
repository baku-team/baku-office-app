...
import { getToken, hostFetch, getVerifyJwk } from "./client_BZYsk0AP.mjs";
import { r as randomId, v as verifyEnvelope, i as importVerifyKey, p as payloadOf } from "./stripe_r-RFTlbb.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { p as preflight, i as isRunnableDefinition } from "./preflight_D18wzMMp.mjs";
import { sanitizeRenderHtml, validateDefinition, isBlockedHost } from "./appdef_Bi9EyADK.mjs";
...
async function installLocalApp(ctx, draftId, by) {
  ...
  if (d.definition) {
    try {
      const jsErr = (await import("./appdef_Bi9EyADK.mjs")).checkRenderScripts(JSON.parse(d.definition).render?.html ?? "");
    ...
    try {
      ...
      if (parsed.render?.isolation === "relaxed") {
        ...
        if (okApproved) {
          ...
          const { createApproval } = await import("./approvals_CqvpClhP.mjs");
...
export {
  ...
  setAppAllowedRoles as x,
  installedAppDefs as y,
  appMeta as z
};
