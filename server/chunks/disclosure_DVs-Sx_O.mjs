...
import { googleStatus, SCOPE_GROUPS } from "./google_qWLExI_e.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_C95zKJ9k.mjs";
import { getRetentionDays } from "./storage_UGqxcZD2.mjs";
const LIMITED_USE = [
