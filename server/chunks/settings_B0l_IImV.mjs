...
import { setMaxUploadMb, setRetentionDays } from "./storage_iZjhVw_T.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_D6iItoV9.mjs";
import { setStorageLimits } from "./storage-usage_C-3xK6OK.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_D2lB-MzN.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_Co6rxvy3.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_CbvjHDq8.mjs");
