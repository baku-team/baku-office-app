...
const PAGE_COLS = "slug,app_id,title,html,fields,allow_files,enabled,created_by,notify_admin,confirm_email,email_field,confirm_subject,confirm_body,price,currency,pay_label,register_mode,auto_approve,collection";
