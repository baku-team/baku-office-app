...
const $$Import = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { listImported } = await import("./import_6cmyvc-e.mjs");
  const { fmtBytes } = await import("./storage-usage_Y492_yZB.mjs");
