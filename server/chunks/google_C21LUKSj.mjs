...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_CDsrEXRz.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_B4X7gB4K.mjs";
const SCOPE_GROUPS = {
  calendar: {
