...
import { setMaxUploadMb, setRetentionDays } from "./storage_BluMveus.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_GLR92U8E.mjs";
import { setStorageLimits } from "./storage-usage_B9EX6Bnq.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_CVbPdOBU.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_DP64nHdo.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_CTLlDinZ.mjs");
