...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BbGjOLTN.mjs";
import { n as nowSec } from "./accounting_CelDuPQg.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_D1diJD1D.mjs";
const SCOPE_GROUPS = {
  calendar: {
