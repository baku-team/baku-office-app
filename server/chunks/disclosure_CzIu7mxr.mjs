...
import { googleStatus, SCOPE_GROUPS } from "./google_C64kqdhG.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_D89ctAwj.mjs";
import { getRetentionDays } from "./storage__hw20N6r.mjs";
const LIMITED_USE = [
