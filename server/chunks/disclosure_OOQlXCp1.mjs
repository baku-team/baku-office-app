...
import { googleStatus, SCOPE_GROUPS } from "./google_Y429FScE.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_Bd9bYc99.mjs";
import { getRetentionDays } from "./storage_DCN_Hros.mjs";
const LIMITED_USE = [
