...
import { $ as $$SiteLockGate, a as $$PublicSite } from "./SiteLockGate_ChaiqIIl.mjs";
const prerender = false;
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$props, $$slots);
  Astro2.self = $$slug;
  const { slug } = Astro2.params;
  const { getPublishedSite, getSite } = await import("./sites_Bjgvb4zb.mjs");
  ...
  const { siteLocked } = await import("./sites_Bjgvb4zb.mjs");
