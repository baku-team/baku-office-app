...
import { googleStatus, SCOPE_GROUPS } from "./google_BZ-HhmWc.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_THcekV6g.mjs";
import { getRetentionDays } from "./storage_Bdf4380v.mjs";
const LIMITED_USE = [
