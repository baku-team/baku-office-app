...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_0Vd7eIvZ.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BLjps7GB.mjs";
const SCOPE_GROUPS = {
  calendar: {
