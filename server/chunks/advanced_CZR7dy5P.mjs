...
const $$Advanced = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const entitlement = await (await import("./client_D9LOZLIb.mjs")).cachedEntitlement(env);
  ...
  const { getAutonomyConfig, ghDeviceAvailable } = await import("./autonomy_Dtnm4DVK.mjs");
  ...
  const { hasApiKey } = await import("./client_D9LOZLIb.mjs");
  ...
  const { storageMode, maxUploadMb } = await import("./storage_lGr9bQlm.mjs");
