...
import { setMaxUploadMb, setRetentionDays } from "./storage_Dr1tD8-3.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_DoEqeUTS.mjs";
import { setStorageLimits } from "./storage-usage_Cf8x-KCR.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_B4dUPQYx.mjs";
import { f as fetchAndInstall, u as uninstallExternal, l as listExternalApps, b as listDrafts, s as submitDraft, d as deleteDraft, c as installLocalApp, e as appVersions, g as activateAppVersion, h as deleteLocalApp } from "./external-apps_CNvt3_XH.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_QpBMzvM_.mjs");
