...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { getSession } = await import("./auth_clq7fc2y.mjs");
  const ses = await getSession(env, Astro2.request);
  if (!ses) return Astro2.redirect("/login", 302);
  const { cachedEntitlement, hasApiKey } = await import("./client_BsuDyowk.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_XkRS78br.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_ChHSVEh7.mjs"),
    import("./scheduled-tasks_DpYoyyG6.mjs")
  ]);
  ...
  await import("./index_D2wnbrnI.mjs");
