...
import { $ as $$EventPublic } from "./EventPublic_JsIOhg6L.mjs";
import { s as sanitizeHtml } from "./sanitize_jH0WNw2O.mjs";
import { $ as $$EvIcon } from "./EvIcon_D0EAs1N0.mjs";
import { env } from "cloudflare:workers";
import { $ as $$EventCard } from "./EventCard_BWj5Z1VE.mjs";
import { getPublicPage } from "./public-pages_CgImd4LL.mjs";
...
const $$EventsBlock = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { block } = Astro2.props;
  const p = block.props;
  const { listPublishedEvents, getPublishedEventBySlug } = await import("./events_B1GsujNA.mjs");
  let events = [];
