...
import { isValidGeminiModel, isValidClaudeModel, isValidOpenAiModel, isValidWorkersAiModel, isValidGrokModel, isValidGithubModelsModel, isValidGroqModel, isValidCerebrasModel, DEFAULT_MODELS } from "./config_D7WVsdyn.mjs";
...
function isMemberModel(v) {
  ...
  return v === "gemini" || v === "claude" || v === "openai" || v === "local" || v === "grok" || v === "github_models" || v === "groq" || v === "cerebras" || isValidGeminiModel(v) || isValidClaudeModel(v) || isValidOpenAiModel(v) || isValidWorkersAiModel(v) || isValidGrokModel(v) || isValidGithubModelsModel(v) || isValidGroqModel(v) || isValidCerebrasModel(v);
}
