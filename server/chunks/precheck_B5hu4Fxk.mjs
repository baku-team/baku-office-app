...
import { v as validateDefinition } from "./appdef_hDA8H9NL.mjs";
import { g as getAppDesign } from "./external-apps_BHSE11sT.mjs";
import { p as preflight } from "./preflight_c48ySkiV.mjs";
import { r as runDraftApp } from "./app-runtime_55Z6KqMD.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BHSE11sT.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
