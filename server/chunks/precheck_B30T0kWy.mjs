...
import { getSession, canDevelopApps } from "./auth_Cki9oGIJ.mjs";
import { l as loadDraft, c as checkDefinition, a as checkTransitions, b as checkSandbox, d as checkFabrication, e as checkRun, f as finalizePrecheck } from "./precheck_SmfSRBYI.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_Dav2SgUe.mjs").then((n) => n.C)).recheckDraft(ctx, draftId);
  } catch {
  }
