...
import { APP_SCHEMA, validateDefinition } from "./appdef_D0-eULfO.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_CtVp9LjS.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_CuoW304l.mjs");
