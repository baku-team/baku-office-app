...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_C9EMiQbG.mjs";
import { n as nowSec } from "./accounting_BipJ8jvJ.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_gpR6U4iD.mjs";
const SCOPE_GROUPS = {
  calendar: {
