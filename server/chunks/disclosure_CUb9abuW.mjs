...
import { googleStatus, SCOPE_GROUPS } from "./google_D6pEN1NA.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_B4dTtRx4.mjs";
import { getRetentionDays } from "./storage_DhH-wMJZ.mjs";
const LIMITED_USE = [
