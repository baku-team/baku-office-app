...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BQbdmWVM.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BQzeudEx.mjs";
const SCOPE_GROUPS = {
  calendar: {
