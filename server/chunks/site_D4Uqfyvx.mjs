...
import { updatePageMeta, setSitePassword, clearLayout, restoreLayoutVersion, listLayoutVersions, publishLayout, saveLayoutDraft, deleteSite, upsertSite } from "./sites_uPzOy8NI.mjs";
import { r as randomId } from "./stripe_r-RFTlbb.mjs";
import { blockDef } from "./defs_C7dN86-U.mjs";
import { audit } from "./storage_B3AGfRzZ.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  switch (b._action) {
    ...
    case "ai_layout": {
      ...
      if (b.ref?.dataB64) {
        const { prepareDevAttachment } = await import("./chat-flow_D-4Q-7AP.mjs");
      ...
      const { generateSiteLayout } = await import("./site-ai_Z4Obw_Qn.mjs");
