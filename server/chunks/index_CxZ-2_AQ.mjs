...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_BvxaQHJg.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_DjXL2gxn.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_C-p2r1-2.mjs"),
    import("./scheduled-tasks_QEdd514b.mjs")
  ]);
