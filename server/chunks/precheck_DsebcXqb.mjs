...
import { validateDefinition } from "./appdef_BI745MGV.mjs";
import { g as getAppDesign } from "./external-apps_B2coGmfm.mjs";
import { p as preflight } from "./preflight_DtMXxocF.mjs";
import { r as runDraftApp } from "./app-runtime_CAbRJv9S.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_B2coGmfm.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
