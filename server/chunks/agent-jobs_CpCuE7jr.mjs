...
import { r as runAgent, n as notifyOwnerDirect } from "./ctx_DwTr64WL.mjs";
import { a as appendMessage, g as getMessages, t as toTurns } from "./chat-sessions_4ZEuV35m.mjs";
  ...
  for (const j of results) {
    ...
    try {
      ...
      if (j.session_id) {
        ...
        if (mid && task.taskId) await (await import("./task-log_DFVySHMg.mjs")).linkTaskMessage(ctx.env, task.taskId, mid);
      }
      if (!delegatedBuild) {
