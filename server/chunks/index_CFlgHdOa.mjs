...
import { b as setReminder, c as remindersPart, i as invoicesPart } from "./invoices_B7etJ8Rd.mjs";
import { a as saveKnowledge, k as knowledgePart } from "./knowledge_DgHZxjua.mjs";
import { calendarPart } from "./calendar_DZa9-ObP.mjs";
import "./google_CAyVckvj.mjs";
const chatApp = {
  id: "chat",
  name: "AIチャット",
  version: "1.0.0",
