...
import { validateDefinition } from "./appdef_Co7mLGGh.mjs";
import { g as getAppDesign } from "./external-apps_B8q51KTm.mjs";
import { p as preflight } from "./preflight_CAdpD9_o.mjs";
import { r as runDraftApp } from "./app-runtime_ClhTyJFR.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_B8q51KTm.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
