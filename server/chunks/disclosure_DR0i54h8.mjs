...
import { googleStatus, SCOPE_GROUPS } from "./google_D_wgy0NO.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_B5cgUMAK.mjs";
import { getRetentionDays } from "./storage_dk4WezxQ.mjs";
const LIMITED_USE = [
