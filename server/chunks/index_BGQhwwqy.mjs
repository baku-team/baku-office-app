...
import { b as setReminder, c as remindersPart, i as invoicesPart } from "./invoices_CSvSDmEM.mjs";
import { a as saveKnowledge, k as knowledgePart } from "./knowledge_Dj79nSwI.mjs";
import { calendarPart } from "./calendar_DZa9-ObP.mjs";
import "./google_OVBncGEN.mjs";
const chatApp = {
  id: "chat",
  name: "AIチャット",
  version: "1.0.0",
