...
import { entitlementForGate, getApiKey } from "./client_DPTfaqTP.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_Bxp1GBUN.mjs";
import { searchDirectory } from "./directory_BErRJVD8.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_Bow6uBXh.mjs";
...
import "./index_BGQhwwqy.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_BTJvMmSe.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_DrEPZmuu.mjs";
import { createDraft } from "./external-apps_DUqwOHps.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_B6PpBwOt.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_C0o2RuAe.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_BUe4Wns5.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_DPTfaqTP.mjs");
