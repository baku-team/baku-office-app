...
import { googleStatus, SCOPE_GROUPS } from "./google_DEemZnx9.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_CQ9pxYJV.mjs";
import { getRetentionDays } from "./storage_DHYPZETu.mjs";
const LIMITED_USE = [
