...
import { $ as $$MoneyTabs } from "./MoneyTabs_UkJ3aV2k.mjs";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_BO4LdvYt.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_C4tL9AHR.mjs");
  ...
  const reg = await import("./register_Bzuh4MdF.mjs");
