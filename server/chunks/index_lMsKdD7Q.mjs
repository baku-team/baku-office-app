...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_DIsDv6Hl.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_C4A7fh0s.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_FkVup65E.mjs"),
    import("./scheduled-tasks_Dp6I0aAQ.mjs")
  ]);
