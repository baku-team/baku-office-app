...
import { getSession, canDevelopApps } from "./auth_CiMMQ0Dd.mjs";
import { l as loadDraft, c as checkDefinition, a as checkTransitions, b as checkSandbox, d as checkFabrication, e as checkRun, f as finalizePrecheck } from "./precheck_Bl3T0xPp.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_h39FFap9.mjs").then((n) => n.C)).recheckDraft(ctx, draftId);
  } catch {
  }
