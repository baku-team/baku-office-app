...
import { googleStatus, SCOPE_GROUPS } from "./google_BXV6NDW8.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DRh9AC7X.mjs";
import { getRetentionDays } from "./storage_Bz3EKlWm.mjs";
const LIMITED_USE = [
