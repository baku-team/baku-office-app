...
import { setMaxUploadMb, setRetentionDays } from "./storage_Ck-RJgTo.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_Bttdvwv3.mjs";
import { setStorageLimits } from "./storage-usage_BGJBsuIr.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_CED2ECDA.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_EkkXvEJS.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_ri432SCb.mjs");
