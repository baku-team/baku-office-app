...
import { $ as $$MoneyTabs } from "./MoneyTabs_RJTyRSaB.mjs";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_CG1mOonk.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_hJXdQlLE.mjs");
  ...
  const reg = await import("./register_DWefA8X9.mjs");
