...
import { r as renderComponent } from "./worker-entry_n-D5bjKY.mjs";
import { env } from "cloudflare:workers";
import { $ as $$App } from "./App_BEkFmXNe.mjs";
...
const $$Apps = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Apps;
  const { getSession } = await import("./auth_CwKWVJ_S.mjs");
  const ses = await getSession(env, Astro2.request);
  if (!ses) return Astro2.redirect("/login", 302);
  const ctx = Astro2.locals.ctx;
  const { canDevelopApps } = await import("./auth_CwKWVJ_S.mjs");
  const isAdminOrg = canDevelopApps(ses.role, ses.ctx);
  const { atLeast, planLabel } = await import("./cf-adapter_Ds_ZQ-Hh.mjs").then((n) => n.y);
  const entitlement = await (await import("./client_BOITous_.mjs")).cachedEntitlement(env).catch(() => "free");
  const okPlan = (minPlan) => !minPlan || atLeast(entitlement, minPlan);
  await import("./index_4iE78nsz.mjs");
  const { appCatalog, installedAppIds, MANDATORY_APPS } = await import("./apps_Du6RRp8T.mjs");
  const { registeredParts } = await import("./parts_DlPNdOxI.mjs").then((n) => n.f);
  const { listExternalApps, listDrafts, installedAppLaunchers } = await import("./external-apps_89S1Hixh.mjs").then((n) => n.y);
  const { storeCatalog, myApps } = await import("./store_Ci1wR722.mjs");
  ...
  const allItems = [
    ...launch.map((l) => ({ href: l.href, label: l.label, app: l.app, icon: firstChar(l.label) })),
  ...
  const folders = await (await import("./settings_BGnJ4d3n.mjs")).getAppFolders(env, ses.uid).catch(() => []);
  ...
  return renderTemplate`${renderComponent($$result, "App", $$App, { "title": "アプリ", "active": "/apps", "denseMobile": true, "data-astro-cid-lo5sges7": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="spread" style="flex-wrap:wrap;gap:12px" data-astro-cid-lo5sges7> <h1 style="margin:0" data-astro-cid-lo5sges7>アプリ</h1> ${isAdminOrg && renderTemplate`<div class="seg" id="apps-seg" role="group" aria-label="表示切替" data-astro-cid-lo5sges7> <button class="seg-opt on" type="button" data-tab="apps" data-astro-cid-lo5sges7>アプリ</button> <button class="seg-opt" type="button" data-tab="store" data-astro-cid-lo5sges7>ストア</button> <button class="seg-opt" type="button" data-tab="gen" data-astro-cid-lo5sges7>生成アプリ</button> </div>`} </div> <div class="apps-panel" data-panel="apps" data-astro-cid-lo5sges7> <div class="card launcher" data-astro-cid-lo5sges7> <div class="launcher-head" data-astro-cid-lo5sges7> <strong data-astro-cid-lo5sges7>アプリ</strong> <div class="launcher-tools" data-astro-cid-lo5sges7> <input id="lf-q" type="search" placeholder="アプリを検索" aria-label="アプリを検索" data-astro-cid-lo5sges7> <button class="btn btn-sm btn-ghost" id="lf-newfolder" type="button" hidden data-astro-cid-lo5sges7>＋ フォルダ</button> <button class="btn btn-sm btn-ghost" id="lf-organize" type="button" aria-pressed="false" data-astro-cid-lo5sges7>整理</button> </div> </div> <p class="muted lf-hint" id="lf-hint" hidden style="font-size:.82rem;margin:.2rem 0 .6rem" data-astro-cid-lo5sges7>「整理」中：各アプリの <strong data-astro-cid-lo5sges7>📁</strong> でフォルダに入れ、フォルダ名で並べ替えできます。もう一度「整理」で完了。</p>  <div id="launcher-root" class="launch-grid"${addAttribute(isAdminOrg ? "1" : "0", "data-admin")} data-astro-cid-lo5sges7></div> <p class="muted" id="launcher-empty" style="font-size:.9rem" hidden data-astro-cid-lo5sges7></p> <div id="launcher-data" hidden${addAttribute(JSON.stringify({ items: launcherItems, folders }), "data-launcher")} data-astro-cid-lo5sges7></div> <noscript> <div class="launch-grid" data-astro-cid-lo5sges7> ${launcherItems.map((l) => renderTemplate`<a class="launch-card"${addAttribute(l.href, "href")}${addAttribute(`--lc-h:${hueOf(l.label)}`, "style")} data-astro-reload data-astro-cid-lo5sges7><span class="lc-icon" aria-hidden="true" data-astro-cid-lo5sges7>${l.icon}</span><span class="lc-label" data-astro-cid-lo5sges7>${l.label}</span><span class="lc-app" data-astro-cid-lo5sges7>${l.app !== l.label ? l.app : " "}</span></a>`)} </div> </noscript> </div> ${isAdminOrg && renderTemplate`<section class="app-manage" data-astro-cid-lo5sges7> <div class="manage-head" data-astro-cid-lo5sges7> <h2 style="margin:0" data-astro-cid-lo5sges7>アプリの管理</h2> <button class="btn btn-primary" id="add-app-btn" type="button" aria-expanded="false" data-astro-cid-lo5sges7>＋ アプリを追加</button> </div> <p class="muted" style="margin:.2rem 0 0" data-astro-cid-lo5sges7>使うアプリの追加・オンオフ・だれが使えるか・削除を、ここでまとめて行えます。</p>  <div class="add-menu card" id="add-menu" hidden data-astro-cid-lo5sges7> <p class="muted" style="margin:0 0 .6rem" data-astro-cid-lo5sges7>どの方法で追加しますか？</p> <div class="add-choices" data-astro-cid-lo5sges7> <button class="add-choice" type="button" id="add-store" data-astro-cid-lo5sges7><span class="ac-emoji" aria-hidden="true" data-astro-cid-lo5sges7>🛍️</span><span class="ac-t" data-astro-cid-lo5sges7>ストアからさがす</span><span class="ac-d" data-astro-cid-lo5sges7>公開されているアプリから選ぶ</span></button> <a class="add-choice" href="/" data-astro-cid-lo5sges7><span class="ac-emoji" aria-hidden="true" data-astro-cid-lo5sges7>✨</span><span class="ac-t" data-astro-cid-lo5sges7>AIに作ってもらう</span><span class="ac-d" data-astro-cid-lo5sges7>「〜するアプリを作って」と相談</span></a> <button class="add-choice" type="button" id="add-csv-btn" data-astro-cid-lo5sges7><span class="ac-emoji" aria-hidden="true" data-astro-cid-lo5sges7>📄</span><span class="ac-t" data-astro-cid-lo5sges7>表（CSV）から作る</span><span class="ac-d" data-astro-cid-lo5sges7>手元の表をアプリに変換</span></button> <button class="add-choice" type="button" id="add-id-btn" data-astro-cid-lo5sges7><span class="ac-emoji" aria-hidden="true" data-astro-cid-lo5sges7>🔗</span><span class="ac-t" data-astro-cid-lo5sges7>配布アプリIDで追加</span><span class="ac-d" data-astro-cid-lo5sges7>配られたアプリIDを入れて追加</span></button> </div>  <div class="add-form" id="add-csv" hidden data-astro-cid-lo5sges7> <p class="muted" style="margin:0 0 .4rem;font-size:.85rem" data-astro-cid-lo5sges7>表（CSV）の1行目を見出しとして読み取り、登録・一覧・編集・削除ができるアプリをAIが作ります。</p> <div class="row" style="flex-wrap:wrap;gap:8px" data-astro-cid-lo5sges7> <input id="csv-name" placeholder="アプリ名（例 顧客台帳）" style="flex:1 1 160px" data-astro-cid-lo5sges7> <input id="csv-file" type="file" accept=".csv,text/csv" style="flex:1 1 200px" data-astro-cid-lo5sges7> <button class="btn btn-primary" id="csv-go" style="flex:0 0 auto" data-astro-cid-lo5sges7>この表から作る</button> </div> <div class="muted" id="csv-msg" style="margin-top:6px;font-size:.85rem" data-astro-cid-lo5sges7></div> </div>  <div class="add-form" id="add-id" hidden data-astro-cid-lo5sges7> <div class="row" data-astro-cid-lo5sges7><input id="ext-id" placeholder="アプリID（例 inventory）" style="flex:1" data-astro-cid-lo5sges7><button class="btn btn-primary" id="fetchApp" style="flex:0 0 auto" data-astro-cid-lo5sges7>追加する</button></div> <p class="muted" style="margin:.4rem 0 0;font-size:.78rem" data-astro-cid-lo5sges7>ほかで配布されたアプリを、IDを入れて追加します（配布元の署名を検証して取り込みます。再デプロイ不要）。</p> </div> </div>  <details class="collapse" data-ck="parts" open data-astro-cid-lo5sges7> <summary class="manage-sub" data-astro-cid-lo5sges7><span data-astro-cid-lo5sges7>使う機能をえらぶ</span><span class="muted" style="font-size:.8rem" data-astro-cid-lo5sges7>${cat.filter((p) => isOn(p.id)).length}/${cat.length} 使用中</span></summary> <div class="card app-install" data-mgmt-list data-astro-cid-lo5sges7> <p class="muted" data-astro-cid-lo5sges7>使う機能を選びます。外すと画面・道具とも消えます（<strong data-astro-cid-lo5sges7>AIチャットは Plus 以上で必須</strong>）。</p> <div class="mgmt-toolbar" data-astro-cid-lo5sges7> <input type="search" class="mgmt-q" placeholder="機能を検索" aria-label="機能を検索" data-astro-cid-lo5sges7> <select class="mgmt-sort" aria-label="並べ替え" data-astro-cid-lo5sges7><option value="default" data-astro-cid-lo5sges7>既定の順</option><option value="name-asc" data-astro-cid-lo5sges7>名前順（あ→ん）</option><option value="name-desc" data-astro-cid-lo5sges7>名前順（ん→あ）</option></select> </div> <div class="mgmt-items" data-astro-cid-lo5sges7> ${cat.map((p) => renderTemplate`<div class="field"${addAttribute(p.name, "data-name")}${addAttribute(`${p.name} ${p.category ?? ""} ${p.description ?? ""}`.toLowerCase(), "data-search")} data-astro-cid-lo5sges7><label data-astro-cid-lo5sges7> <input type="checkbox" class="app-chk"${addAttribute(p.id, "value")}${addAttribute(isOn(p.id), "checked")}${addAttribute(isMust(p.id) || !okPlan(p.minPlan), "disabled")} data-astro-cid-lo5sges7> <strong data-astro-cid-lo5sges7>${p.name}</strong> <span class="muted" data-astro-cid-lo5sges7>v${p.version}${p.category ? `・${p.category}` : ""}${isMust(p.id) ? "・必須" : ""}${p.minPlan && !okPlan(p.minPlan) ? `・要${planLabel(p.minPlan)}` : ""}</span> ${p.description && renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-lo5sges7": true }, { "default": async ($$result3) => renderTemplate`<br data-astro-cid-lo5sges7><span class="muted" style="font-size:.85rem" data-astro-cid-lo5sges7>${p.description}</span>` })}`} ${p.permissions.length > 0 && renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-lo5sges7": true }, { "default": async ($$result3) => renderTemplate`<br data-astro-cid-lo5sges7><span class="muted" style="font-size:.8rem" data-astro-cid-lo5sges7>権限: ${p.permissions.join(" / ")}</span>` })}`} </label></div>`)} </div> <button class="btn btn-primary" id="saveApps" data-astro-cid-lo5sges7>この内容で保存</button> </div> </details>  <details class="collapse" data-ck="ext" open data-astro-cid-lo5sges7> <summary class="manage-sub" data-astro-cid-lo5sges7><span data-astro-cid-lo5sges7>追加したアプリ</span><span class="muted" style="font-size:.8rem" data-astro-cid-lo5sges7>${externalApps.length} 件</span></summary> ${externalApps.length === 0 && renderTemplate`<p class="muted" data-astro-cid-lo5sges7>まだ追加したアプリはありません。上の「＋ アプリを追加」から増やせます。</p>`} ${externalApps.length > 0 && renderTemplate`<div data-mgmt-list data-astro-cid-lo5sges7> <div class="mgmt-toolbar" data-astro-cid-lo5sges7> <input type="search" class="mgmt-q" placeholder="アプリを検索（名前・ID・権限）" aria-label="アプリを検索" data-astro-cid-lo5sges7> <select class="mgmt-sort" aria-label="並べ替え" data-astro-cid-lo5sges7><option value="default" data-astro-cid-lo5sges7>追加が新しい順</option><option value="name-asc" data-astro-cid-lo5sges7>名前順（あ→ん）</option><option value="name-desc" data-astro-cid-lo5sges7>名前順（ん→あ）</option></select> </div> <div class="mgmt-items" data-astro-cid-lo5sges7> ${externalApps.map((a) => renderTemplate`<div class="card mgmt-card"${addAttribute(a.id, "data-ext")}${addAttribute(a.id, "data-roleapp")}${addAttribute(a.allow_fork === 1 && a.source === "store" ? "1" : "0", "data-fork")}${addAttribute(a.name, "data-name")}${addAttribute(`${a.name} ${a.id} ${a.source} ${a.permissions.join(" ")}`.toLowerCase(), "data-search")} data-astro-cid-lo5sges7> <div class="mgmt-top" data-astro-cid-lo5sges7> <div class="mgmt-name" data-astro-cid-lo5sges7> <strong data-astro-cid-lo5sges7>${a.name}</strong> <span class="pill" style="margin-left:6px" data-astro-cid-lo5sges7>${a.source === "store" ? "ストア" : a.forked_from_id ? "自作（派生）" : a.source === "draft" || a.source === "local" ? "自作" : "取り込み"}</span> ${a.allow_fork === 1 && a.source === "store" && renderTemplate`<span class="pill brand" style="margin-left:4px" data-astro-cid-lo5sges7>拡張可</span>`} <div class="muted" style="font-size:.78rem;margin-top:2px" data-astro-cid-lo5sges7><code data-astro-cid-lo5sges7>${a.id}</code>・v${a.version}${a.forked_from_id ? `・派生元: ${a.forked_from_name || a.forked_from_id}` : ""}</div> ${a.permissions.length > 0 && renderTemplate`<div class="muted" style="font-size:.78rem" data-astro-cid-lo5sges7>使う道具: ${a.permissions.join(" / ")}</div>`} </div> <div class="mgmt-actions" data-astro-cid-lo5sges7> <a class="btn btn-sm btn-ghost"${addAttribute("/app/" + a.id, "href")} data-astro-reload data-astro-cid-lo5sges7>開く</a> ${a.allow_fork === 1 && a.source === "store" && renderTemplate`<button class="btn btn-sm btn-ghost ext-fork" data-astro-cid-lo5sges7>派生して開発</button>`} <button class="btn btn-sm btn-ghost ext-hist" data-astro-cid-lo5sges7>履歴</button> <button class="btn btn-sm btn-ghost ext-del" data-astro-cid-lo5sges7>削除</button> </div> </div> <div class="mgmt-roles" data-astro-cid-lo5sges7> <span class="muted" style="font-size:.82rem;font-weight:600" data-astro-cid-lo5sges7>だれが使える：</span> ${ACCESS_ROLES.map(([val, label]) => renderTemplate`<label class="role-chk" data-astro-cid-lo5sges7><input type="checkbox" class="ra-role"${addAttribute(val, "value")}${addAttribute(Array.isArray(a.allowed_roles) && a.allowed_roles.includes(val), "checked")} data-astro-cid-lo5sges7> ${label}</label>`)} <button class="btn btn-sm btn-primary ra-save" style="flex:0 0 auto" data-astro-cid-lo5sges7>保存</button> <span class="muted" style="font-size:.78rem" data-astro-cid-lo5sges7>${accessLabel(a.allowed_roles)}</span> </div> </div>`)} </div> <p class="muted" style="font-size:.78rem;margin:.4rem 0 0" data-astro-cid-lo5sges7>「だれが使える」を<strong data-astro-cid-lo5sges7>すべて外して保存すると「管理者のみ」</strong>になります（誤って全員に公開しないための既定）。全員に公開するには<strong data-astro-cid-lo5sges7>「メンバー」を選択</strong>します。特定の役割を選ぶと、その役割の人だけに表示されます。管理者・開発者は常に使えます。</p> <div id="ext-hist-box" class="card" style="margin-top:.5rem" hidden data-astro-cid-lo5sges7></div> </div>`} </details> </section>`} </div> ${isAdminOrg && renderTemplate`<div class="apps-panel" data-panel="store" hidden data-astro-cid-lo5sges7> <h2 data-astro-cid-lo5sges7>ストア</h2> <p class="muted" data-astro-cid-lo5sges7>ホストが配信する公開アプリ。お使いのプランで入手できるものが表示されます（DL数・評価順）。</p> <div class="row" style="margin:.2rem 0 .8rem" data-astro-cid-lo5sges7><input id="store-q" type="search" placeholder="ストアを検索（名前・説明・カテゴリ）" style="flex:1" aria-label="ストアを検索" data-astro-cid-lo5sges7></div> <div class="grid" id="store-grid" data-astro-cid-lo5sges7> ${store.map((a) => renderTemplate`<div class="card"${addAttribute(a.id, "data-store")}${addAttribute(`${a.name} ${a.description ?? ""} ${a.category ?? ""}`.toLowerCase(), "data-search")} data-astro-cid-lo5sges7> <strong data-astro-cid-lo5sges7>${a.name}</strong> <span class="muted" data-astro-cid-lo5sges7>v${a.version}${a.category ? `・${a.category}` : ""}</span> ${a.badges.map((bd) => renderTemplate`<span class="pill brand" style="margin-left:4px" data-astro-cid-lo5sges7>${bd}</span>`)} ${a.description && renderTemplate`<div class="muted" style="font-size:.85rem;margin-top:2px" data-astro-cid-lo5sges7>${a.description}</div>`} <div class="muted" style="font-size:.8rem;margin-top:4px" data-astro-cid-lo5sges7>DL ${a.downloads} 評価 ${a.avg_rating || "—"}（${a.reviews}）${a.min_entitlement !== "free" ? `　要${a.min_entitlement}` : ""}</div> <div class="row" style="margin-top:6px" data-astro-cid-lo5sges7> <button class="btn btn-primary btn-sm st-get" style="flex:0 0 auto" data-astro-cid-lo5sges7>入手</button> <select class="st-rate" style="flex:0 0 auto" data-astro-cid-lo5sges7><option value="" data-astro-cid-lo5sges7>評価…</option><option value="5" data-astro-cid-lo5sges7>★5</option><option value="4" data-astro-cid-lo5sges7>★4</option><option value="3" data-astro-cid-lo5sges7>★3</option><option value="2" data-astro-cid-lo5sges7>★2</option><option value="1" data-astro-cid-lo5sges7>★1</option></select> </div> </div>`)} ${store.length === 0 && renderTemplate`<p class="muted" data-astro-cid-lo5sges7>公開中のアプリはありません。</p>`} </div> <p class="muted" id="store-empty" style="display:none" data-astro-cid-lo5sges7>該当するアプリがありません。</p> ${mine.length > 0 && renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-lo5sges7": true }, { "default": async ($$result3) => renderTemplate` <h2 data-astro-cid-lo5sges7>自分の提供アプリ（ストア公開）</h2> <div class="card" data-astro-cid-lo5sges7> <p class="muted" data-astro-cid-lo5sges7>承認済みのアプリを任意でストアに公開できます。DL可能な最低プランも設定します。</p> ${mine.map((a) => renderTemplate`<div class="field"${addAttribute(a.id, "data-mine")} data-astro-cid-lo5sges7> <strong data-astro-cid-lo5sges7>${a.name}</strong> <span class="muted" data-astro-cid-lo5sges7>v${a.version}・${a.status}・DL ${a.downloads}・評価 ${a.avg || "—"}</span> ${a.forked_from_id && renderTemplate`<span class="muted" style="font-size:.78rem" data-astro-cid-lo5sges7> 派生元: ${a.forked_from_name || a.forked_from_id}（${a.forked_from_id}）</span>`} ${a.removal_requested ? renderTemplate`<span class="muted" style="font-size:.8rem" data-astro-cid-lo5sges7>（ストア削除を申請済み。ホスト承認後に確定します）</span>` : a.status === "approved" ? renderTemplate`<span class="row" style="margin-top:4px;align-items:center;flex-wrap:wrap" data-astro-cid-lo5sges7> <label data-astro-cid-lo5sges7><input type="checkbox" class="m-listed"${addAttribute(a.listed === 1, "checked")} data-astro-cid-lo5sges7> ストアに公開</label> <select class="m-ent" style="flex:0 0 auto" data-astro-cid-lo5sges7>${ENT_OPTS.map((o) => renderTemplate`<option${addAttribute(o, "value")}${addAttribute(a.min_entitlement === o, "selected")} data-astro-cid-lo5sges7>${o}</option>`)}</select> <label title="他の利用者が、このアプリを導入して派生（拡張開発）し、新しいアプリとして公開申請できるようにします" data-astro-cid-lo5sges7><input type="checkbox" class="m-fork"${addAttribute(a.allow_fork === 1, "checked")} data-astro-cid-lo5sges7> 拡張開発（派生）を許可</label> <button class="btn btn-primary btn-sm m-save" style="flex:0 0 auto" data-astro-cid-lo5sges7>保存</button> <button class="btn btn-ghost btn-sm m-remove" style="flex:0 0 auto" data-astro-cid-lo5sges7>ストアから削除を申請</button> </span>` : renderTemplate`<span class="muted" style="font-size:.8rem" data-astro-cid-lo5sges7>（承認待ち。ホスト承認後に公開できます）</span>`} </div>`)} </div> ` })}`} </div>`}${isAdminOrg && renderTemplate`<div class="apps-panel" data-panel="gen" hidden data-astro-cid-lo5sges7> <h2 data-astro-cid-lo5sges7>生成アプリ</h2> <p class="muted" style="margin:.2rem 0 .6rem" data-astro-cid-lo5sges7>新しく作るときは「アプリ」タブの<strong data-astro-cid-lo5sges7>「＋ アプリを追加」</strong>から（AIに相談／表(CSV)から作る）。ここでは作成済みのアプリの確認・登録・公開申請ができます。</p> <div class="card" data-astro-cid-lo5sges7> <p class="muted" data-astro-cid-lo5sges7>AIチャットで「〜するアプリを作って」と頼むと、ここに生成アプリが並びます。要求権限と事前確認（環境／権限／安全／コスト）を確認し、プレビューで動作確認のうえ自分だけで登録するか、ストアへ公開申請できます。公開申請の前にはセルフチェック（個人情報・破壊的動作・公序良俗・法的問題・過剰コスト）を実行し、通過した場合のみ申請できます。</p> ${drafts.length === 0 && renderTemplate`<p class="muted" data-astro-cid-lo5sges7>生成アプリはありません。<a href="/" data-astro-cid-lo5sges7>AIチャット</a>で「〜するアプリを作って」と頼むと作成できます。</p>`} ${drafts.map((d) => renderTemplate`<div class="card"${addAttribute(d.id, "data-draft")}${addAttribute(`app-${d.id}`, "id")} style="margin:.5rem 0" data-astro-cid-lo5sges7> <strong data-astro-cid-lo5sges7>${d.name}</strong> <span class="muted" data-astro-cid-lo5sges7>v${d.version}</span> <span${addAttribute("pill " + (d.gate_status === "ready" ? "ok" : d.gate_status === "blocked" ? "danger" : ""), "class")}${addAttribute(`状態: ${d.gate_status === "ready" ? "実装可" : d.gate_status === "blocked" ? "ブロック" : "企画中"}`, "aria-label")} data-astro-cid-lo5sges7>${d.gate_status === "ready" ? "実装可" : d.gate_status === "blocked" ? "ブロック" : "企画中"}</span> ${d.selfcheck_status && renderTemplate`<span${addAttribute("pill " + (d.selfcheck_status === "pass" ? "ok" : "danger"), "class")} data-astro-cid-lo5sges7>${d.selfcheck_status === "pass" ? "セルフチェック通過" : "セルフチェック要修正"}</span>`} ${d.forked_from_id && renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-lo5sges7": true }, { "default": async ($$result3) => renderTemplate`<br data-astro-cid-lo5sges7><span class="muted" style="font-size:.8rem" data-astro-cid-lo5sges7>派生元: ${d.forked_from_name || d.forked_from_id}（${d.forked_from_id}${d.forked_from_version ? ` v${d.forked_from_version}` : ""}）</span>` })}`} ${d.spec && renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-lo5sges7": true }, { "default": async ($$result3) => renderTemplate`<br data-astro-cid-lo5sges7><span class="muted" style="font-size:.85rem" data-astro-cid-lo5sges7>仕様: ${d.spec}</span>` })}`} <br data-astro-cid-lo5sges7><span class="muted" style="font-size:.8rem" data-astro-cid-lo5sges7>要求権限: ${d.permissions.join(" / ") || "なし"}</span>  <div class="meta-edit" style="margin-top:.4rem;display:flex;flex-wrap:wrap;gap:.4rem;align-items:center" data-astro-cid-lo5sges7> <span class="muted" style="font-size:.78rem" data-astro-cid-lo5sges7>分類</span> <input class="m-cat"${addAttribute(d.category ?? "", "value")} placeholder="例 集計" style="flex:0 0 130px;padding:5px 8px;font-size:.82rem" data-astro-cid-lo5sges7> <span class="muted" style="font-size:.78rem" data-astro-cid-lo5sges7>タグ</span> <input class="m-tags"${addAttribute((d.tags ?? []).join(", "), "value")} placeholder="カンマ区切り（例 CSV, 月次）" style="flex:1 1 200px;padding:5px 8px;font-size:.82rem" data-astro-cid-lo5sges7> <button class="btn btn-ghost btn-sm m-meta-save" style="flex:0 0 auto" data-astro-cid-lo5sges7>保存</button> <button class="btn btn-ghost btn-sm m-retag" style="flex:0 0 auto" title="AIに分類・タグを付け直してもらう" data-astro-cid-lo5sges7>AIで再付与</button> </div> ${d.preflight && renderTemplate`<ul style="margin:.4rem 0 0;padding-left:1.1rem;font-size:.82rem" data-astro-cid-lo5sges7>${d.preflight.checks.map((c) => renderTemplate`<li class="muted" data-astro-cid-lo5sges7>[${c.status === "ok" ? "可" : c.status === "warn" ? "注意" : "不可"}] ${c.label}：${c.detail}</li>`)}</ul>`} <div class="row" style="margin-top:.4rem;flex-wrap:wrap;gap:.4rem" data-astro-cid-lo5sges7><a${addAttribute("btn btn-primary d-preview" + (d.gate_status !== "ready" ? " is-disabled" : ""), "class")}${addAttribute(d.gate_status === "ready" ? `/app/${d.id}?preview=1` : "#", "href")} data-astro-reload style="flex:0 0 auto" data-astro-cid-lo5sges7>プレビュー・動作確認して登録</a><button class="btn d-local" style="flex:0 0 auto"${addAttribute(d.gate_status !== "ready", "disabled")} title="動作確認を省略して直接登録" data-astro-cid-lo5sges7>そのまま登録</button><button class="btn d-selfcheck" style="flex:0 0 auto"${addAttribute(d.gate_status !== "ready", "disabled")} data-astro-cid-lo5sges7>セルフチェックして公開申請</button>${d.forked_from_id && renderTemplate`<button class="btn btn-ghost d-merge" style="flex:0 0 auto" data-astro-cid-lo5sges7>フォーク元の更新を確認</button>`}<button class="btn btn-ghost d-del" style="flex:0 0 auto" data-astro-cid-lo5sges7>削除</button></div> ${d.forked_from_id && renderTemplate`<div class="mg-box" hidden style="margin-top:.5rem;border-top:1px dashed var(--line,#e5e5e5);padding-top:.5rem" data-astro-cid-lo5sges7><div class="mg-msg muted" style="font-size:.85rem" aria-live="polite" data-astro-cid-lo5sges7></div><div class="mg-actions" hidden style="margin-top:.4rem" data-astro-cid-lo5sges7><button class="btn btn-primary btn-sm mg-apply" style="flex:0 0 auto" data-astro-cid-lo5sges7>この内容で取り込む</button></div></div>`} <div class="sc-box" hidden style="margin-top:.6rem;border-top:1px solid var(--line,#e5e5e5);padding-top:.5rem" data-astro-cid-lo5sges7> <div class="sc-phase muted" style="font-size:.85rem" aria-live="polite" data-astro-cid-lo5sges7></div> <ul class="sc-list" style="margin:.4rem 0 0;padding:0;list-style:none;font-size:.84rem" data-astro-cid-lo5sges7></ul> <div class="sc-actions" hidden style="margin-top:.5rem" data-astro-cid-lo5sges7><button class="btn btn-primary d-submit" style="flex:0 0 auto" data-astro-cid-lo5sges7>この内容で公開申請</button></div> </div> </div>`)} </div> </div>`}  `, "scripts": async ($$result2) => renderTemplate(_a || (_a = __template([`<script data-astro-rerun>
    // セグメント切替（アプリ／ストア／AI生成）。選択タブは保存し、再読込後も維持する。
    (function () {
      ...
      // ディープリンク：?tab=gen で生成アプリタブを開き、#app-<id> の生成アプリへスクロール＆一時ハイライト。
      // （チャットの「ストア申請」ボタンや完了通知からの着地に使う。）
      let deepTab = "";
      try {
      ...
      // 復元：?tab があればそれ、無ければ保存タブ（自動更新で再読込したときに生成アプリタブのままにする）。
      try { const t = deepTab || localStorage.getItem("bo_apps_tab"); if (t && seg.querySelector('.seg-opt[data-tab="' + t + '"]')) activate(t); } catch (e) { /* noop */ }
      ...
      async function pollDrafts() {
        try {
          ...
          if (s !== baseline) { baseline = s; location.reload(); }
        } catch (e) { /* offline */ }
      }
      pollDrafts(); (window.bo?.every ? window.bo.every(pollDrafts, 6000) : setInterval(pollDrafts, 6000));
    })();
    ...
    document.getElementById("csv-go")?.addEventListener("click", async (e) => {
      ...
      msg.textContent = r.ok ? (r.message || "作成を開始しました。") : (r.error || "失敗しました。");
    });
    ...
    document.querySelectorAll("[data-ext]").forEach((tr) => {
      ...
      tr.querySelector(".ext-fork")?.addEventListener("click", async (e) => {
        ...
        const r = await window.bo.api("/api/settings", { _action: "fork_app", appId: id, newName: newName.trim() }, { btn: e.currentTarget, successMsg: "派生アプリを作成しました（「生成アプリ」タブで開発・申請できます）" });
        if (r.ok) { try { localStorage.setItem("bo_apps_tab", "gen"); } catch (_) { /* noop */ } setTimeout(() => location.reload(), 900); }
      });
      ...
      tr.querySelector(".ext-hist")?.addEventListener("click", async (e) => {
        ...
        if (!r.ok) return; const vs = r.versions || [];
        box.hidden = false;
        box.innerHTML = \`<strong>\${id} のバージョン履歴</strong>\` + (vs.length ? vs.map((v) => \`<div class="row" style="justify-content:space-between;margin:.3rem 0;gap:.5rem"><span><code>v\${v.version}</code> <span class="muted" style="font-size:.82rem">\${v.changelog || "（変更ログなし）"}</span></span><button class="btn btn-ghost v-act" data-app="\${id}" data-ver="\${v.version}">この版を有効化</button></div>\`).join("") : '<p class="muted">履歴はありません。</p>');
    ...
    function renderCheck(listEl, c) {
      ...
      li.innerHTML = '<span style="flex:0 0 1.1rem;font-weight:700;color:' + scColor(c.status) + '">' + scIcon(c.status) + '</span>'
        + '<span><strong>' + (c.label || c.key) + '</strong>' + (c.ai ? ' <span class="muted" style="font-size:.75rem">(AI審査)</span>' : '')
        + '<br><span class="muted">' + (c.detail || "") + '</span></span>';
    }
      ...
      try {
        ...
        for (;;) {
          ...
          let i; while ((i = buf.indexOf("\\n\\n")) >= 0) {
            ...
            if (ev.type === "phase") phase.textContent = ev.label;
            ...
            else if (ev.type === "error") { phase.innerHTML = '<span style="color:#c0392b">' + ev.error + '</span>'; btn.disabled = false; }
              ...
              else { const bad = (ev.checks || []).filter((c) => c.status === "fail").map((c) => c.label); phase.innerHTML = '<span style="color:#c0392b;font-weight:700">✗ 申請できません。</span> <span class="muted">次の項目を修正してください：' + (bad.join("、") || "（詳細は上記）") + '。修正後にもう一度実行してください。</span>'; btn.disabled = false; }
            }
          }
        }
    ...
    document.querySelectorAll("[data-draft]").forEach((el) => {
      ...
      el.querySelector(".d-merge")?.addEventListener("click", async (e) => {
        ...
        if (!r.ok) { msg.innerHTML = '<span style="color:#c0392b">' + (r.error || "確認できませんでした。") + '</span>'; return; }
        if (!r.updated) { msg.innerHTML = '<span style="color:#2e7d32">フォーク元(v' + (r.upstreamVersion || "?") + ')に更新はありません。最新です。</span>'; return; }
        if (r.recommend === "merge") { msg.innerHTML = '<strong>フォーク元 v' + r.upstreamVersion + ' に更新があります（AI推奨：取り込み）。</strong><br><span class="muted">' + (r.rationale || "") + '</span>'; actions.hidden = false; }
        else { msg.innerHTML = '<strong>フォーク元 v' + r.upstreamVersion + ' に更新がありますが、AIは取り込みを見送りを推奨します。</strong><br><span class="muted">' + (r.rationale || "") + '</span>'; }
      });
