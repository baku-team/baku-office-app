...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_DUcQGvLc.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_q-C6vxHR.mjs";
import { googleFetch } from "./google_fXg5Bro0.mjs";
import { getApiKey, entitlementForGate } from "./client_C6i3Usi3.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_BLO8JKYO.mjs";
import { validateDefinition, APP_SCHEMA, RENDER_HTML_MAX, opCatalogText } from "./appdef_DFNK-Uyv.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_JZ6PGOfC.mjs";
import { searchDirectory } from "./directory_Bj__yr4q.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_CC6wvzTd.mjs";
import { logDiag } from "./diag_Cu0HTcAn.mjs";
import { i as isRunnableDefinition } from "./preflight_EiN3q0he.mjs";
...
import { g as getAppDesign, m as createDraft, n as repairOutputLiterals, o as getAppMeta, q as setAppMeta, t as suggestAppMeta, v as setAppAllowedRoles, b as listExternalApps, w as installedAppDefs, x as appsBrief } from "./external-apps_isqg69Qv.mjs";
...
import "./index_BwDnm4vX.mjs";
import { listSkills, runSkill, generateSkill, searchSkills } from "./skills_CJKbDfs6.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_ScKG7tYq.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_DVq3o9M5.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_DN6pGBs1.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_DdVDrz-N.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_BGGEwO0x.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_D5ydJxIm.mjs";
import { p as pushToUser } from "./push_CBPrf9XA.mjs";
...
${lines || "（なし）"}`;
  ...
  if (name === "manage_project") {
    const proj = await import("./projects_GnqKk175.mjs");
    const action = String(args.action ?? "");
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_C6i3Usi3.mjs");
