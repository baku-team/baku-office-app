...
import { APP_SCHEMA, validateDefinition } from "./appdef_Clj7O5Hr.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_CH6qhuCH.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_BQbdmWVM.mjs");
