...
import { googleStatus, SCOPE_GROUPS } from "./google_CS5rxal6.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_CjIg_yhG.mjs";
import { getRetentionDays } from "./storage_B4jFnDvF.mjs";
const LIMITED_USE = [
