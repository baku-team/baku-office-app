...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_C1ICAElS.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_Dt1CZ0pl.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_EdVoFJRC.mjs"),
    import("./scheduled-tasks_CQiEWiQY.mjs")
  ]);
