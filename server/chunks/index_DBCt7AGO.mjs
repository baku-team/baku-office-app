...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_DcubbLWL.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_CSnBmSgE.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_CvCwkaW3.mjs"),
    import("./scheduled-tasks_XfQK3VgZ.mjs")
  ]);
  ...
  const { disabledBuiltins } = await import("./client_DcubbLWL.mjs");
