...
import { validateDefinition } from "./appdef_BPWputZt.mjs";
import { g as getAppDesign } from "./external-apps_C2915SQL.mjs";
import { p as preflight } from "./preflight_BffwzSOO.mjs";
import { r as runDraftApp } from "./app-runtime_thLMd8GV.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_C2915SQL.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
