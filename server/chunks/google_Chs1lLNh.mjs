...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_CQSsPpWQ.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_D4ixuJrX.mjs";
const SCOPE_GROUPS = {
  calendar: {
