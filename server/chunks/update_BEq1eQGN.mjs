...
const $$Update = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { pollHost, APP_VERSION } = await import("./client_CCzD9Z58.mjs");
  const { hasDeployHook, cmpVersion, getAutoUpdate, getAutoUpdateStatus } = await import("./update_DkIjVYjn.mjs");
