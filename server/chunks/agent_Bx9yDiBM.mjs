...
import { getAiEngine, getCustomPrompt, getMemberEngine, getWorkersAiModel, maxParallelAgents, agentMaxHops } from "./settings_C2uu0Zu7.mjs";
...
${custom}`].filter(Boolean).join("\n");
  ...
  const want = opts.model ?? await getMemberEngine(env, owner) ?? void 0;
  let model = null;
  let provider = "gemini";
