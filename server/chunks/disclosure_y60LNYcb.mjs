...
import { googleStatus, SCOPE_GROUPS } from "./google_DGoraTXz.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_CWIyC2Ge.mjs";
import { getRetentionDays } from "./storage_BAZ0fe2z.mjs";
const LIMITED_USE = [
