...
import { googleStatus, SCOPE_GROUPS } from "./google_CMAdQG9w.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_Dvu2gt-n.mjs";
import { getRetentionDays } from "./storage_C2XNcZ5b.mjs";
const LIMITED_USE = [
