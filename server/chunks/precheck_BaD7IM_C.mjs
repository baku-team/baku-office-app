...
import { validateDefinition } from "./appdef_DMuHQEU9.mjs";
import { g as getAppDesign } from "./external-apps_CXYObSRd.mjs";
import { p as preflight } from "./preflight_Cm6SEMK5.mjs";
import { r as runDraftApp } from "./app-runtime_CK_Ae6BQ.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_CXYObSRd.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
