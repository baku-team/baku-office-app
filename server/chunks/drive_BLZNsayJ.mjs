...
const $$Drive = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { driveConfigured, driveConnected, driveAvailable, listDriveFiles, getDriveBackup } = await import("./drive_kNuTSby3.mjs");
