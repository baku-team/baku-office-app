...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BXVeeS3h.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_DNcqUJ4j.mjs";
const SCOPE_GROUPS = {
  calendar: {
