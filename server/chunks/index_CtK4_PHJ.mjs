...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_Dkd4XO8R.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_DyaJ2J6C.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_Y3tQgqgi.mjs"),
    import("./scheduled-tasks_gLBHEDJb.mjs")
  ]);
