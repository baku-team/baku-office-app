...
import { setMaxUploadMb, setRetentionDays } from "./storage_S4P08Enk.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_EmlmN_zB.mjs";
import { setStorageLimits } from "./storage-usage_DfoLw8bZ.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_DV1esmHZ.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_C9pBmBBP.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_DjZRqVDa.mjs");
