...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { getSession } = await import("./auth_CVltyN7d.mjs");
  const ses = await getSession(env, Astro2.request);
  if (!ses) return Astro2.redirect("/login", 302);
  const { cachedEntitlement, hasApiKey } = await import("./client_DVo9lSTr.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_CFNy6idE.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_D0kaNE1S.mjs"),
    import("./scheduled-tasks_9RRCMur5.mjs")
  ]);
  ...
  await import("./index_C6kyOQ9r.mjs");
