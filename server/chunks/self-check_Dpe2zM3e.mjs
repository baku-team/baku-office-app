...
import { APP_SCHEMA, validateDefinition } from "./appdef_DGh1-JGZ.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_BzN5Ly8A.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_BV1rSndT.mjs");
