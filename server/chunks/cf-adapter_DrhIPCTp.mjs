...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_COf58ej6.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_Y-kdLxkq.mjs";
import { googleFetch } from "./google_DekoRUfe.mjs";
import { getApiKey, entitlementForGate } from "./client_DSiKbs27.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_Dnwa3KfN.mjs";
import { v as validateDefinition, A as APP_SCHEMA, R as RENDER_HTML_MAX, o as opCatalogText } from "./appdef_C5b3bPt4.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_o2BQz37e.mjs";
import { searchDirectory } from "./directory_BmPh6n73.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_DDldWtVC.mjs";
import { logDiag } from "./diag_Cu0HTcAn.mjs";
import { i as isRunnableDefinition } from "./preflight_FbqObRhF.mjs";
...
import { rebuildPublicPageFromDef, fieldsFromDefinition, renderFormHtml, upsertPublicPage } from "./public-pages_CvPz6VHR.mjs";
import { g as getAppDesign, m as createDraft, n as repairOutputLiterals, o as getAppMeta, q as setAppMeta, t as suggestAppMeta, v as setAppAllowedRoles, b as listExternalApps, w as installedAppDefs, x as appsBrief } from "./external-apps_JQBtFvEn.mjs";
...
import "./index_BehDur4O.mjs";
import { listSkills, runSkill, generateSkill, searchSkills } from "./skills_dC8xdhj5.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_Bk5wFnAF.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_DyBaB6uL.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_DN6pGBs1.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_BLstOCl6.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_C-MGuiyE.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_CyzogZ4L.mjs";
import { p as pushToUser } from "./push_CjmGVani.mjs";
...
async function maybePublishPublicPage(ctx, row, plan, def) {
  ...
  const storedFields = customHtml ? fields.map((f) => ({ ...f, required: false })) : fields;
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_DSiKbs27.mjs");
