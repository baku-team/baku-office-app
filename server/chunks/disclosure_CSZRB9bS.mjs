...
import { googleStatus, SCOPE_GROUPS } from "./google_DyMCFF9E.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BwGLztfK.mjs";
import { getRetentionDays } from "./storage_CT4gbX4d.mjs";
const LIMITED_USE = [
