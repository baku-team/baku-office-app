...
import { validateDefinition } from "./appdef_CtFQjyVf.mjs";
import { g as getAppDesign } from "./external-apps_Bb659Sv7.mjs";
import { p as preflight } from "./preflight_B8FfShri.mjs";
import { r as runDraftApp } from "./app-runtime_1xlsUZZ-.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_Bb659Sv7.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
