...
import { entitlementForGate, getApiKey } from "./client_BNfwKBey.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_DR-3cxoS.mjs";
import { searchDirectory } from "./directory_BoNKg7I8.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_Bttdvwv3.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_B1Ym4BTc.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_B_Mf7bFz.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_PaDc6wA7.mjs";
import { createDraft } from "./external-apps_EkkXvEJS.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_B9QBcRDz.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_ri432SCb.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_BNfwKBey.mjs");
