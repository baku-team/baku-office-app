...
import { googleStatus, SCOPE_GROUPS } from "./google_PgIyhE7r.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DjXL2gxn.mjs";
import { getRetentionDays } from "./storage_B2HA1A74.mjs";
const LIMITED_USE = [
