...
import { validateDefinition } from "./appdef_B6fA1TVE.mjs";
import { g as getAppDesign } from "./external-apps_BcG2B-uJ.mjs";
import { p as preflight } from "./preflight_CJl-ZubK.mjs";
import { r as runDraftApp } from "./app-runtime_C_S6cERW.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BcG2B-uJ.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
