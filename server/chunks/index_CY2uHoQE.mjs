...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_DNkcBUdZ.mjs");
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_D8OS_04X.mjs"),
    import("./scheduled-tasks_CMJqVe-_.mjs")
  ]);
  ...
  const { disabledBuiltins } = await import("./client_DNkcBUdZ.mjs");
