...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BHT8hMec.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BhoCcFTw.mjs";
const SCOPE_GROUPS = {
  calendar: {
