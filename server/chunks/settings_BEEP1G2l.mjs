...
import { setMaxUploadMb, setRetentionDays } from "./storage_Ckp1uovh.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_Bow6uBXh.mjs";
import { setStorageLimits } from "./storage-usage_CCQRMVv0.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_BWa2L1Fq.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_DUqwOHps.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_BUe4Wns5.mjs");
