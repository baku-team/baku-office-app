...
import { getPublicPage, getPublicPageAny, seatsTaken } from "./public-pages_Bg1BWixA.mjs";
import { b as buildPublicFullPage, a as buildFrameSrcdoc, P as PUBLIC_BRIDGE_SDK, c as FRAME_ALLOW, F as FRAME_SANDBOX } from "./app-frame_94JLaJDA.mjs";
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (!page2 && Astro2.url.searchParams.get("preview") === "1") {
    const { getSession, canDevelopApps } = await import("./auth_iZjiHMy7.mjs");
