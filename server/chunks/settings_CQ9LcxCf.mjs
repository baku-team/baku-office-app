...
import { setMaxUploadMb, setRetentionDays } from "./storage_BU1BbtLn.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_DIfeYUj4.mjs";
import { setStorageLimits } from "./storage-usage_C7VQSZdL.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_Dd4rnlyx.mjs";
import { f as fetchAndInstall, u as uninstallExternal, l as listExternalApps, b as listDrafts, s as submitDraft, d as deleteDraft, c as installLocalApp, e as appVersions, g as activateAppVersion, h as deleteLocalApp } from "./external-apps_CMUWRR6d.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_DMZZWw5-.mjs");
