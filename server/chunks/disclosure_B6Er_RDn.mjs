...
import { googleStatus, SCOPE_GROUPS } from "./google_DMwHpGeD.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_T0S0OwSZ.mjs";
import { getRetentionDays } from "./storage_BU1BbtLn.mjs";
const LIMITED_USE = [
