...
import { validateDefinition } from "./appdef_DyM-L_iC.mjs";
import { g as getAppDesign } from "./external-apps_CVNZFet_.mjs";
import { p as preflight } from "./preflight_Crl3xrQ-.mjs";
import { r as runDraftApp } from "./app-runtime_D9zDeAkY.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_CVNZFet_.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
