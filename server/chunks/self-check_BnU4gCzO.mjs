...
import { APP_SCHEMA, validateDefinition } from "./appdef_C5MFUqHH.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_CCYEJicX.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_B_HP_Ex9.mjs");
