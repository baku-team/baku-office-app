...
import { setMaxUploadMb, setRetentionDays } from "./storage_DAcrnttd.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_DEsPVk-8.mjs";
import { setStorageLimits } from "./storage-usage_Bxct6EX_.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_D2wGK6QL.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_BjEpEAVR.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_ozzXUfvP.mjs");
