...
import { googleStatus, SCOPE_GROUPS } from "./google_DffTuEJw.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_CFNy6idE.mjs";
import { getRetentionDays } from "./storage_AVD7qBz2.mjs";
const LIMITED_USE = [
