...
import { r as renderTemplate, m as maybeRenderHead, u as unescapeHTML } from "./sequence_2tuU57vh.mjs";
...
const $$CraftCareer = createComponent(async ($$result, $$props, $$slots) => {
  const { listPublishedEvents, CRAFT_LP_SLUG, CRAFT_LP_DEFAULT } = await import("./events_DjxtE3JE.mjs");
  const { getPublishedSite } = await import("./sites_DoSFEHWo.mjs");
