...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_CPPkK4pl.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_BY28V0AV.mjs");
  ...
  const reg = await import("./register_ODxk2Ngx.mjs");
