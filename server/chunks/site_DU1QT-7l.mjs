...
import { updatePageMeta, setSitePassword, clearLayout, restoreLayoutVersion, listLayoutVersions, publishLayout, saveLayoutDraft, deleteSite, upsertSite } from "./sites_B9Dkn3FV.mjs";
import { r as randomId } from "./stripe_r-RFTlbb.mjs";
import { blockDef } from "./defs_C7dN86-U.mjs";
import { audit } from "./storage_BAZ0fe2z.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  switch (b._action) {
    ...
    case "ai_layout": {
      ...
      const { generateSiteLayout } = await import("./site-ai_gLNgnurA.mjs");
