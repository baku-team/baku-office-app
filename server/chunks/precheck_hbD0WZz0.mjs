...
import { validateDefinition } from "./appdef_TXXgFm_P.mjs";
import { g as getAppDesign } from "./external-apps_BLHrxe4n.mjs";
import { p as preflight } from "./preflight_E1ZLJNyJ.mjs";
import { r as runDraftApp } from "./app-runtime_PC9OT4W-.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BLHrxe4n.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
