...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BCk4EGYy.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_7jAecm_N.mjs";
const SCOPE_GROUPS = {
  calendar: {
