...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_CbtCJxWn.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_CgIuyQZL.mjs";
import { googleFetch } from "./google_Cz4GpstA.mjs";
import { getApiKey, entitlementForGate } from "./client_w07XlKo6.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_BsMJJaFf.mjs";
import { v as validateDefinition, A as APP_SCHEMA, R as RENDER_HTML_MAX, o as opCatalogText } from "./appdef_ClDjnDcw.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_Crze6Nye.mjs";
import { searchDirectory } from "./directory_Co-npAHx.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_ByACQ5wQ.mjs";
import { logDiag } from "./diag_B7sefss8.mjs";
import { i as isRunnableDefinition } from "./preflight_BfyVn2YW.mjs";
...
import { m as createDraft, g as getAppDesign, n as getAppMeta, o as setAppMeta, q as suggestAppMeta, t as setAppAllowedRoles, b as listExternalApps, v as installedAppDefs, w as appsBrief } from "./external-apps_B-0nE2nO.mjs";
...
import "./index_CyuXw7nH.mjs";
import { listSkills, runSkill, generateSkill } from "./skills_BleJbZP4.mjs";
import { c as runInstalledApp, r as runDraftApp, b as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_CHjcQ8A-.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_BPLruks8.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_D3RuFGmp.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_DYucn0P5.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_BmV3NSF3.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_DJOOIjKD.mjs";
import { p as pushToUser } from "./push_DCz7rB5I.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_w07XlKo6.mjs");
