...
import { setMaxUploadMb, setRetentionDays } from "./storage_DAMys_Bo.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_D8dAr5Of.mjs";
import { setStorageLimits } from "./storage-usage_BpC9xa1t.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_C5VHx1eS.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_CG72iIkm.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_DvFN1iel.mjs");
