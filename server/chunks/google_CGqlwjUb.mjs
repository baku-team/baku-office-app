...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_yx4APBBm.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_CCK3bxkv.mjs";
const SCOPE_GROUPS = {
  calendar: {
