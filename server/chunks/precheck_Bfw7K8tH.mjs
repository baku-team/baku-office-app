...
import { validateDefinition } from "./appdef_CAZMqTui.mjs";
import { g as getAppDesign } from "./external-apps_BTUHKH0-.mjs";
import { p as preflight } from "./preflight_Degc5Ajg.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_Bez7jxL1.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BTUHKH0-.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
