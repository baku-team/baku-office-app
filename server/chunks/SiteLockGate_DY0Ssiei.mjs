...
import { $ as $$EventPublic } from "./EventPublic_BgpHl2uE.mjs";
import { s as sanitizeHtml } from "./sanitize_jH0WNw2O.mjs";
import { $ as $$EvIcon } from "./EvIcon_D0EAs1N0.mjs";
import { env } from "cloudflare:workers";
import { $ as $$EventCard } from "./EventCard_Dbfprsvi.mjs";
...
const $$EventsBlock = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { block } = Astro2.props;
  const p = block.props;
  const { listPublishedEvents, getPublishedEventBySlug } = await import("./events_Dj6CojAJ.mjs");
  let events = [];
