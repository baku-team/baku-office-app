...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_CtDgLyHf.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_DJXqAaUw.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_C5anvL9L.mjs"),
    import("./scheduled-tasks_Cj9dcGSC.mjs")
  ]);
