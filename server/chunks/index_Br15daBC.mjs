...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_DcvmK-U8.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_CKLelfj1.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_DO7mIsrT.mjs"),
    import("./scheduled-tasks_DraYHEzu.mjs")
  ]);
