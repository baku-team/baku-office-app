...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BjKlgqy9.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_DfekJPlq.mjs";
const SCOPE_GROUPS = {
  calendar: {
