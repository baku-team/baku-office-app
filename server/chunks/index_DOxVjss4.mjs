...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_92mF-n-g.mjs");
  ...
  const agentName = await (await import("./settings_CBzcH790.mjs")).getAgentName(env).catch(() => "相棒");
  const ttsCloudReady = await (await import("./capabilities_C95zKJ9k.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    import("./settings_CBzcH790.mjs"),
    import("./skills_C6To6NJb.mjs"),
    import("./scheduled-tasks_Dp9dDibn.mjs")
  ]);
