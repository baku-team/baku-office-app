...
import { APP_SCHEMA, validateDefinition } from "./appdef_BexAdeyk.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_fVy9d1St.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_CSBhOn7n.mjs");
