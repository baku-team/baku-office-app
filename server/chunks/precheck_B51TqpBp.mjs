...
import { validateDefinition } from "./appdef_gHLPzpQu.mjs";
import { g as getAppDesign } from "./external-apps_DzHldYd8.mjs";
import { p as preflight } from "./preflight_B8hxzyUM.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_C41xJ6pT.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_DzHldYd8.mjs").then((n) => n.B)).recheckDraft(ctx, draftId);
  } catch {
  }
