...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_K1qefTQL.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_Ceuk86HV.mjs";
import { googleFetch } from "./google_IXW9AIYQ.mjs";
import { getApiKey, entitlementForGate } from "./client_yS3Z_a8H.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_Cem46T0w.mjs";
import { validateDefinition, APP_SCHEMA, RENDER_HTML_MAX, opCatalogText, checkRenderScripts, checkRenderHandlers } from "./appdef_C79luNjF.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_B2w28NsC.mjs";
import { searchDirectory } from "./directory_CWAEdBrY.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_sZnW7wtF.mjs";
import { logDiag } from "./diag_Cu0HTcAn.mjs";
import { i as isRunnableDefinition } from "./preflight_S2KgfM5S.mjs";
...
import { g as getAppDesign, m as createDraft, n as repairOutputLiterals, o as getAppMeta, q as setAppMeta, t as suggestAppMeta, i as installLocalApp, v as setAppAllowedRoles, b as listExternalApps, w as installedAppDefs, x as appsBrief } from "./external-apps_60xKlRS4.mjs";
...
import "./index_CpFO7isQ.mjs";
import { listSkills, runSkill, generateSkill, searchSkills } from "./skills_D9wlkxZT.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_4aWxYQ2t.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_BYTVEltU.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_DN6pGBs1.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_C8BHkv5v.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_DkMhM7L4.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_8-Zu6NvX.mjs";
import { p as pushToUser } from "./push_uhagTMOU.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_yS3Z_a8H.mjs");
