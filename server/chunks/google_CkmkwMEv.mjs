...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_C1dOp0Cn.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BfehJ1ZU.mjs";
const SCOPE_GROUPS = {
  calendar: {
