...
import { googleStatus, SCOPE_GROUPS } from "./google_CljRQN3C.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_D1cpdn3R.mjs";
import { getRetentionDays } from "./storage_Czk76zwb.mjs";
const LIMITED_USE = [
