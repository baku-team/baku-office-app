...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_DQhV0ghx.mjs";
import { n as nowSec } from "./accounting_CtvChRxg.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_DY2TFLxm.mjs";
const SCOPE_GROUPS = {
  calendar: {
