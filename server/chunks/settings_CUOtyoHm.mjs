...
import { setMaxUploadMb, setRetentionDays } from "./storage_IXeHfBaF.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_3J2h8SOe.mjs";
import { setStorageLimits } from "./storage-usage_Ba3wilzZ.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_Br_IjkaX.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_5dY7k4Fx.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_DRZj-Rgu.mjs");
