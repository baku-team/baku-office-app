...
import { googleStatus, SCOPE_GROUPS } from "./google_C1mdkR6d.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BjVny2_a.mjs";
import { getRetentionDays } from "./storage_BGXYQVtj.mjs";
const LIMITED_USE = [
