...
import { validateDefinition } from "./appdef_DkBpW8rV.mjs";
import { g as getAppDesign } from "./external-apps_DO3nkheO.mjs";
import { p as preflight } from "./preflight_DvOhvy-f.mjs";
import { r as runDraftApp } from "./app-runtime_CAb-nSV_.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_DO3nkheO.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
