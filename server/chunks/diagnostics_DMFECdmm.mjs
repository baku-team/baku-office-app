...
const $$Diagnostics = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { recentDiagnostics, hasRecentLimitError } = await import("./diag_8r20ZCMR.mjs");
  const { listReplies } = await import("./reports_DjKNMk5R.mjs");
