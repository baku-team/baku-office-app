...
import { validateDefinition } from "./appdef_BrFbYECV.mjs";
import { g as getAppDesign } from "./external-apps_BLW-izfW.mjs";
import { p as preflight } from "./preflight_5uXD-icA.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_ClpUQl5j.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BLW-izfW.mjs").then((n) => n.B)).recheckDraft(ctx, draftId);
  } catch {
  }
