...
import { validateDefinition } from "./appdef_CabiUCP9.mjs";
import { g as getAppDesign } from "./external-apps_Czv7yIer.mjs";
import { p as preflight } from "./preflight_-ArRKcgp.mjs";
import { r as runDraftApp } from "./app-runtime_CF9yqU5O.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_Czv7yIer.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
