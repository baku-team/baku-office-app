...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_Cmhn0ct_.mjs");
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_DM9DEYF0.mjs"),
    import("./scheduled-tasks_bQ3j85_t.mjs")
  ]);
  ...
  const { disabledBuiltins } = await import("./client_Cmhn0ct_.mjs");
