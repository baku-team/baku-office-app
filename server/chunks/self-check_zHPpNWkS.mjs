...
import { APP_SCHEMA, validateDefinition } from "./appdef_CtwKFZ_L.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_DWmuHuDh.mjs";
import { p as preflight } from "./preflight_BC4pw_bA.mjs";
