...
import { validateDefinition } from "./appdef_BU9G7jMa.mjs";
import { g as getAppDesign } from "./external-apps_BEfZxNjt.mjs";
import { p as preflight } from "./preflight_CIgoUVeB.mjs";
import { r as runDraftApp } from "./app-runtime_DZH8q7_o.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BEfZxNjt.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
