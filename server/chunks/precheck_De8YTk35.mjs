...
import { validateDefinition } from "./appdef_D8zxSW3L.mjs";
import { g as getAppDesign } from "./external-apps_Dn5Vnq79.mjs";
import { p as preflight } from "./preflight_CEq_HrxL.mjs";
import { r as runDraftApp } from "./app-runtime_SgHsgCoy.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_Dn5Vnq79.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
