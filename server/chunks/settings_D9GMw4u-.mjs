...
import { setMaxUploadMb, setRetentionDays } from "./storage_BpMEfKKE.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_Xy0bMs3x.mjs";
import { setStorageLimits } from "./storage-usage_BZdkfaAd.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_Be-sZMiJ.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_Czt0ODSr.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_pnaiZOyL.mjs");
