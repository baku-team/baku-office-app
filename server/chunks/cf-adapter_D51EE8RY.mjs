...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_DZNylPHb.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_kFpsqPcH.mjs";
import { googleFetch } from "./google_BkvrPDvs.mjs";
import { getApiKey, entitlementForGate } from "./client_CdSGakTK.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_sdCYmWZn.mjs";
import { validateDefinition, APP_SCHEMA, RENDER_HTML_MAX, opCatalogText, checkRenderScripts, checkRenderHandlers } from "./appdef_B6fA1TVE.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_GWXcRvF4.mjs";
import { searchDirectory } from "./directory_HITHxp-J.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_CFln3Tmy.mjs";
import { logDiag } from "./diag_Cu0HTcAn.mjs";
import { i as isRunnableDefinition } from "./preflight_CJl-ZubK.mjs";
...
import { g as getAppDesign, m as createDraft, n as repairOutputLiterals, o as getAppMeta, q as setAppMeta, t as suggestAppMeta, v as setAppAllowedRoles, b as listExternalApps, w as installedAppDefs, x as appsBrief } from "./external-apps_BcG2B-uJ.mjs";
...
import "./index_BmteSGwA.mjs";
import { listSkills, runSkill, generateSkill, searchSkills } from "./skills_2dHViOoe.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_C_S6cERW.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_A7HHJcFs.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_DN6pGBs1.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_iJ2BASBk.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_ClyOEoCZ.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_sJBBi1nt.mjs";
import { p as pushToUser } from "./push_9rYg6Cs2.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_CdSGakTK.mjs");
