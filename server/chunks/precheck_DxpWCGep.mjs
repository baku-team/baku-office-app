...
import { validateDefinition } from "./appdef_BcH-onZm.mjs";
import { g as getAppDesign } from "./external-apps_xzpbaRmZ.mjs";
import { p as preflight } from "./preflight_CJgoml1U.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_CN9lQNXj.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_xzpbaRmZ.mjs").then((n) => n.B)).recheckDraft(ctx, draftId);
  } catch {
  }
