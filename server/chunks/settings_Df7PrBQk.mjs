...
import { setMaxUploadMb, setRetentionDays } from "./storage_BocuNd5z.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_DKs0ZAVL.mjs";
import { setStorageLimits } from "./storage-usage_Y492_yZB.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_B5O5FLC5.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_CETWOrmK.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_BnTnOHbv.mjs");
