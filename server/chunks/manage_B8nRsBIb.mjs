...
import { moderate, setPublicEnabled, setRegisterMode, getPublicPageAny, deletePublicPage } from "./public-pages_CvPz6VHR.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b.action === "rebuild") {
    ...
    const { rebuildPublicPage } = await import("./cf-adapter_DrhIPCTp.mjs").then((n) => n.C);
