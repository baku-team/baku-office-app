...
import { setMaxUploadMb, setRetentionDays } from "./storage_BE5gVdDk.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_dgWq63qy.mjs";
import { setStorageLimits } from "./storage-usage_CCHasFVt.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_3gQVojvb.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_ivWyFtIy.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_DYBGnNYj.mjs");
