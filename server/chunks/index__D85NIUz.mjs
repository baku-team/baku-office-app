...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_ZR_ELpXg.mjs");
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_DTmnzVV7.mjs"),
    import("./scheduled-tasks_1abFOwhQ.mjs")
  ]);
  ...
  const { disabledBuiltins } = await import("./client_ZR_ELpXg.mjs");
