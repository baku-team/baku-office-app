...
import { setMaxUploadMb, setRetentionDays } from "./storage_DLy4Ktsu.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_BFl8qM-S.mjs";
import { setStorageLimits } from "./storage-usage_LzIpyIdO.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_DFrbpPbI.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_K1jUIQ3-.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_C49hODrk.mjs");
