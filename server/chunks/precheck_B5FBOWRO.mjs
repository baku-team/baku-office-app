...
import { validateDefinition } from "./appdef_BTKTsCnS.mjs";
import { g as getAppDesign } from "./external-apps_Dr0mvakg.mjs";
import { p as preflight } from "./preflight_BT97NqXu.mjs";
import { r as runDraftApp } from "./app-runtime_DSH4t3zk.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_Dr0mvakg.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
