...
import { validateDefinition } from "./appdef_BexAdeyk.mjs";
import { g as getAppDesign } from "./external-apps_CfvnGFDu.mjs";
import { p as preflight } from "./preflight_0kD82fK8.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_D5f_9wYJ.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_CfvnGFDu.mjs").then((n) => n.B)).recheckDraft(ctx, draftId);
  } catch {
  }
