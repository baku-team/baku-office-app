...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_C0wNwuGo.mjs";
import { n as nowSec } from "./accounting_CtvChRxg.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BOYCuXhc.mjs";
const SCOPE_GROUPS = {
  calendar: {
