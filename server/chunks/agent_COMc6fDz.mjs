...
import { entitlementForGate, getApiKey } from "./client_CryjS_8W.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_B6jWMKby.mjs";
import { searchDirectory } from "./directory_C2JRDOkl.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_vuCzOMhh.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_CyzQ5YzI.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_BCxkHEBP.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_Bptvt3fb.mjs";
import { createDraft } from "./external-apps_BQtMb2tw.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_DRh9AC7X.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_Bp9G15Mo.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_CryjS_8W.mjs");
