...
import { googleStatus, SCOPE_GROUPS } from "./google_lTlgwG8J.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_dF2ZZLH-.mjs";
import { getRetentionDays } from "./storage_dCjt0lxN.mjs";
const LIMITED_USE = [
