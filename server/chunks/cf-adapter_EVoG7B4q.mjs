...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_Dvmn3unV.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_BPiGF2W1.mjs";
import { googleFetch } from "./google_B00iOqPm.mjs";
import { getApiKey, entitlementForGate } from "./client_DNkcBUdZ.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_t7uZkVIe.mjs";
import { v as validateDefinition, A as APP_SCHEMA, R as RENDER_HTML_MAX, o as opCatalogText } from "./appdef_Cj1nrG-j.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_Cy9suYn1.mjs";
import { searchDirectory } from "./directory_DTVeUqLr.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_CF68La6g.mjs";
import { logDiag } from "./diag_B7sefss8.mjs";
import { i as isRunnableDefinition } from "./preflight_CEwKbZpm.mjs";
...
import { m as createDraft, g as getAppDesign, n as getAppMeta, o as setAppMeta, q as suggestAppMeta, t as setAppAllowedRoles, b as listExternalApps, v as installedAppDefs, w as appsBrief } from "./external-apps_CIfdV394.mjs";
...
import "./index_C9K-32fF.mjs";
import { listSkills, runSkill, generateSkill } from "./skills_D8OS_04X.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_CHZMrXsU.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_BxI33RuM.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_D3RuFGmp.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_BkEgDZ_T.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_0NnH3aXT.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_DvqXLdov.mjs";
import { p as pushToUser } from "./push_B57PXcTq.mjs";
