...
import { googleStatus, SCOPE_GROUPS } from "./google_fh8uE04S.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DId0R5ou.mjs";
import { getRetentionDays } from "./storage_BgjO-NRr.mjs";
const LIMITED_USE = [
