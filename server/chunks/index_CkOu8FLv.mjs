...
import { $ as $$MoneyTabs } from "./MoneyTabs_CCPWpxyU.mjs";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_DCMxpdwM.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_DHOyCLdr.mjs");
  ...
  const reg = await import("./register_BUQNbn5h.mjs");
