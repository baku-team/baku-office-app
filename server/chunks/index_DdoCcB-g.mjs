...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_C5A1-cK5.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_Bmfmicjq.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_B8OBBW4E.mjs"),
    import("./scheduled-tasks_DbZNiN2O.mjs")
  ]);
  ...
  const { disabledBuiltins } = await import("./client_C5A1-cK5.mjs");
