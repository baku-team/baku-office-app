...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_CJh_mVEi.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_CDen6ceU.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_BDuQsvY0.mjs"),
    import("./scheduled-tasks_CMOJeEu7.mjs")
  ]);
