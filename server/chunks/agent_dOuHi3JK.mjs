...
import { entitlementForGate, getApiKey } from "./client_BAAgke-T.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_1SnJ6fUi.mjs";
import { searchDirectory } from "./directory_YGEgTs_n.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_Ox_ebKS-.mjs";
...
import "./index_k1VqsgsM.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_BlDux7ZT.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_CGtz7Ft8.mjs";
import { createDraft } from "./external-apps_CdNfcbEp.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_Cd55fW6c.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_B3QOJ1kB.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_B7ei6hDX.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_BAAgke-T.mjs");
