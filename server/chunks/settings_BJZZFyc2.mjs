...
import { setMaxUploadMb, setRetentionDays } from "./storage_lGr9bQlm.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_Dtnm4DVK.mjs";
import { setStorageLimits } from "./storage-usage_BUInF2zJ.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_DXHaPAC7.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_CbE-JzAr.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_COkpBDeE.mjs");
