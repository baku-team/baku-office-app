...
import { googleStatus, SCOPE_GROUPS } from "./google_DOlylB8O.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_Bk39abXV.mjs";
import { getRetentionDays } from "./storage_B11Nmez-.mjs";
const LIMITED_USE = [
