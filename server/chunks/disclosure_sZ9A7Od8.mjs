...
import { googleStatus, SCOPE_GROUPS } from "./google_CB8FnbZ9.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BWaHqP09.mjs";
import { getRetentionDays } from "./storage_BbJRuC4n.mjs";
const LIMITED_USE = [
