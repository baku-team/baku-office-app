...
import { googleStatus, SCOPE_GROUPS } from "./google_DftucxS4.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_XkRS78br.mjs";
import { getRetentionDays } from "./storage_CqwoO7zq.mjs";
const LIMITED_USE = [
