...
import { validateDefinition } from "./appdef_C79luNjF.mjs";
import { g as getAppDesign } from "./external-apps_60xKlRS4.mjs";
import { p as preflight } from "./preflight_S2KgfM5S.mjs";
import { r as runDraftApp } from "./app-runtime_4aWxYQ2t.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_60xKlRS4.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
