...
import { APP_SCHEMA, validateDefinition } from "./appdef_gHLPzpQu.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_DF9qKz49.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_0pHY0CaD.mjs");
