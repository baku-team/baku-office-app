...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_DHYPZETu.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_CDxd25Ab.mjs";
import { googleFetch } from "./google_DEemZnx9.mjs";
import { getApiKey, entitlementForGate } from "./client_TWPTdJdo.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_B3yfw8OL.mjs";
import { v as validateDefinition, A as APP_SCHEMA, R as RENDER_HTML_MAX, o as opCatalogText } from "./appdef_GTIHHGas.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_AOcWAybX.mjs";
import { searchDirectory } from "./directory_DzSY8SKM.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_Ds5oncnk.mjs";
import { logDiag } from "./diag_B7sefss8.mjs";
import { i as isRunnableDefinition } from "./preflight_rrEo9oPH.mjs";
...
import { m as createDraft, g as getAppDesign, n as getAppMeta, o as setAppMeta, q as suggestAppMeta, t as setAppAllowedRoles, b as listExternalApps, v as installedAppDefs, w as appsBrief } from "./external-apps_Dd7ZbSkI.mjs";
...
import "./index_wR0izv-9.mjs";
import { listSkills, runSkill, generateSkill } from "./skills_DYHIsxL3.mjs";
import { c as runInstalledApp, r as runDraftApp, b as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_BFYpvBKg.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_CQ9pxYJV.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_D3RuFGmp.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals__X7hszL7.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_E4kYmseI.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_IIr3WvUX.mjs";
import { p as pushToUser } from "./push_BYdZeUMY.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_TWPTdJdo.mjs");
