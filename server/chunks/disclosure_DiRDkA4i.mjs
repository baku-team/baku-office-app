...
import { googleStatus, SCOPE_GROUPS } from "./google_C5gaPtIE.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_P2gLs6_q.mjs";
import { getRetentionDays } from "./storage_XAs8LXvN.mjs";
const LIMITED_USE = [
