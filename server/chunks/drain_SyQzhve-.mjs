...
import { getApiKey } from "./client_BOITous_.mjs";
import { d as cfEgressGateway, l as linePush, e as processAppBuilds } from "./cf-adapter_Ds_ZQ-Hh.mjs";
import { d as dueReminders, m as markReminderDone } from "./invoices_BMFT0nQ4.mjs";
import { p as processSummaryJobs } from "./media-ai_tGeljFRj.mjs";
import { pollVideoJobs } from "./capabilities_B31azrYa.mjs";
import { processAgentJobs } from "./agent-jobs_wZLXyjCv.mjs";
import { runDueScheduledTasks } from "./scheduled-tasks_Cb3MAGwx.mjs";
import { guardHeavy } from "./diag_B7sefss8.mjs";
import { getDriveBackup, driveConnected, backupToDrive, uploadBufferToDrive } from "./drive_DUnQcaBU.mjs";
import { getBackupSchedule, backupAlert, buildBackup, backupFileName, recordBackupDone } from "./backup_IP7N6KOl.mjs";
import { flushReports } from "./reports_Cr78v98F.mjs";
import { addNotification, pushWebhook } from "./notifications_CdoRv0_M.mjs";
import { getNotifyWebhook } from "./settings_BGnJ4d3n.mjs";
import { purgeFiles } from "./storage_BW2B_Uds.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  return json({ ok: true, sent, notified, summarized, scheduled, video, agentJobs, appBuilds, driveBackup, fullBackup, reportsSent, purged });
};
