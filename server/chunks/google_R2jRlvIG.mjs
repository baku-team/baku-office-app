...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_XKaks_hD.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_tl0ys28U.mjs";
const SCOPE_GROUPS = {
  calendar: {
