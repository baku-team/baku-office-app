...
import { validateDefinition } from "./appdef_A6tXOSXJ.mjs";
import { g as getAppDesign } from "./external-apps_DnM9W0WO.mjs";
import { p as preflight } from "./preflight_BAx23egV.mjs";
import { r as runDraftApp } from "./app-runtime_VDJGb8ix.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_DnM9W0WO.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
