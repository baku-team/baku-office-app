...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_DVo9lSTr.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_C4s54b4W.mjs";
const SCOPE_GROUPS = {
  calendar: {
