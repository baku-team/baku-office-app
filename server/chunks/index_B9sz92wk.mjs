...
import { $ as $$MoneyTabs } from "./MoneyTabs_EBSxvesF.mjs";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_CVltyN7d.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_BKzORwjT.mjs");
  ...
  const reg = await import("./register_BU4r7DWS.mjs");
