...
import { setMaxUploadMb, setRetentionDays } from "./storage_DNiFHm67.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_DDctJAsU.mjs";
import { setStorageLimits } from "./storage-usage_C_tYdv-t.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_D9v53KLK.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_D4Ylp6ZT.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_BlvwATsr.mjs");
