...
import { googleStatus, SCOPE_GROUPS } from "./google_fXg5Bro0.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DVq3o9M5.mjs";
import { getRetentionDays } from "./storage_DUcQGvLc.mjs";
const LIMITED_USE = [
