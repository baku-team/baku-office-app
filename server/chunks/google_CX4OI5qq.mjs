...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BKYtLCd6.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_Cfiu9nCW.mjs";
const SCOPE_GROUPS = {
  calendar: {
