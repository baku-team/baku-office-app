...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_DhfR4ryc.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_Dvu2gt-n.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_CAb57Z3h.mjs"),
    import("./scheduled-tasks_BtqWB3kA.mjs")
  ]);
