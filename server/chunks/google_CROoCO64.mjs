...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_icI3Uf5x.mjs";
import { n as nowSec } from "./accounting_CelDuPQg.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_D6JanvQD.mjs";
const SCOPE_GROUPS = {
  calendar: {
  ...
  drive: {
    label: "ドライブ（書類の取り込み・読み取り）",
    risk: "ドライブ内のファイル一覧とファイル本文を読み取れます（変更・削除はしません）。",
    restricted: true,
