...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_BZYsk0AP.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_UVhG5pcl.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_17crGD_z.mjs"),
    import("./scheduled-tasks_BzNdzOLy.mjs")
  ]);
