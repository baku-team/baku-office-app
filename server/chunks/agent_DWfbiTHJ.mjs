...
import { entitlementForGate, getApiKey } from "./client_CTSTpEVI.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_BiBJopp6.mjs";
import { searchDirectory } from "./directory_BmG_lsb7.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_DEsPVk-8.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_DGUEyazM.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_BSPh7Poq.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_BlUD_Zfn.mjs";
import { createDraft } from "./external-apps_BjEpEAVR.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_DbrUoxt0.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage__IUbXlIy.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_ozzXUfvP.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_CTSTpEVI.mjs");
