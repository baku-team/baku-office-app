...
import { googleStatus, SCOPE_GROUPS } from "./google_Ca1jl-Ew.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_B9wOpFrA.mjs";
import { getRetentionDays } from "./storage_iUFCTMib.mjs";
const LIMITED_USE = [
