...
import { setMaxUploadMb, setRetentionDays } from "./storage_BZM8Ok-T.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_DT4CiOpW.mjs";
import { setStorageLimits } from "./storage-usage_DZOVxVBH.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_DcLoUjgu.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_BEp7sORQ.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_CKVtq-4X.mjs");
