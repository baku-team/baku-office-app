...
import { googleStatus, SCOPE_GROUPS } from "./google_1u5oGUJI.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DbrUoxt0.mjs";
import { getRetentionDays } from "./storage_DAcrnttd.mjs";
const LIMITED_USE = [
