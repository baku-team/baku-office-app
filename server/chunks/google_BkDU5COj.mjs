...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_0pHY0CaD.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_DUcBL2p9.mjs";
const SCOPE_GROUPS = {
  calendar: {
