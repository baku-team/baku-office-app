...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_D0aobTMW.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_BisWdx2f.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_m7q6dBg5.mjs"),
    import("./scheduled-tasks_CP6kxdWW.mjs")
  ]);
