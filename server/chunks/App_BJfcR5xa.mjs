...
const $$App = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const navIcon = { "/": "home", "/chat": "spark", "/apps": "grid", "/settings": "gear", "/my-events": "home" };
  ...
  const [themeMod, navMod, diagMod, notifMod, clientMod] = await Promise.all([
    ...
    import("./diag_ul3h80Zr.mjs"),
    import("./notifications_DSCbW_CR.mjs"),
    import("./client_BTLpH8fW.mjs")
  ]);
