...
const $$Advanced = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const entitlement = await (await import("./client_icI3Uf5x.mjs")).cachedEntitlement(env);
  ...
  const { getAutonomyConfig, ghDeviceAvailable } = await import("./autonomy_BKdZWV3m.mjs");
  ...
  const { hasApiKey } = await import("./client_icI3Uf5x.mjs");
  ...
  const { storageMode, maxUploadMb } = await import("./storage_B0ooiN1b.mjs");
