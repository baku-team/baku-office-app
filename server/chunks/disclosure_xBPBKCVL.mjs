...
import { googleStatus, SCOPE_GROUPS } from "./google_DpZmCkU5.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DJmViIQt.mjs";
import { getRetentionDays } from "./storage_Ch3C4uCb.mjs";
const LIMITED_USE = [
