...
import { disconnectGoogle, googleStatus, setGoogleGroups, grantedScopeString } from "./google_BvZ7tCLO.mjs";
import { getServiceAccountInfo, saveServiceAccount, saveWifConfig, testServiceAccount } from "./google-sa_C0NsU8Rq.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "probe") {
    ...
    const { probeGoogleApis } = await import("./google-probe_FdFsY1eI.mjs");
