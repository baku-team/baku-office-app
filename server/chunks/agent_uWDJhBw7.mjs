...
import { entitlementForGate, getApiKey } from "./client__0Sedoue.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_BGBReJdy.mjs";
import { searchDirectory } from "./directory_B_-JJ5Gl.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_BvIeCoUM.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_BUEso0gu.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_DTHOTK7J.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_D-TQZKa0.mjs";
import { createDraft } from "./external-apps_Dzh2gxAI.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_BAKwfWSR.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_Co1PlYfh.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client__0Sedoue.mjs");
