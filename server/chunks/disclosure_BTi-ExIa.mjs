...
import { googleStatus, SCOPE_GROUPS } from "./google_1EhGkBF9.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_Cu8t67mA.mjs";
import { getRetentionDays } from "./storage_IXeHfBaF.mjs";
const LIMITED_USE = [
