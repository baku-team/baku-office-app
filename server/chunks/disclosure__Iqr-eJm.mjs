...
import { googleStatus, SCOPE_GROUPS } from "./google_CAyVckvj.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_XTwNNyG7.mjs";
import { getRetentionDays } from "./storage_DNiFHm67.mjs";
const LIMITED_USE = [
