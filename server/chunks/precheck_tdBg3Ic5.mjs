...
import { getSession, canDevelopApps } from "./auth_Bh_tJP0x.mjs";
import { l as loadDraft, c as checkDefinition, a as checkTransitions, b as checkSandbox, d as checkFabrication, e as checkRun, f as finalizePrecheck } from "./precheck_CqMtin6Q.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_ehcQ_Xp6.mjs").then((n) => n.C)).recheckDraft(ctx, draftId);
  } catch {
  }
