...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_CqYezlNs.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_XDFylmqR.mjs";
import { googleFetch } from "./google_CbZiubp_.mjs";
import { getApiKey, entitlementForGate } from "./client_DM4zCU7e.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_oLPd3RSw.mjs";
import { validateDefinition, APP_SCHEMA, RENDER_HTML_MAX, opCatalogText } from "./appdef_Bkd2ZI33.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_BoClbhV1.mjs";
import { searchDirectory } from "./directory_DCBNzMf2.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_DUavRV7D.mjs";
import { logDiag } from "./diag_Cu0HTcAn.mjs";
import { i as isRunnableDefinition } from "./preflight_sV0IXFr6.mjs";
...
import { g as getAppDesign, m as createDraft, n as repairOutputLiterals, o as getAppMeta, q as setAppMeta, t as suggestAppMeta, v as setAppAllowedRoles, b as listExternalApps, w as installedAppDefs, x as appsBrief } from "./external-apps_D5nJw62F.mjs";
...
import "./index_DuHFU0n5.mjs";
import { listSkills, runSkill, generateSkill, searchSkills } from "./skills_PVeN1-UG.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_DiiJsKu9.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_BjhHPHue.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_DN6pGBs1.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_Cj7vjLDx.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_DwzuO0m5.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_DtRwVkbb.mjs";
import { p as pushToUser } from "./push_BXjc_27P.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_DM4zCU7e.mjs");
