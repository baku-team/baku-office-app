...
import { googleStatus, SCOPE_GROUPS } from "./google_CkmkwMEv.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DMM7LWsq.mjs";
import { getRetentionDays } from "./storage_Ik0IyZy_.mjs";
const LIMITED_USE = [
