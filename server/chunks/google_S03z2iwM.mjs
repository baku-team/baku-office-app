...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_C30hHFwA.mjs";
import { n as nowSec } from "./accounting_BipJ8jvJ.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BcFEVpmm.mjs";
const SCOPE_GROUPS = {
  calendar: {
