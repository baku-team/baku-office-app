...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_qGL1F133.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_D9peWgZU.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_C1sFtvfo.mjs"),
    import("./scheduled-tasks_bl-dn-9r.mjs")
  ]);
