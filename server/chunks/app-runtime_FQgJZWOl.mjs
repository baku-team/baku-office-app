...
import { validateDefinition, appApprovalEffects, roleCanOpenScreen, isBlockedHost } from "./appdef_B9RUsC0I.mjs";
import { a as scopeCtx } from "./parts_CYwgYHWx.mjs";
import { g as getAppDesign, a as activeAppDefinition, r as roleCanUseApp } from "./external-apps_BZsna514.mjs";
import { i as isGoogleOp, a as GOOGLE_OPS, r as runGoogleOp } from "./google-bridge_CxaeMFe4.mjs";
import { googleStatus, SCOPE_GROUPS } from "./google_R2jRlvIG.mjs";
import { entitlementForGate } from "./client_XKaks_hD.mjs";
...
import { enqueueReport } from "./reports_DtCC2Zug.mjs";
...
async function runApp(ctx, def, inputs, owner, screenId, appId, opts) {
  ...
  try {
    for (const s of defSteps) {
      curStep = s;
      const out = await runStep(ctx, def, s, { ref, interp, jsonTemplate, asText, bind, owner, dryRun: !!opts?.dryRun, role: opts?.role });
