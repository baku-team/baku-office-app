...
import { saveApiKey, getApiKey, deleteApiKey } from "./client__0Sedoue.mjs";
import { n as nowSec } from "./accounting_BipJ8jvJ.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_C1_NSXvK.mjs";
const SCOPE_GROUPS = {
  calendar: {
