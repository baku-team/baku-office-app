...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_DpHFYvTj.mjs";
import { n as nowSec } from "./accounting_CtvChRxg.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BW2dHlxz.mjs";
const SCOPE_GROUPS = {
  calendar: {
