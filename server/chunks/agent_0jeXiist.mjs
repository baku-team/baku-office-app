...
import { entitlementForGate, getApiKey } from "./client_K_W-4z9g.mjs";
...
import { permissionCatalogText } from "./apps_Dd4rnlyx.mjs";
import { A as APP_SCHEMA, o as opCatalogText, j as createDraft, k as getAppDesign, m as installedAppDefs, n as appsBrief } from "./external-apps_CMUWRR6d.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_iY5NPEYp.mjs";
import { searchDirectory } from "./directory_juxDlbTx.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_DIfeYUj4.mjs";
...
import "./index_Cbs2uaDg.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_CxDIwDXZ.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_DYbnZI7a.mjs";
import { r as runInstalledApp } from "./app-runtime_ByFojCLw.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_T0S0OwSZ.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_C0o2RuAe.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_DMZZWw5-.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_K_W-4z9g.mjs");
