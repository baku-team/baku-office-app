...
import { getPublicPage, getPublicPageAny } from "./public-pages_DKlxnm-h.mjs";
import { b as buildFrameSrcdoc, P as PUBLIC_BRIDGE_SDK, a as FRAME_ALLOW, F as FRAME_SANDBOX } from "./app-frame_Cka9f0RL.mjs";
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (!page2 && Astro2.url.searchParams.get("preview") === "1") {
    const { getSession, canDevelopApps } = await import("./auth_B8CX3HBm.mjs");
...
</div>`, addAttribute(page2.title, "title"), addAttribute(FRAME_SANDBOX, "sandbox"), addAttribute(FRAME_ALLOW, "allow"), addAttribute(frameDoc, "srcdoc"), unescapeHTML(JSON.stringify(slug)), addAttribute(Astro2.locals.cspNonce, "nonce"));
