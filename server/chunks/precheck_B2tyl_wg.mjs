...
import { v as validateDefinition } from "./appdef_C5b3bPt4.mjs";
import { g as getAppDesign } from "./external-apps_JQBtFvEn.mjs";
import { p as preflight } from "./preflight_FbqObRhF.mjs";
import { r as runDraftApp } from "./app-runtime_Bk5wFnAF.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_JQBtFvEn.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
