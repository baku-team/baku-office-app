...
import { googleStatus, SCOPE_GROUPS } from "./google_B00iOqPm.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BxI33RuM.mjs";
import { getRetentionDays } from "./storage_Dvmn3unV.mjs";
const LIMITED_USE = [
