...
import { APP_SCHEMA, validateDefinition } from "./appdef_C4DJM6El.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_DX3YoKbL.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_DkJb1xQq.mjs");
