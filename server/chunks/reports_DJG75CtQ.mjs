...
import { $ as $$App, r as renderScript } from "./App_DU0__uW2.mjs";
...
const $$Reports = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { monthKpi } = await import("./kpi_3GMMgNyP.mjs");
  const { TASK_KIND_LABEL } = await import("./task-log_DFVySHMg.mjs");
