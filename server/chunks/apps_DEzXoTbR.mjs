...
import { e as enabledPartIds, r as registeredParts, s as setEnabledPartIds, a as scopeCtx } from "./parts_BnninK9G.mjs";
import { disabledBuiltins } from "./client_sRscislI.mjs";
const PERMISSIONS = [
