...
import { getToken, hostFetch, getVerifyJwk } from "./client_BkhaD8kM.mjs";
import { r as randomId, v as verifyEnvelope, i as importVerifyKey, p as payloadOf } from "./stripe_r-RFTlbb.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { p as preflight, i as isRunnableDefinition } from "./preflight_B-_Zv8g4.mjs";
import { sanitizeRenderHtml, validateDefinition } from "./appdef_B4nA_AiL.mjs";
const MAX_TAGS = 8;
...
async function installLocalApp(ctx, draftId, by) {
  ...
  if (d.definition) {
    try {
      const jsErr = (await import("./appdef_B4nA_AiL.mjs")).checkRenderScripts(JSON.parse(d.definition).render?.html ?? "");
