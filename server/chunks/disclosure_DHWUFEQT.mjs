...
import { googleStatus, SCOPE_GROUPS } from "./google_BNQiUYSl.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_CDZk1MuL.mjs";
import { getRetentionDays } from "./storage_BluMveus.mjs";
const LIMITED_USE = [
