...
import { parseRequestModel, getWorkersPaid } from "./settings_D2rjJD-A.mjs";
import { s as startAppEdit, b as processAppBuild } from "./cf-adapter_DBX5cnQS.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b.image?.dataB64) {
    const { prepareDevAttachment } = await import("./chat-flow_BrAyvErl.mjs");
