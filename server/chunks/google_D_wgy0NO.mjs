...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_Dd9FH8gm.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BFhzSwlO.mjs";
const SCOPE_GROUPS = {
  calendar: {
