...
import { googleStatus, SCOPE_GROUPS } from "./google_AdgSxl2f.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_B9QBcRDz.mjs";
import { getRetentionDays } from "./storage_Ck-RJgTo.mjs";
const LIMITED_USE = [
