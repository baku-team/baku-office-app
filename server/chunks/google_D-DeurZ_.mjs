...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_D0aobTMW.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BFi-17hg.mjs";
const SCOPE_GROUPS = {
  calendar: {
