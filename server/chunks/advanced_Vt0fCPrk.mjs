...
const $$Advanced = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const entitlement = await (await import("./client_C23diL6K.mjs")).cachedEntitlement(env);
  ...
  const { getAutonomyConfig, ghDeviceAvailable } = await import("./autonomy_CdESEoWA.mjs");
  ...
  const { hasApiKey } = await import("./client_C23diL6K.mjs");
  ...
  const { storageMode, maxUploadMb } = await import("./storage_XAs8LXvN.mjs");
