...
import { entitlementForGate, getApiKey } from "./client_BCGuPb9o.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_CSdmnYrE.mjs";
import { searchDirectory } from "./directory_Bfy-KKmT.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_COWOhsgK.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_CwnDzWoS.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_DFRByNHz.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_DT1prPX3.mjs";
import { createDraft } from "./external-apps_D4rr60NP.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_Bd9bYc99.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_1ITWonsm.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_BCGuPb9o.mjs");
