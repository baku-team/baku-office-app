...
import { validateDefinition } from "./appdef_Ko9hM_6e.mjs";
import { g as getAppDesign } from "./external-apps_rV9_WCfp.mjs";
import { p as preflight } from "./preflight_BYlnVg38.mjs";
import { r as runDraftApp } from "./app-runtime_COvz7h7N.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_rV9_WCfp.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
