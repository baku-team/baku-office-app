...
const $$Advanced = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const entitlement = await (await import("./client_Cm6c2326.mjs")).cachedEntitlement(env);
  ...
  const { getAutonomyConfig, ghDeviceAvailable } = await import("./autonomy_Xy0bMs3x.mjs");
  ...
  const { hasApiKey } = await import("./client_Cm6c2326.mjs");
  ...
  const { storageMode, maxUploadMb } = await import("./storage_BpMEfKKE.mjs");
