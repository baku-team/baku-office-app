...
import { googleStatus, SCOPE_GROUPS } from "./google_DmyO49bx.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_D7lT25-K.mjs";
import { getRetentionDays } from "./storage_S4P08Enk.mjs";
const LIMITED_USE = [
