...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_Dd9FH8gm.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_B5cgUMAK.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_w_QpqFZo.mjs"),
    import("./scheduled-tasks_C61t2yz_.mjs")
  ]);
