...
import { validateDefinition } from "./appdef_DBu9p1Pp.mjs";
import { g as getAppDesign } from "./external-apps_Bh_N8LI2.mjs";
import { p as preflight } from "./preflight_B9L28Ilz.mjs";
import { r as runDraftApp } from "./app-runtime_Czv0dzdw.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_Bh_N8LI2.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
