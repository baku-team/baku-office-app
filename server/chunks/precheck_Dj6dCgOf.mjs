...
import { validateDefinition } from "./appdef_CuUJ9l7z.mjs";
import { g as getAppDesign } from "./external-apps_2G5fL5LC.mjs";
import { p as preflight } from "./preflight_8LOHoSIy.mjs";
import { r as runDraftApp } from "./app-runtime_BXspWHEz.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_2G5fL5LC.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
