...
import { setMaxUploadMb, setRetentionDays } from "./storage_My0jkMrn.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_I3hALocb.mjs";
import { setStorageLimits } from "./storage-usage_Dq8MpX_H.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_Dc0l4YqP.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_BARHPxoN.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_egOiPSom.mjs");
