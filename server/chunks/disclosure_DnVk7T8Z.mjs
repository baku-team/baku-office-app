...
import { googleStatus, SCOPE_GROUPS } from "./google_BPx6BLZX.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_zWHpyB6q.mjs";
import { getRetentionDays } from "./storage_BBucxay0.mjs";
const LIMITED_USE = [
