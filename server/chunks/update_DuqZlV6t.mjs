...
const $$Update = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { pollHost, APP_VERSION } = await import("./client_DSiKbs27.mjs");
  const { hasDeployHook, cmpVersion } = await import("./update_CSyiNJl8.mjs");
