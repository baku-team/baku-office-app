...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_DsktjJVP.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_BjEYqoBP.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_DlOSPa5I.mjs"),
    import("./scheduled-tasks_DuAscN8_.mjs")
  ]);
