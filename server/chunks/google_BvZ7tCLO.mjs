...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BTiBrVBU.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_C0NsU8Rq.mjs";
const SCOPE_GROUPS = {
  calendar: {
