...
import { googleStatus, SCOPE_GROUPS } from "./google_DFGiAMu3.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_CDen6ceU.mjs";
import { getRetentionDays } from "./storage_cf3JyuGL.mjs";
const LIMITED_USE = [
