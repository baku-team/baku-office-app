...
import { r as renderTemplate, m as maybeRenderHead, F as Fragment } from "./sequence_CKjIrPcu.mjs";
...
const $$Calendar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { googleConfigured, googleStatus } = await import("./google_B80Gv57H.mjs");
