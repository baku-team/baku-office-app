...
import { googleStatus, SCOPE_GROUPS } from "./google_DDa6Z_Jd.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BDwrF6rl.mjs";
import { getRetentionDays } from "./storage_CTBMIurh.mjs";
const LIMITED_USE = [
