...
import { entitlementForGate, getApiKey } from "./client_SzFl8Xp8.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_BebAZDVO.mjs";
import { searchDirectory } from "./directory_CcAoyhKJ.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_GLR92U8E.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_CK9rtFUm.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_ExXwFB5S.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_D0vojoKT.mjs";
import { createDraft } from "./external-apps_DP64nHdo.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_CDZk1MuL.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_CTLlDinZ.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_SzFl8Xp8.mjs");
