...
import { googleStatus, SCOPE_GROUPS } from "./google_S03z2iwM.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_I4SuksWF.mjs";
import { getRetentionDays } from "./storage_My0jkMrn.mjs";
const LIMITED_USE = [
