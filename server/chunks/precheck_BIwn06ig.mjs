...
import { validateDefinition } from "./appdef_C5MFUqHH.mjs";
import { g as getAppDesign } from "./external-apps_JB9CsP9c.mjs";
import { p as preflight } from "./preflight_B7c1PlDL.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_CmW4t-nd.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_JB9CsP9c.mjs").then((n) => n.B)).recheckDraft(ctx, draftId);
  } catch {
  }
