...
import { entitlementForGate, getApiKey } from "./client_F7ZfSNZF.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_j0ambz3I.mjs";
import { searchDirectory } from "./directory_DeMj_gGp.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_BKV_3WZ8.mjs";
...
import "./index_C_5HGQfJ.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_3yZs7XHe.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_C7FsIV6Z.mjs";
import { createDraft } from "./external-apps_BhDWDOUK.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_DZAAdcdq.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_C0o2RuAe.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_C_YPyh4_.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_F7ZfSNZF.mjs");
