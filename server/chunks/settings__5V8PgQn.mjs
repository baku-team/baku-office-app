...
import { setMaxUploadMb, setRetentionDays } from "./storage_Dmlxp-V7.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_3GTpunft.mjs";
import { setStorageLimits } from "./storage-usage_CCr9muu4.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_Dm5RA95F.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_Cegz1wdy.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_Dw9j8Q0j.mjs");
