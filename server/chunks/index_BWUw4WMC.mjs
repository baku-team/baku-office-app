...
import { $ as $$MoneyTabs } from "./MoneyTabs_BXdQmERn.mjs";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_DcLP1ieF.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_FobH8uUC.mjs");
  ...
  const reg = await import("./register_DX0dTG1u.mjs");
