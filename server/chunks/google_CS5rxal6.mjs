...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_CFhfgOdP.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_DKCp6uay.mjs";
const SCOPE_GROUPS = {
  calendar: {
