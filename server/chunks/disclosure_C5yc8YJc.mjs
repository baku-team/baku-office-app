...
import { googleStatus, SCOPE_GROUPS } from "./google_CUODxhfH.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_Bmfmicjq.mjs";
import { getRetentionDays } from "./storage_D9WoeNDX.mjs";
const LIMITED_USE = [
