...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_yx4APBBm.mjs");
  ...
  const agentName = await (await import("./settings_FobH8uUC.mjs")).getAgentName(env).catch(() => "相棒");
  const ttsCloudReady = await (await import("./capabilities_DWpc94yf.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    import("./settings_FobH8uUC.mjs"),
    import("./skills_DR8Whgry.mjs"),
    import("./scheduled-tasks_C9qwqwgT.mjs")
  ]);
