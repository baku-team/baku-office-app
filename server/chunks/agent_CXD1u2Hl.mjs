...
import { entitlementForGate, getApiKey } from "./client_B06zZZvw.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_K6LXp2rc.mjs";
import { searchDirectory } from "./directory_dUwZpDfG.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_dgWq63qy.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_CeUyuBtY.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_DXjVSs72.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_a5tAOdXb.mjs";
import { createDraft } from "./external-apps_ivWyFtIy.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_BphVg9S2.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_DYBGnNYj.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_B06zZZvw.mjs");
