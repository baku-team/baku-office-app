...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_DEGbNk-F.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_5Oxe-xzE.mjs";
import { googleFetch } from "./google_CQ787iwz.mjs";
import { getApiKey, entitlementForGate } from "./client_AxuQz5dA.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_BsdZaID6.mjs";
import { v as validateDefinition, A as APP_SCHEMA, R as RENDER_HTML_MAX, o as opCatalogText } from "./appdef_IUYd_KVi.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_DhXQ8TFr.mjs";
import { searchDirectory } from "./directory_Dx31jdo8.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_SsbS55Wf.mjs";
import { logDiag } from "./diag_Cu0HTcAn.mjs";
import { i as isRunnableDefinition } from "./preflight_CFiDajXx.mjs";
...
import { m as createDraft, g as getAppDesign, n as repairOutputLiterals, o as getAppMeta, q as setAppMeta, t as suggestAppMeta, v as setAppAllowedRoles, b as listExternalApps, w as installedAppDefs, x as appsBrief } from "./external-apps_TTFEFEgh.mjs";
...
import "./index_BvR2HJE_.mjs";
import { listSkills, runSkill, generateSkill, searchSkills } from "./skills_DS5TLKxm.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_D0aGUFZo.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_B8Sxy_6R.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_DN6pGBs1.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_CDQhlaoC.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_-sPlWLZj.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_Dy_Ay4Sj.mjs";
import { p as pushToUser } from "./push_CH1684Oi.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_AxuQz5dA.mjs");
