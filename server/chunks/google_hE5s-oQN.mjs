...
import { disconnectGoogle, googleStatus, setGoogleGroups, grantedScopeString } from "./google_B3DwQ4ws.mjs";
import { getServiceAccountInfo, saveServiceAccount, saveWifConfig, testServiceAccount } from "./google-sa_C1Nj7n9U.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "probe") {
    ...
    const { probeGoogleApis } = await import("./google-probe_BO71OACe.mjs");
