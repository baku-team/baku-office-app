...
import { getFile, saveFile, setRetentionDays, setMaxUploadMb, storageMode, fileBelongsTo } from "./storage_B8-WCIen.mjs";
import { getApiKey, getToken, hostFetch, cachedEntitlement, entitlementForGate, masterKeyCtx } from "./client_DBc4AdQ5.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { addNotification, notifyHook } from "./notifications_B_W244Oy.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers, verifyPassword } from "./users_DYTaJK75.mjs";
import { detectProfile } from "./profiles_D3vLhBYo.mjs";
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp, makeAppsApi } from "./apps_WWbnZ3SD.mjs";
import "./index_DaPtUtWl.mjs";
import { recordUsage, recordTokens, overBudget, recordCallLog, estimateUsd } from "./usage_Br94sshr.mjs";
...
import { googleFetch } from "./google_DQXcSNbr.mjs";
...
import { validateDefinition, APP_SCHEMA, RENDER_HTML_MAX, checkRenderScripts, checkRenderHandlers, checkRenderDataKeys, opCatalogText } from "./appdef_Bii9MnnM.mjs";
import { runToolLoop, HOPS_EXCEEDED, classifyModelError } from "./ai_Dn536Rzr.mjs";
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_ClLvSGv0.mjs";
import { getOrgProfile, setOrgProfile, listPublicActions, listActions, createAction, deleteAction, updateAction } from "./a2a-actions_7Ix0aoJE.mjs";
import { brandName, getTheme } from "./theme_DFty9gzU.mjs";
import { setAutonomy, getAutonomyConfig, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_DBeeklQt.mjs";
import { logDiag } from "./diag_ByGiCOpc.mjs";
import { i as isRunnableDefinition } from "./preflight_CN3WkTUc.mjs";
import { c as catalogPromptHint } from "./cdn-allowlist_Ck6a6kXM.mjs";
import { i as isDisplayOnly, u as unitsOf, a as checkTransitions, s as sampleInputs } from "./precheck_9I51fWaB.mjs";
import { g as runApp, p as platformInvariantSuspected, e as escalatePlatformInvariant, f as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_bp0g1ldn.mjs";
...
import { listSkills, runSkill, generateSkill, searchSkills } from "./skills_DN7dUuWz.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_7tDntmWn.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_DuR4lKFT.mjs";
import { saveLayoutDraft, listSites } from "./sites_CW6jwfXX.mjs";
import { v as validateLayout, m as makeBlock } from "./site-layout_KPAYKPQC.mjs";
import { ICON_OPTIONS, BLOCK_DEFS } from "./defs_C7dN86-U.mjs";
import { storeCatalog } from "./store_xBf3QcGR.mjs";
import { setCustomDomain } from "./custom-domain_BlEKJqw-.mjs";
import { p as pushToUser } from "./push_B4BRZXAA.mjs";
...
${lines}`;
    ...
    if (action === "build") {
      ...
      const base = await import("./sites_CW6jwfXX.mjs").then((m) => m.getSite(env, slug)).then((s) => {
        try {
...
・どうする：管理者がホーム画面の『スキル管理』で内容を確認して有効化すると、run_skill で使えるようになります。` : g.error ?? "スキル生成に失敗しました。";
    ...
    case "post_social": {
      ...
      const { socialPost } = await import("./social_DKc6DZ-l.mjs");
    ...
    case "search_social": {
      const { socialSearch } = await import("./social_DKc6DZ-l.mjs");
   ...
   ${i.url ?? ""}`).join("\n");
    ...
    case "read_social": {
      const { socialRead } = await import("./social_DKc6DZ-l.mjs");
...
async function runAgent(ctx2, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_DBc4AdQ5.mjs");
  ...
  const snsOn = Object.values(await (await import("./social_DKc6DZ-l.mjs")).socialStatus(env)).some(Boolean);
  ...
  const r2On = (await import("./storage_B8-WCIen.mjs")).storageMode(env) === "r2";
