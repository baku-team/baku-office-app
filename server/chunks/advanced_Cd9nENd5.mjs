...
const $$Advanced = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const entitlement = await (await import("./client_D8olaOjQ.mjs")).cachedEntitlement(env);
  ...
  const { getAutonomyConfig, ghDeviceAvailable } = await import("./autonomy_D8dAr5Of.mjs");
  ...
  const { hasApiKey } = await import("./client_D8olaOjQ.mjs");
  ...
  const { storageMode, maxUploadMb } = await import("./storage_DAMys_Bo.mjs");
