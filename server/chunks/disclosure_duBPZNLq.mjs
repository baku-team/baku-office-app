...
import { googleStatus, SCOPE_GROUPS } from "./google_BuZz6w7H.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_Dt1CZ0pl.mjs";
import { getRetentionDays } from "./storage_DJiP0NOX.mjs";
const LIMITED_USE = [
