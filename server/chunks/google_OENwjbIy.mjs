...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_Du2JHuMP.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_wI_HVjPw.mjs";
const SCOPE_GROUPS = {
  calendar: {
