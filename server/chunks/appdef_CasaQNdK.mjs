...
import { ALLOWED_PERMISSIONS } from "./apps_DfgyJWKg.mjs";
...
function isRenderable(input) {
  ...
  return vr.issues.every((i) => i.path === "render.html" && (i.message.includes("screens[] に定義されていません") || i.message.includes("カスタムUIのスクリプトに構文エラー")));
}
