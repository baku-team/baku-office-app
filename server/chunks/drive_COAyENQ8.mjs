...
const $$Drive = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { driveConfigured, driveConnected, listDriveFiles, getDriveBackup } = await import("./drive_CYmeiSnE.mjs");
