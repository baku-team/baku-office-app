...
import { validateDefinition } from "./appdef_C4DJM6El.mjs";
import { g as getAppDesign } from "./external-apps_BSfdE0OQ.mjs";
import { p as preflight } from "./preflight_De4tH6Sq.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_DQoKcPEY.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BSfdE0OQ.mjs").then((n) => n.B)).recheckDraft(ctx, draftId);
  } catch {
  }
