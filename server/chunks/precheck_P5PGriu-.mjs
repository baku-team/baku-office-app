...
import { validateDefinition } from "./appdef_ke6Sfkl6.mjs";
import { g as getAppDesign } from "./external-apps_CjQOD0Ds.mjs";
import { p as preflight } from "./preflight_CP-pOvkl.mjs";
import { r as runDraftApp } from "./app-runtime_BwQfQUin.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_CjQOD0Ds.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
