...
import { validateDefinition } from "./appdef_Cl-rwi-H.mjs";
import { g as getAppDesign } from "./external-apps_BJqjrgQW.mjs";
import { p as preflight } from "./preflight_CwLopji2.mjs";
import { r as runDraftApp } from "./app-runtime_DBoLRSMZ.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BJqjrgQW.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
