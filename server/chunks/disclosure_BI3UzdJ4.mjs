...
import { googleStatus, SCOPE_GROUPS } from "./google_jereYF8M.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_Dii7V1bw.mjs";
import { getRetentionDays } from "./storage_Bbu5kdRU.mjs";
const LIMITED_USE = [
