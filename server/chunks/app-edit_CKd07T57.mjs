...
import { parseRequestModel, getWorkersPaid } from "./settings_C4tL9AHR.mjs";
import { f as startAppEdit, k as kickBuild } from "./ctx_CIL4AtJU.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  await kickBuild(locals.ctx, buildId, new URL(request.url).origin, "app-edit");
