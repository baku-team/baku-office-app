...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BZPpVhKD.mjs";
import { n as nowSec } from "./accounting_BipJ8jvJ.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_Dzg-W1ci.mjs";
const SCOPE_GROUPS = {
  calendar: {
