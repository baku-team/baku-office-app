...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_mgVrvX2Z.mjs");
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_C080gmVv.mjs"),
    import("./scheduled-tasks_CvPvwwX4.mjs")
  ]);
  ...
  const { disabledBuiltins } = await import("./client_mgVrvX2Z.mjs");
