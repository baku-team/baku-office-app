...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_DhfR4ryc.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_s_gAlOB-.mjs";
const SCOPE_GROUPS = {
  calendar: {
