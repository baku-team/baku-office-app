...
import { validateDefinition } from "./appdef_B4nA_AiL.mjs";
import { g as getAppDesign } from "./external-apps_WPZGR1xq.mjs";
import { p as preflight } from "./preflight_B-_Zv8g4.mjs";
import { r as runDraftApp } from "./app-runtime_3wSoq0s6.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_WPZGR1xq.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
