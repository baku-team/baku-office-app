...
import { googleStatus, SCOPE_GROUPS } from "./google_DU5pRih0.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_CQBv3XB_.mjs";
import { getRetentionDays } from "./storage_iZjhVw_T.mjs";
const LIMITED_USE = [
