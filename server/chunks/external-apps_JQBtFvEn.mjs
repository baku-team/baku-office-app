...
import { getToken, hostFetch, getVerifyJwk } from "./client_DSiKbs27.mjs";
import { r as randomId, v as verifyEnvelope, i as importVerifyKey, p as payloadOf } from "./stripe_r-RFTlbb.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { p as preflight, i as isRunnableDefinition } from "./preflight_FbqObRhF.mjs";
import { s as sanitizeRenderHtml, v as validateDefinition } from "./appdef_C5b3bPt4.mjs";
const MAX_TAGS = 8;
...
async function installLocalApp(ctx, draftId, by) {
  ...
  try {
    if (d.definition) {
      const { rebuildPublicPageFromDef } = await import("./public-pages_CvPz6VHR.mjs");
...
async function deleteLocalApp(ctx, appId, deleteData = false) {
  ...
  await (await import("./public-pages_CvPz6VHR.mjs")).deletePublicPagesByApp(ctx.env, appId).catch(() => {
  });
