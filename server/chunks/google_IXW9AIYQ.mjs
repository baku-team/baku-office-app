...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_yS3Z_a8H.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BytmOybl.mjs";
const SCOPE_GROUPS = {
  calendar: {
