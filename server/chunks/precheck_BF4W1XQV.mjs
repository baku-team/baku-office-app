...
import { v as validateDefinition } from "./appdef_B8AQs2ti.mjs";
import { g as getAppDesign } from "./external-apps_B2UyOhc0.mjs";
import { p as preflight } from "./preflight_DNLmay0L.mjs";
import { r as runDraftApp } from "./app-runtime_Dh3LRADA.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_B2UyOhc0.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
