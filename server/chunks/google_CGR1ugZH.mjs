...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_CSBhOn7n.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_Bdr54thC.mjs";
const SCOPE_GROUPS = {
  calendar: {
