...
import { r as renderComponent, s as spreadAttributes } from "./worker-entry_SGdZ5KUz.mjs";
...
const $$Membership = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (ses.ctx !== "org") return Astro2.redirect("/forbidden", 302);
  const canEdit = canAccess(ses.role, "accounting");
  const { listMembers, memberStats, FEE_STATUSES, FEE_LABEL } = await import("./membership_CPRHg6HN.mjs");
