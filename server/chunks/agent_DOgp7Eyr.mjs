...
import { entitlementForGate, getApiKey } from "./client_sMs6A3qN.mjs";
...
import { getAiEngine, getCustomPrompt, getWorkersAiModel, maxParallelAgents, agentMaxHops } from "./settings_j1AROY7x.mjs";
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_BkVEfOnC.mjs";
import { searchDirectory } from "./directory_1OUCLPSO.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_C7Or1U9e.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_D1YtWpDB.mjs";
import "./index_BlHS1PcQ.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_DxqMkMON.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_D3TNwtN_.mjs";
import { createDraft } from "./external-apps_PF1LwimL.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_BWaHqP09.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_CZzCVGe-.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_C0FxI2g-.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_sMs6A3qN.mjs");
