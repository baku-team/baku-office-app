...
import { r as renderComponent } from "./worker-entry_Ai7LTa6r.mjs";
import { env } from "cloudflare:workers";
import { $ as $$App } from "./App_DlRdqdVj.mjs";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { getSession } = await import("./auth_D3ppHoJV.mjs");
  const ses = await getSession(env, Astro2.request);
  if (!ses) return Astro2.redirect("/login", 302);
  const { cachedEntitlement, hasApiKey } = await import("./client_BJ88O0X2.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_XBR5BPqI.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_ouBOFBur.mjs"),
    import("./scheduled-tasks_B5QoyvYt.mjs")
  ]);
  ...
  await import("./index_DM39iHq9.mjs");
