...
import { r as renderTemplate, d as defineScriptVars, m as maybeRenderHead, a as addAttribute } from "./sequence_CKjIrPcu.mjs";
...
import { atLeast, planLabel } from "./index_CrjiuAkj.mjs";
...
const $$Billing = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { pollHost, cachedEntitlement, getLicenseId, hostFetch } = await import("./client_DpHFYvTj.mjs");
