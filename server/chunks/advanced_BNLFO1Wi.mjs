...
const $$Advanced = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const entitlement = await (await import("./client_mUx62QP1.mjs")).cachedEntitlement(env);
  ...
  const { getAutonomyConfig, ghDeviceAvailable } = await import("./autonomy_3GTpunft.mjs");
  ...
  const { hasApiKey } = await import("./client_mUx62QP1.mjs");
  ...
  const { storageMode, maxUploadMb } = await import("./storage_Dmlxp-V7.mjs");
