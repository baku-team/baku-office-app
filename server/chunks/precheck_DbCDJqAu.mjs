...
import { validateDefinition } from "./appdef_C5vmO67B.mjs";
import { g as getAppDesign } from "./external-apps_DS8tDlHa.mjs";
import { p as preflight } from "./preflight_BZy9aon5.mjs";
import { r as runDraftApp } from "./app-runtime_CIbCw4hy.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_DS8tDlHa.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
