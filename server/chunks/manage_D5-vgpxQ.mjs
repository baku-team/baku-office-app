...
import { moderate, setPublicEnabled, setRegisterMode, getPublicPageAny, deletePublicPage } from "./public-pages_BaPDC316.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b.action === "rebuild") {
    ...
    const { rebuildPublicPage } = await import("./ctx_DmYZEEDZ.mjs").then((n) => n.P);
