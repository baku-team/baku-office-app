...
import { googleStatus, SCOPE_GROUPS } from "./google_BKX64DRF.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_LH9O0Brq.mjs";
import { getRetentionDays } from "./storage_hKiHcy_A.mjs";
const LIMITED_USE = [
