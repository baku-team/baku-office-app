...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BCGuPb9o.mjs";
import { n as nowSec } from "./accounting_BipJ8jvJ.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BiyMvRV3.mjs";
const SCOPE_GROUPS = {
  calendar: {
