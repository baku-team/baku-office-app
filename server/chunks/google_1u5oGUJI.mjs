...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_CTSTpEVI.mjs";
import { n as nowSec } from "./accounting_CelDuPQg.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BJoZXQI5.mjs";
const SCOPE_GROUPS = {
  calendar: {
