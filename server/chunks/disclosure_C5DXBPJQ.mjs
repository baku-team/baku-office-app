...
import { googleStatus, SCOPE_GROUPS } from "./google_Ca8BaTxT.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DnNmBjYH.mjs";
import { getRetentionDays } from "./storage_HzCeCgFJ.mjs";
const LIMITED_USE = [
