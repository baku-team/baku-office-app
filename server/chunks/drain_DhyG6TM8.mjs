...
import { getApiKey } from "./client_w07XlKo6.mjs";
import { d as cfEgressGateway, l as linePush, e as processAppBuilds } from "./cf-adapter_C1pggy-8.mjs";
import { d as dueReminders, m as markReminderDone } from "./invoices_BMFT0nQ4.mjs";
import { p as processSummaryJobs } from "./media-ai_CgIuyQZL.mjs";
import { pollVideoJobs } from "./capabilities_BPLruks8.mjs";
import { processAgentJobs } from "./agent-jobs_eXqOWzfz.mjs";
import { reclaimStaleApprovals } from "./approvals_DYucn0P5.mjs";
import { runDueScheduledTasks } from "./scheduled-tasks_DxbIcLJk.mjs";
import { guardHeavy } from "./diag_B7sefss8.mjs";
import { getDriveBackup, driveConnected, backupToDrive, uploadBufferToDrive } from "./drive_DzkGp6d7.mjs";
import { getBackupSchedule, backupAlert, buildBackup, backupFileName, recordBackupDone } from "./backup_C6OGyHjw.mjs";
import { flushReports } from "./reports_D1FNhwT2.mjs";
import { addNotification, pushWebhook } from "./notifications_CdoRv0_M.mjs";
import { getNotifyWebhook } from "./settings_BGnJ4d3n.mjs";
import { purgeFiles } from "./storage_CbtCJxWn.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  const ab = await guardHeavy(env, "app builds", () => processAppBuilds(locals.ctx, new URL(request.url).origin));
  const appBuilds = ab.ok ? ab.value.processed : 0;
  ...
  return json({ ok: true, sent, notified, summarized, scheduled, video, agentJobs, appBuilds, approvalsReclaimed, driveBackup, fullBackup, reportsSent, purged });
};
