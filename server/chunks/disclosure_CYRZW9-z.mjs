...
import { googleStatus, SCOPE_GROUPS } from "./google_CQ787iwz.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_B8Sxy_6R.mjs";
import { getRetentionDays } from "./storage_DEGbNk-F.mjs";
const LIMITED_USE = [
