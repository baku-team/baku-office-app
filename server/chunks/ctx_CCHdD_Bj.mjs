...
import { getFile, saveFile, setRetentionDays, setMaxUploadMb, fileBelongsTo, storageMode } from "./storage_B3AGfRzZ.mjs";
import { getApiKey, getToken, hostFetch, entitlementForGate, masterKeyCtx } from "./client_Dkd4XO8R.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { addNotification } from "./notifications_CdoRv0_M.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers, verifyPassword } from "./users_BiQVVDnj.mjs";
import { detectProfile } from "./profiles_D3vLhBYo.mjs";
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp, makeAppsApi } from "./apps_BgIyC1x0.mjs";
import "./index_DHfqgO_N.mjs";
...
import { googleFetch } from "./google_BmSZEUR0.mjs";
...
import { validateDefinition, APP_SCHEMA, checkRenderScripts, checkRenderHandlers, checkRenderDataKeys, RENDER_HTML_MAX, opCatalogText } from "./appdef_043hMRPD.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_DxH6lL8l.mjs";
import { getOrgProfile, setOrgProfile, listPublicActions, listActions, createAction, deleteAction, updateAction } from "./a2a-actions_DGLAViEu.mjs";
import { brandName, getTheme } from "./theme_DFty9gzU.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_B05TaQu4.mjs";
import { logDiag } from "./diag_DUN9A_L9.mjs";
import { i as isRunnableDefinition } from "./preflight_BNHW0b-7.mjs";
...
import { g as getAppDesign, m as repairOutputLiterals, n as createDraft, o as getAppMeta, q as setAppMeta, t as suggestAppMeta, i as installLocalApp, v as setAppAllowedRoles, b as listExternalApps, w as installedAppDefs, x as appsBrief } from "./external-apps_C08IdFiZ.mjs";
import { a as appendMessage } from "./chat-sessions_BLqLinNd.mjs";
import { a as resolveChannel } from "./connectors-store_CHWkgRyl.mjs";
import { listSkills, runSkill, generateSkill, searchSkills } from "./skills_Y3tQgqgi.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_C_Cs7AnB.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_DyaJ2J6C.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_TaOxZjhW.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { p as pushToUser } from "./push_CugRq8S9.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_Dkd4XO8R.mjs");
