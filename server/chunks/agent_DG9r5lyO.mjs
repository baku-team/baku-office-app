...
import { entitlementForGate, getApiKey } from "./client_C30hHFwA.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_D18XqPt8.mjs";
import { searchDirectory } from "./directory_DY9WXIvH.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_I3hALocb.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_Cq3Vgwa_.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_pJqo87hO.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_DL28trEl.mjs";
import { createDraft } from "./external-apps_BARHPxoN.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_I4SuksWF.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_egOiPSom.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_C30hHFwA.mjs");
