...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_Ch3C4uCb.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_BgFqnPGk.mjs";
import { googleFetch } from "./google_DpZmCkU5.mjs";
import { getApiKey, entitlementForGate } from "./client_Cmhn0ct_.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_CSXPq6XS.mjs";
import { v as validateDefinition, A as APP_SCHEMA, R as RENDER_HTML_MAX, o as opCatalogText } from "./appdef_CpMWiGcK.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_LcutyVcM.mjs";
import { searchDirectory } from "./directory_CpyetOVL.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_BadI-zsn.mjs";
import { logDiag } from "./diag_B7sefss8.mjs";
import { i as isRunnableDefinition } from "./preflight_CB162xI_.mjs";
...
import { m as createDraft, g as getAppDesign, n as getAppMeta, o as setAppMeta, q as suggestAppMeta, t as setAppAllowedRoles, b as listExternalApps, v as installedAppDefs, w as appsBrief } from "./external-apps_CyLGJDop.mjs";
...
import "./index_DDhRaaxU.mjs";
import { listSkills, runSkill, generateSkill } from "./skills_DM9DEYF0.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_Bqcqs6P_.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_DJmViIQt.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_D3RuFGmp.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_CAyXoKNG.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_C8cbQeLC.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_CDQQ8TEg.mjs";
import { p as pushToUser } from "./push_BfroEU0d.mjs";
...
- 添付の読み取り：画像・PDF は内容を見て読み取り、テキスト系ファイル（txt/csv/json/md など）は中身をそのまま読める。請求書/領収書の画像は会計登録に使える。
