...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_BpHW5W0y.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_CGAf54Rj.mjs");
  ...
  const reg = await import("./register_CPqa7s1K.mjs");
