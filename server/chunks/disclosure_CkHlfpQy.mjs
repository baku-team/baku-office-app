...
import { googleStatus, SCOPE_GROUPS } from "./google_BPPjGxsX.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DAjIaJcm.mjs";
import { getRetentionDays } from "./storage_BocuNd5z.mjs";
const LIMITED_USE = [
