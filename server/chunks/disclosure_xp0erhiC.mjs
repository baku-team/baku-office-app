...
import { googleStatus, SCOPE_GROUPS } from "./google_8IkJu7Qx.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_D9peWgZU.mjs";
import { getRetentionDays } from "./storage_CsdZqwDR.mjs";
const LIMITED_USE = [
