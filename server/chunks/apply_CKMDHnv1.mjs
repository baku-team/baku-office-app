...
import { registerForEvent } from "./events_Cw1NGgaN.mjs";
import { makeSessionCookie, sessionExp } from "./auth_B7urFPAX.mjs";
...
const POST = async ({ request }) => {
  ...
  const cookie = await makeSessionCookie(env, { uid: r.userId, role: "member", ctx: "personal", name: String(b.name ?? ""), exp: sessionExp() });
