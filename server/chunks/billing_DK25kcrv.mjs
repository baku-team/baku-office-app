...
import { r as renderTemplate, d as defineScriptVars, m as maybeRenderHead, a as addAttribute } from "./sequence_2tuU57vh.mjs";
import { r as renderComponent } from "./worker-entry_BZxNlkKO.mjs";
import { env } from "cloudflare:workers";
import { $ as $$App } from "./App_DuM5EJ0p.mjs";
import { $ as $$MoneyTabs } from "./MoneyTabs_DLC2xT17.mjs";
...
const $$Billing = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { pollHost, cachedEntitlement, getLicenseId, hostFetch } = await import("./client_CET1td35.mjs");
