...
import { validateDefinition } from "./appdef_043hMRPD.mjs";
import { g as getAppDesign } from "./external-apps_C08IdFiZ.mjs";
import { p as preflight } from "./preflight_BNHW0b-7.mjs";
import { r as runDraftApp } from "./app-runtime_C_Cs7AnB.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_C08IdFiZ.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
