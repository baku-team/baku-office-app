...
import { $ as $$DriveStatus } from "./DriveStatus_CppHYKAh.mjs";
...
const $$Drive = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { driveConfigured, driveConnected, driveAvailable, driveStatus, listDriveFiles } = await import("./drive_B0TqaLRC.mjs");
