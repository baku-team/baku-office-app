...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_-spfSM1I.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_D1lpYzHd.mjs";
const SCOPE_GROUPS = {
  calendar: {
