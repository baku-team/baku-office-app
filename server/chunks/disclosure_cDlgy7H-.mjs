...
import { googleStatus, SCOPE_GROUPS } from "./google_KBliO7QR.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BphVg9S2.mjs";
import { getRetentionDays } from "./storage_BE5gVdDk.mjs";
const LIMITED_USE = [
