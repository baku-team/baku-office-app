...
import { getToken, hostFetch, getVerifyJwk } from "./client_C_RhHGpz.mjs";
import { r as randomId, v as verifyEnvelope, i as importVerifyKey, p as payloadOf } from "./stripe_r-RFTlbb.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { p as preflight, i as isRunnableDefinition } from "./preflight_CM72wj6v.mjs";
import { sanitizeRenderHtml, validateDefinition, isBlockedHost } from "./appdef_BEoNJ34p.mjs";
import { a as isCuratedHost } from "./cdn-allowlist_rKupC5M_.mjs";
import { r as registeredParts } from "./parts_CVGBl5kS.mjs";
import { installApp } from "./apps_DQ67RXU1.mjs";
const MAX_TAGS = 8;
...
async function installLocalApp(ctx, draftId, by) {
  ...
  if (d.definition) {
    try {
      const jsErr = (await import("./appdef_BEoNJ34p.mjs")).checkRenderScripts(JSON.parse(d.definition).render?.html ?? "");
    ...
    try {
      ...
      if (parsed.render?.isolation === "relaxed") {
        ...
        if (okApproved) {
          ...
          const { createApproval } = await import("./approvals_1nREIbT_.mjs");
...
export {
  ...
  appMeta as B,
  externalApps as C,
  listExternalApps as a,
  forkExternalApp as b,
  applyUpstreamMerge as c,
  deleteDraft as d,
  activeAppDefinition as e,
