...
function isMemberModel(v) {
  return v === "gemini" || v === "claude" || typeof v === "string" && isValidWorkersAiModel(v);
}
function resolveModelSelection(v) {
  if (v === "gemini" || v === "claude") return { engine: v };
  if (v && isValidWorkersAiModel(v)) return { engine: "local", waModel: v };
