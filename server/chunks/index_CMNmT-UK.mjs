...
import { $ as $$MoneyTabs } from "./MoneyTabs_Mbh91tOo.mjs";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_CzLHri08.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_BmjoORVR.mjs");
  ...
  const reg = await import("./register_BXE3SAXI.mjs");
