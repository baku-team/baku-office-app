...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_7WfEvhS0.mjs");
  ...
  const agentName = await (await import("./settings_C_1axsCz.mjs")).getAgentName(env).catch(() => "相棒");
  const ttsCloudReady = await (await import("./capabilities_DnNmBjYH.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    import("./settings_C_1axsCz.mjs"),
    import("./skills_DgeidZxB.mjs"),
    import("./scheduled-tasks_5gDG02Ry.mjs")
  ]);
