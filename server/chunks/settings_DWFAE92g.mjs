...
import { setMaxUploadMb, setRetentionDays } from "./storage_DCN_Hros.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_COWOhsgK.mjs";
import { setStorageLimits } from "./storage-usage_BxO3e0V_.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_CdgXOypi.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_D4rr60NP.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_1ITWonsm.mjs");
