...
import { validateDefinition } from "./appdef_B1qN9jxn.mjs";
import { g as getAppDesign } from "./external-apps_CbHDX8yf.mjs";
import { p as preflight } from "./preflight_BivD_X5O.mjs";
import { r as runDraftApp } from "./app-runtime_CdAb1bam.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_CbHDX8yf.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
