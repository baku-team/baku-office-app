...
import { validateDefinition } from "./appdef_CasaQNdK.mjs";
import { g as getAppDesign } from "./external-apps_CFGtMTKs.mjs";
import { p as preflight } from "./preflight_7oh8SOHY.mjs";
import { r as runDraftApp } from "./app-runtime_MAqKmypx.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_CFGtMTKs.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
