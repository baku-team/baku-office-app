...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_BwhEewZt.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_BGnJ4d3n.mjs");
  ...
  const reg = await import("./register_Bdz8tLlL.mjs");
