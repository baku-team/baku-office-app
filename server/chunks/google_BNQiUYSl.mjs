...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_SzFl8Xp8.mjs";
import { n as nowSec } from "./accounting_BipJ8jvJ.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_YVb1l8No.mjs";
const SCOPE_GROUPS = {
  calendar: {
