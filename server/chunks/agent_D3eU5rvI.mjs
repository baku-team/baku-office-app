...
import { entitlementForGate, getApiKey } from "./client_CXgE4FGk.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_BipVAVjA.mjs";
import { searchDirectory } from "./directory_DnJehgN7.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_DZAXMsjG.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_BUgtM5Dr.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_CUsLW0jc.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_BLzrtVHm.mjs";
import { createDraft } from "./external-apps_XyIZEFAM.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_uPYAGLDC.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_DvQzobx_.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_CXgE4FGk.mjs");
