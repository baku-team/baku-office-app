...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_Bdf4380v.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_VsRd0e69.mjs";
import { googleFetch } from "./google_BZ-HhmWc.mjs";
import { getApiKey, entitlementForGate } from "./client_DdrEUTKx.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_vCtql7Lf.mjs";
import { validateDefinition, APP_SCHEMA, RENDER_HTML_MAX, opCatalogText } from "./appdef_ke6Sfkl6.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_CQmz13fZ.mjs";
import { searchDirectory } from "./directory_Fx7U10NM.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_BM_V_axw.mjs";
import { logDiag } from "./diag_Cu0HTcAn.mjs";
import { i as isRunnableDefinition } from "./preflight_CP-pOvkl.mjs";
...
import { g as getAppDesign, m as createDraft, n as repairOutputLiterals, o as getAppMeta, q as setAppMeta, t as suggestAppMeta, v as setAppAllowedRoles, b as listExternalApps, w as installedAppDefs, x as appsBrief } from "./external-apps_CjQOD0Ds.mjs";
...
import "./index_D7U8yzuf.mjs";
import { listSkills, runSkill, generateSkill, searchSkills } from "./skills_CF-laAOp.mjs";
import { e as runInstalledApp, r as runDraftApp, c as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_BwQfQUin.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_THcekV6g.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_DN6pGBs1.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_BtBC9xms.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_Df4NLF9D.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_CCiJAIWD.mjs";
import { p as pushToUser } from "./push_DYLqlVUe.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_DdrEUTKx.mjs");
