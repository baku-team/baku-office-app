...
import { $ as $$MoneyTabs } from "./MoneyTabs_DG6Lr1G_.mjs";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_D-SE8ibz.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_C2uu0Zu7.mjs");
  ...
  const reg = await import("./register_DtwlHYVq.mjs");
