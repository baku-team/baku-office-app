...
import { validateDefinition } from "./appdef_D0-eULfO.mjs";
import { g as getAppDesign } from "./external-apps_C9jYx4MB.mjs";
import { p as preflight } from "./preflight_D12Q3rxJ.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_CZdHJJLR.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_C9jYx4MB.mjs").then((n) => n.B)).recheckDraft(ctx, draftId);
  } catch {
  }
