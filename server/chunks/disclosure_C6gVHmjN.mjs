...
import { googleStatus, SCOPE_GROUPS } from "./google_CbZiubp_.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BjhHPHue.mjs";
import { getRetentionDays } from "./storage_CqYezlNs.mjs";
const LIMITED_USE = [
