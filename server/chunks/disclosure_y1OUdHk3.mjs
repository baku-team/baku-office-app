...
import { googleStatus, SCOPE_GROUPS } from "./google_wcCBu7Mn.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_CsMC_79r.mjs";
import { getRetentionDays } from "./storage_DMuH0rYg.mjs";
const LIMITED_USE = [
