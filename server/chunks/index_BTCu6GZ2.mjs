...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const { getSession, canAccess } = await import("./auth_bbtIbOVC.mjs");
  ...
  const { getBookkeepingMode } = await import("./settings_D2rjJD-A.mjs");
  ...
  const reg = await import("./register_C5rx_3uH.mjs");
