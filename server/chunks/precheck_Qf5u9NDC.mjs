...
import { validateDefinition } from "./appdef_Bz-FCBXl.mjs";
import { g as getAppDesign } from "./external-apps_CND5X7DG.mjs";
import { p as preflight } from "./preflight_BBriIbUe.mjs";
import { r as runDraftApp } from "./app-runtime_xFT8akwb.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_CND5X7DG.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
