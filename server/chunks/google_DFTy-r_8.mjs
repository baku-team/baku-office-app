...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BPZJrufk.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_e9k6yqqs.mjs";
const SCOPE_GROUPS = {
  calendar: {
