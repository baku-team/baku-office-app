...
import { validateDefinition } from "./appdef_DljWxVwr.mjs";
import { g as getAppDesign } from "./external-apps_CjtNtWNm.mjs";
import { p as preflight } from "./preflight_CHr9CHdM.mjs";
import { r as runDraftApp } from "./app-runtime_BiBb3zGh.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_CjtNtWNm.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
