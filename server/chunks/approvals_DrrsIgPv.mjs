...
const $$Approvals = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { listApprovals, getApprovalMode } = await import("./approvals_4RWwxnco.mjs");
