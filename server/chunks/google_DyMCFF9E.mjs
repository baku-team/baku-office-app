...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BV1rSndT.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_CjQKSSc9.mjs";
const SCOPE_GROUPS = {
  calendar: {
