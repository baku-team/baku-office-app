...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_BCrexcwr.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_CUSmsEak.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_RF-0odTN.mjs"),
    import("./scheduled-tasks_B8-Nykxe.mjs")
  ]);
