...
const $$Advanced = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const entitlement = await (await import("./client_Cmhn0ct_.mjs")).cachedEntitlement(env);
  ...
  const { getAutonomyConfig, ghDeviceAvailable } = await import("./autonomy_BadI-zsn.mjs");
  ...
  const { storageMode, maxUploadMb } = await import("./storage_Ch3C4uCb.mjs");
