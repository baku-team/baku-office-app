...
import { validateDefinition } from "./appdef_Bkd2ZI33.mjs";
import { g as getAppDesign } from "./external-apps_D5nJw62F.mjs";
import { p as preflight } from "./preflight_sV0IXFr6.mjs";
import { r as runDraftApp } from "./app-runtime_DiiJsKu9.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_D5nJw62F.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
