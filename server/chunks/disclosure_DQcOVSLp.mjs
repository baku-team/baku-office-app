...
import { googleStatus, SCOPE_GROUPS } from "./google_Cd3M1ltz.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_D7yFgcIz.mjs";
import { getRetentionDays } from "./storage_BpQ232ZA.mjs";
const LIMITED_USE = [
