...
import { validateDefinition } from "./appdef_CjtXKAi2.mjs";
import { g as getAppDesign } from "./external-apps_BIgCZPwg.mjs";
import { p as preflight } from "./preflight_Cg-LrPRq.mjs";
import { r as runDraftApp } from "./app-runtime_uo-McrqR.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BIgCZPwg.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
