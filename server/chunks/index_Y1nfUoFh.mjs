...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_BTiBrVBU.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_C7j9aJHH.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_CDedU4Ou.mjs"),
    import("./scheduled-tasks_YSHkorhG.mjs")
  ]);
