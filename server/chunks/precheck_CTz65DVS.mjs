...
import { validateDefinition } from "./appdef_DFNK-Uyv.mjs";
import { g as getAppDesign } from "./external-apps_isqg69Qv.mjs";
import { p as preflight } from "./preflight_EiN3q0he.mjs";
import { r as runDraftApp } from "./app-runtime_ScKG7tYq.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_isqg69Qv.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
