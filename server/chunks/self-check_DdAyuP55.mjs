...
import { APP_SCHEMA, validateDefinition } from "./appdef_BTKTsCnS.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_DGSaVCvE.mjs";
import { p as preflight } from "./preflight_BT97NqXu.mjs";
