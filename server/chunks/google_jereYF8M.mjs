...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_DmOpR5Pi.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_C9Ybf-Xm.mjs";
const SCOPE_GROUPS = {
  calendar: {
