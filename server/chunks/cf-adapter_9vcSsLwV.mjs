...
import { setRetentionDays, setMaxUploadMb, fileBelongsTo, getFile, saveFile, storageMode } from "./storage_DpdH5p5l.mjs";
import { m as makeDocument, w as webSearch, b as summarizeTranscript, c as extractInvoiceData, t as transcribeAudio, i as inferApp } from "./media-ai_CbNUsUzL.mjs";
import { googleFetch } from "./google_DAnsDJ3a.mjs";
import { getApiKey, entitlementForGate } from "./client_mgVrvX2Z.mjs";
...
import { permissionCatalogText, installedAppIds, appCatalog, installApp, uninstallApp } from "./apps_BwLwnmlD.mjs";
import { v as validateDefinition, A as APP_SCHEMA, R as RENDER_HTML_MAX, o as opCatalogText } from "./appdef_FywQemou.mjs";
...
import { a2aHost, callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_BNpt8EXb.mjs";
import { searchDirectory } from "./directory_DviBAuWT.mjs";
import { setAutonomy, autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_BJnrF_6J.mjs";
import { logDiag } from "./diag_B7sefss8.mjs";
import { i as isRunnableDefinition } from "./preflight_RVI1vb0r.mjs";
...
import { m as createDraft, g as getAppDesign, n as getAppMeta, o as setAppMeta, q as suggestAppMeta, t as setAppAllowedRoles, b as listExternalApps, v as installedAppDefs, w as appsBrief } from "./external-apps_WS9MhPJy.mjs";
...
import "./index_DtI5QjU2.mjs";
import { listSkills, runSkill, generateSkill } from "./skills_C080gmVv.mjs";
import { c as runInstalledApp, r as runDraftApp, b as appRunNeedsApproval, a as authorizeAppRun } from "./app-runtime_CdUAGt5U.mjs";
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from "./capabilities_XiiAiJAb.mjs";
import { overBudget, recordUsage, estimateUsd, recordTokens } from "./usage_D3RuFGmp.mjs";
import { setApprovalMode, getApprovalMode, createApproval, A2A_OUTWARD, previewFor } from "./approvals_dE95gvdX.mjs";
import { setCustomDomain } from "./custom-domain_0fz0VPJf.mjs";
import { createInvite, approveUser, setRole, activeAdminCount, rejectUser, deleteUser, listUsers } from "./users_TBwo4v8p.mjs";
import { listActions, createAction, deleteAction, updateAction } from "./a2a-actions_BzV0PwDM.mjs";
import { p as pushToUser } from "./push_CJY2BueA.mjs";
