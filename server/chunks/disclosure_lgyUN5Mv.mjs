...
import { googleStatus, SCOPE_GROUPS } from "./google_DvQoLsEb.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BPQd_5aE.mjs";
import { getRetentionDays } from "./storage_CpD6nnHA.mjs";
const LIMITED_USE = [
