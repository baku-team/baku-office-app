...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_CyRmMA6L.mjs";
import { n as nowSec } from "./accounting_BipJ8jvJ.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_C7zn0crz.mjs";
const SCOPE_GROUPS = {
  calendar: {
