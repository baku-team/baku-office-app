...
import { googleStatus, SCOPE_GROUPS } from "./google_CDJJUUzX.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_GcjRF9RO.mjs";
import { getRetentionDays } from "./storage_CzB15Zqw.mjs";
const LIMITED_USE = [
