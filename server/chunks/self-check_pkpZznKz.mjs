...
import { APP_SCHEMA, validateDefinition } from "./appdef_Bm7gf-0K.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_Cp-oPbDk.mjs";
import { p as preflight } from "./preflight_d1Ums5jP.mjs";
