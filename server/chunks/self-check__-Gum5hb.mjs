...
import { APP_SCHEMA, validateDefinition } from "./appdef_CFwTTtdH.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_DMCgfXnA.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_BKYtLCd6.mjs");
