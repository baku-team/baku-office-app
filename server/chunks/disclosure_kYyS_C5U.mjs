...
import { googleStatus, SCOPE_GROUPS } from "./google_OENwjbIy.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DzDhNcts.mjs";
import { getRetentionDays } from "./storage_Cc5JIPVQ.mjs";
const LIMITED_USE = [
