...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BAVQqvb3.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_CHfKjn8b.mjs";
const SCOPE_GROUPS = {
  calendar: {
