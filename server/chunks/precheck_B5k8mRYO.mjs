...
import { validateDefinition } from "./appdef_BWuyKLhN.mjs";
import { g as getAppDesign } from "./external-apps_B45zdqU6.mjs";
import { p as preflight } from "./preflight_BowEflmt.mjs";
import { r as runDraftApp } from "./app-runtime_DUL4FeEs.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_B45zdqU6.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
