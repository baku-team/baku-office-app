...
import { googleStatus, SCOPE_GROUPS } from "./google_IXW9AIYQ.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BYTVEltU.mjs";
import { getRetentionDays } from "./storage_K1qefTQL.mjs";
const LIMITED_USE = [
