...
import { setMaxUploadMb, setRetentionDays } from "./storage_CxiQNFHb.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_8JOsEvWt.mjs";
import { setStorageLimits } from "./storage-usage_D5P-Ka9J.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_BT_VA6pC.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_Dbevb6hy.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_oK6wYgQs.mjs");
