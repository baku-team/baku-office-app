...
import { googleStatus, SCOPE_GROUPS } from "./google_CGqlwjUb.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DWpc94yf.mjs";
import { getRetentionDays } from "./storage_eLhCSUGc.mjs";
const LIMITED_USE = [
