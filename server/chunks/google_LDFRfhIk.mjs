...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_vij6I9Jq.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_DvNP8Nck.mjs";
const SCOPE_GROUPS = {
  calendar: {
