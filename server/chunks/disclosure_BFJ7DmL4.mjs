...
import { googleStatus, SCOPE_GROUPS } from "./google_Dr8xgTaY.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_88MMJgK4.mjs";
import { getRetentionDays } from "./storage_BpMEfKKE.mjs";
const LIMITED_USE = [
