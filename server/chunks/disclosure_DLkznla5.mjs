...
import { googleStatus, SCOPE_GROUPS } from "./google_D5EtcQ9X.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_Bv2rFnMu.mjs";
import { getRetentionDays } from "./storage_CSR2WvVx.mjs";
const LIMITED_USE = [
