...
import { validateDefinition } from "./appdef_1-F7SXGY.mjs";
import { g as getAppDesign } from "./external-apps_B8UBajsg.mjs";
import { p as preflight } from "./preflight_CcnkXJfr.mjs";
import { r as runDraftApp } from "./app-runtime_Bx_tsk5y.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_B8UBajsg.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
