...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_PSBt_dAs.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_Bv2rFnMu.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_Dx3QJnKH.mjs"),
    import("./scheduled-tasks_Chq0rheS.mjs")
  ]);
