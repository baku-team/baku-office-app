...
import { entitlementForGate, getApiKey } from "./client_Cm6c2326.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_D635SfcA.mjs";
import { searchDirectory } from "./directory_DizgfEB_.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_Xy0bMs3x.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_C38zwQKE.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_Ccwtffmz.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_BPiBfYpT.mjs";
import { createDraft } from "./external-apps_Czt0ODSr.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_88MMJgK4.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_pnaiZOyL.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_Cm6c2326.mjs");
