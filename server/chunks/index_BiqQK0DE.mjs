...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_sRscislI.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_CsMC_79r.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_Bfwp1C8W.mjs"),
    import("./scheduled-tasks_7tdbENNz.mjs")
  ]);
  ...
  await import("./index_BJcJsswH.mjs");
