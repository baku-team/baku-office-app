...
import { googleStatus, SCOPE_GROUPS } from "./google_B8Y8Hi05.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BMo1S9wt.mjs";
import { getRetentionDays } from "./storage_CmFAV3Wf.mjs";
const LIMITED_USE = [
