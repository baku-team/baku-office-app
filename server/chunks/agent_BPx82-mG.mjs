...
import { entitlementForGate, getApiKey } from "./client_BZPpVhKD.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_BxXHxmCr.mjs";
import { searchDirectory } from "./directory_CDJutJVx.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_Dst-rRxs.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_BSErZPDT.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_uAvAPspo.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_CnYi_RAK.mjs";
import { createDraft } from "./external-apps_DrovB8Nb.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_D4FpV5BK.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_yKbvv-JH.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_BZPpVhKD.mjs");
