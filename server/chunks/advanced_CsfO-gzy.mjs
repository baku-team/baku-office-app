...
const $$Advanced = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const entitlement = await (await import("./client_K_W-4z9g.mjs")).cachedEntitlement(env);
  ...
  const { getAutonomyConfig, ghDeviceAvailable } = await import("./autonomy_DIfeYUj4.mjs");
  ...
  const { hasApiKey } = await import("./client_K_W-4z9g.mjs");
  ...
  const { storageMode, maxUploadMb } = await import("./storage_BU1BbtLn.mjs");
