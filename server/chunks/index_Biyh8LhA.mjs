...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_DlpdsadF.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_B9wOpFrA.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_D-_59EQd.mjs"),
    import("./scheduled-tasks_CeYVLMj-.mjs")
  ]);
