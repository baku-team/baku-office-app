...
import { googleStatus, SCOPE_GROUPS } from "./google_BA44zWxK.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_txgzfJXR.mjs";
import { getRetentionDays } from "./storage_BZM8Ok-T.mjs";
const LIMITED_USE = [
