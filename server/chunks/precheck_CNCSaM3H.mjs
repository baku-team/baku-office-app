...
import { getSession, canDevelopApps } from "./auth_D3ppHoJV.mjs";
import { l as loadDraft, c as checkDefinition, a as checkTransitions, b as checkSandbox, d as checkFabrication, e as checkRun, f as finalizePrecheck } from "./precheck_CqVWZc8T.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_C3f4hWKe.mjs").then((n) => n.D)).recheckDraft(ctx, draftId);
  } catch {
  }
