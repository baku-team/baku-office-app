...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_B06zZZvw.mjs";
import { n as nowSec } from "./accounting_BipJ8jvJ.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_CViYiSH8.mjs";
const SCOPE_GROUPS = {
  calendar: {
