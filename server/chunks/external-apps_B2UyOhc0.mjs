...
import { getToken, hostFetch, getVerifyJwk } from "./client_Wma9rw14.mjs";
import { r as randomId, v as verifyEnvelope, i as importVerifyKey, p as payloadOf } from "./stripe_r-RFTlbb.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { p as preflight, i as isRunnableDefinition } from "./preflight_DNLmay0L.mjs";
import { s as sanitizeRenderHtml, v as validateDefinition } from "./appdef_B8AQs2ti.mjs";
const MAX_TAGS = 8;
...
async function deleteLocalApp(ctx, appId, deleteData = false) {
  ...
  await (await import("./public-pages_nVpmJrxF.mjs")).deletePublicPagesByApp(ctx.env, appId).catch(() => {
  });
