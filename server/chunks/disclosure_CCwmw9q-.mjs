...
import { googleStatus, SCOPE_GROUPS } from "./google_I0y18Q-r.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DDmgSIQr.mjs";
import { getRetentionDays } from "./storage_D6LLPvBw.mjs";
const LIMITED_USE = [
