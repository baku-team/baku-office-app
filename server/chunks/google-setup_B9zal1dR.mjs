...
import { r as renderComponent } from "./worker-entry__7ztzzTH.mjs";
import { env } from "cloudflare:workers";
import { $ as $$App } from "./App_hEiObwMy.mjs";
...
const $$GoogleSetup = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { getSession } = await import("./auth_BpHW5W0y.mjs");
  const ses = await getSession(env, Astro2.request);
  if (!ses) return Astro2.redirect("/login", 302);
  const isAdmin = ses.role === "admin";
  const { googleConfigured, googleStatus, SCOPE_GROUPS } = await import("./google_WOEp-dug.mjs");
  const configured = isAdmin ? await googleConfigured(env) : false;
  const { getServiceAccountInfo } = await import("./google-sa_B6QIkQei.mjs");
  const saInfo = isAdmin ? await getServiceAccountInfo(env).catch(() => null) : null;
  const { driveConfigured, driveStatus } = await import("./drive_TKcxAmMF.mjs");
  ...
  const dstat = isAdmin ? await driveStatus(env).catch(() => ({ read: false, write: false, via: null })) : { read: false, via: null };
  const driveReady = dstat.read;
  const driveViaLabel = dstat.via === "workspace" ? "Workspace（WIF）" : dstat.via === "oauth" ? "Google アカウント（OAuth）" : dstat.via === "both" ? "WIF＋OAuth" : "";
  ...
  const { randomId } = await import("./ctx_DXZLzw9T.mjs").then((n) => n.K);
  const handoffToken = isAdmin ? randomId(16) : "";
  ...
  return renderTemplate`${renderComponent($$result, "App", $$App, { "title": "Google連携セットアップ", "active": "/settings", "data-astro-cid-v63rqogn": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<h1 data-astro-cid-v63rqogn>Google 連携セットアップ（Google Workspace・WIF）</h1> ${!isAdmin && renderTemplate`<div class="card" data-astro-cid-v63rqogn><div class="banner banner-warn" data-astro-cid-v63rqogn>この画面は管理者のみ利用できます。</div></div>`}${isAdmin && renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": async ($$result3) => renderTemplate`<p style="margin:.2rem 0 .6rem;font-weight:700;font-size:1.02rem" data-astro-cid-v63rqogn>まず、お使いの Google アカウントで選んでください</p> <div class="gpick" data-astro-cid-v63rqogn> <a class="gpick-c gpick-rec" href="#sa-wizard" data-astro-cid-v63rqogn> <div class="gpick-h" data-astro-cid-v63rqogn><span class="gpick-badge ok" data-astro-cid-v63rqogn>おすすめ</span>会社・団体で使っている方</div> <div class="gpick-d" data-astro-cid-v63rqogn>独自ドメインの <strong data-astro-cid-v63rqogn>Google Workspace（有料）</strong>をお使いなら</div> <div class="gpick-pick" data-astro-cid-v63rqogn>→ ① <strong data-astro-cid-v63rqogn>WIF</strong>（この画面の上から）</div> <div class="gpick-why" data-astro-cid-v63rqogn>メンバー全員ぶんをまとめて AI に任せられます。</div> </a> <a class="gpick-c" href="#goauth" data-astro-cid-v63rqogn> <div class="gpick-h" data-astro-cid-v63rqogn><span class="gpick-badge" data-astro-cid-v63rqogn>かんたん</span>個人で使っている方</div> <div class="gpick-d" data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>無料の Gmail アカウント</strong>（@gmail.com など）をお使いなら</div> <div class="gpick-pick" data-astro-cid-v63rqogn>→ ② <strong data-astro-cid-v63rqogn>OAuth</strong>（この画面の下から）</div> <div class="gpick-why" data-astro-cid-v63rqogn>ご自身ひとり分のデータを、すぐに連携できます。</div> </a> </div> <p class="muted" style="font-size:.8rem;margin:.1rem 0 .8rem" data-astro-cid-v63rqogn>
ざっくり言うと——<strong data-astro-cid-v63rqogn>WIF＝みんなの分をまとめて</strong>（会社向け）、<strong data-astro-cid-v63rqogn>OAuth＝自分ひとり分だけ</strong>（個人向け）。なお Gemini／Claude／LINE 等の API キーは <a href="/settings/keys" data-astro-cid-v63rqogn>連携設定（APIキー）</a> です。
</p><div class="banner banner-info" data-astro-cid-v63rqogn> <strong data-astro-cid-v63rqogn>Google Workspace のサービスアカウント連携（WIF）</strong>です（<strong data-astro-cid-v63rqogn>キーレス＝鍵を発行しません</strong>。組織ポリシーで鍵作成が禁止されていても使えます）。下のステップを<strong data-astro-cid-v63rqogn>上から順に</strong>進めてください（<strong data-astro-cid-v63rqogn>Cloud Shell でほぼ自動</strong>・残る手動は管理コンソールでの委任承認1回のみ）。
</div> ${configured ? renderTemplate`<div class="banner banner-ok" data-astro-cid-v63rqogn>すでに Google 連携は設定済みです。各機能の連携は <a href="/calendar" data-astro-cid-v63rqogn>カレンダー</a> / <a href="/gmail" data-astro-cid-v63rqogn>Gmail</a> / <a href="/meet" data-astro-cid-v63rqogn>Meet</a> の画面から行えます。</div>` : renderTemplate`<div class="banner banner-warn" data-astro-cid-v63rqogn>未設定です。下のステップで設定してください。</div>`}<div data-astro-cid-v63rqogn> <div id="sa-wizard"${addAttribute(saInfo ? "1" : "0", "data-configured")}${addAttribute(handoffToken, "data-handoff")} data-astro-cid-v63rqogn> <section class="wstep" data-step="1" data-astro-cid-v63rqogn> <header class="wstep-h" data-astro-cid-v63rqogn><span class="wstep-n" data-astro-cid-v63rqogn>1</span><span class="wstep-t" data-astro-cid-v63rqogn>Google Cloud で準備（Cloud Shell）</span><span class="wstep-badge" data-astro-cid-v63rqogn></span></header> <div class="wstep-b" data-astro-cid-v63rqogn> <p class="muted" data-astro-cid-v63rqogn>ブラウザ内のターミナル <strong data-astro-cid-v63rqogn>Cloud Shell</strong> で、プロジェクト作成・API有効化・サービスアカウント作成・WIF 設定までを自動で行います（ログイン済み・インストール不要）。</p> <div class="field" data-astro-cid-v63rqogn><label data-astro-cid-v63rqogn>① 実行コマンド（自動でコピーされます）</label><div class="row" data-astro-cid-v63rqogn><input id="wif-cmd" type="text" readonly${addAttribute(wifCommand, "value")} style="flex:1;font-family:monospace;font-size:.78rem" data-astro-cid-v63rqogn><button class="btn" id="copy-wif-cmd" type="button" data-astro-cid-v63rqogn>コピー</button></div><div class="muted small" data-astro-cid-v63rqogn>先頭の <code data-astro-cid-v63rqogn>WORKER_URL</code> はこの画面のURLから自動設定済み。下のボタンで開くと<strong data-astro-cid-v63rqogn>このコマンドが自動でコピー</strong>されます。</div></div> <a class="btn btn-primary" id="open-cloudshell"${addAttribute(cloudshellUrl, "href")} target="_blank" rel="noopener" style="margin-top:.5rem" data-astro-cid-v63rqogn>② コマンドをコピーして Cloud Shell を開く ↗</a> <p class="muted small" style="margin-top:.7rem" data-astro-cid-v63rqogn>開いた後の操作（3つだけ）：</p> <ol class="dwd-steps" data-astro-cid-v63rqogn> <li data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>「Authorize（承認）」</strong> が出たらクリック（<strong data-astro-cid-v63rqogn>出ないこともあります。出なければそのまま次へ</strong>進んでください）</li> <li data-astro-cid-v63rqogn>ターミナルで <strong data-astro-cid-v63rqogn>Ctrl+V / Cmd+V</strong> で貼り付け（コマンドはコピー済み）</li> <li data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>「Enter」キー</strong>を押す（貼り付けただけでは実行されません）</li> <li data-astro-cid-v63rqogn>自動で進み、完了すると <strong data-astro-cid-v63rqogn>WIF設定が自動で baku-office へ送信</strong>されます（コピー不要）</li> <li data-astro-cid-v63rqogn>このタブ（baku-office）に戻ると、下の<strong data-astro-cid-v63rqogn>手順2</strong>に<strong data-astro-cid-v63rqogn>自動入力</strong>されます（入らない場合のみ手動で貼り付け）</li> </ol> <details class="adv" style="margin-top:6px" data-astro-cid-v63rqogn><summary data-astro-cid-v63rqogn>自分の端末の gcloud で実行する場合</summary> <pre style="background:#0f172a;color:#e2e8f0;padding:.8rem;border-radius:8px;overflow:auto;font-size:.8rem" data-astro-cid-v63rqogn><code data-astro-cid-v63rqogn>gcloud auth login
${wifCommand.replace("bash ", "bash scripts/")}</code></pre> </details> <div class="wstep-nav" data-astro-cid-v63rqogn><button class="btn btn-primary" type="button" data-next="2" data-astro-cid-v63rqogn>準備ができた → 次へ</button></div> </div> </section> <section class="wstep" data-step="2" data-astro-cid-v63rqogn> <header class="wstep-h" data-astro-cid-v63rqogn><span class="wstep-n" data-astro-cid-v63rqogn>2</span><span class="wstep-t" data-astro-cid-v63rqogn>WIF設定を登録</span><span class="wstep-badge" data-astro-cid-v63rqogn></span></header> <div class="wstep-b" data-astro-cid-v63rqogn> <p class="muted" data-astro-cid-v63rqogn>Cloud Shell の完了時に <strong data-astro-cid-v63rqogn>WIF設定が自動コピー</strong>されています。下の欄をクリックして貼り付け（Ctrl+V / Cmd+V）してください。</p> <div class="field" data-astro-cid-v63rqogn><label for="sa-wif" data-astro-cid-v63rqogn>WIF設定（JSON）</label><textarea id="sa-wif" rows="3"${addAttribute('{ "sa_email": "...", "client_id": "...", "project_number": "...", "pool": "...", "provider": "..." }', "placeholder")} style="width:100%;font-family:monospace;font-size:.78rem" data-astro-cid-v63rqogn></textarea><div class="muted small" data-astro-cid-v63rqogn>うまく貼れない場合は Cloud Shell 出力の「┌─ … └─」の間の 1 行をコピーしてください。</div></div> <div class="field" data-astro-cid-v63rqogn><label for="sa-subject" data-astro-cid-v63rqogn>代理するユーザーのメール（Workspace）</label><input id="sa-subject" type="email" placeholder="admin@yourdomain.co.jp"${addAttribute(saInfo?.subject ?? orgEmail, "value")} autocomplete="off" data-astro-cid-v63rqogn><div class="muted small" data-astro-cid-v63rqogn>${orgEmail && !saInfo ? `ログイン中の団体アカウント（${orgEmail}）を既定表示しています。別ユーザーを代理させる場合は変更してください。` : "予定/メールを操作する Workspace ユーザーのメール。"}</div></div> <fieldset style="border:1px solid var(--line);border-radius:6px;padding:.5rem .8rem" data-astro-cid-v63rqogn> <legend class="muted" style="font-size:.85rem" data-astro-cid-v63rqogn>利用する機能（委任するスコープ）</legend> ${groupList.map((g) => renderTemplate`<label style="display:block;margin:.2rem 0" data-astro-cid-v63rqogn><input type="checkbox" class="sa-grp"${addAttribute(g.id, "value")}${addAttribute(g.scopes, "data-scopes")} checked data-astro-cid-v63rqogn> ${g.label}</label>`)} </fieldset> <div class="wstep-nav" data-astro-cid-v63rqogn><button class="btn btn-primary" id="sa-go" data-astro-cid-v63rqogn>① 設定を登録</button></div> <div id="sa-result" style="margin-top:.5rem" data-astro-cid-v63rqogn></div> </div> </section> <section class="wstep" data-step="3" data-astro-cid-v63rqogn> <header class="wstep-h" data-astro-cid-v63rqogn><span class="wstep-n" data-astro-cid-v63rqogn>3</span><span class="wstep-t" data-astro-cid-v63rqogn>ドメイン全体の委任を承認</span><span class="wstep-badge" data-astro-cid-v63rqogn></span></header> <div class="wstep-b" data-astro-cid-v63rqogn> <div class="banner banner-warn small" data-astro-cid-v63rqogn>この手順だけは <strong data-astro-cid-v63rqogn>Google Workspace の超管理者</strong> の操作が必要です（Google がセキュリティ上、人による承認を必須にしているため省略できません・反映に1〜2分かかります）。</div> <p class="muted" data-astro-cid-v63rqogn>下の2つの値を使います（右の「コピー」で取得）。</p> <div class="field" data-astro-cid-v63rqogn><label data-astro-cid-v63rqogn>クライアントID</label><div class="row" data-astro-cid-v63rqogn><input id="sa-cid" type="text" readonly${addAttribute(saInfo?.clientId ?? "（手順2を登録すると表示されます）", "value")} style="flex:1;font-family:monospace;font-size:.82rem" data-astro-cid-v63rqogn><button class="btn" id="sa-copy-cid" type="button"${addAttribute(!saInfo, "disabled")} data-astro-cid-v63rqogn>コピー</button></div></div> <div class="field" data-astro-cid-v63rqogn><label data-astro-cid-v63rqogn>OAuth スコープ（カンマ区切り）</label><div class="row" data-astro-cid-v63rqogn><input id="sa-scopes" type="text" readonly value="" style="flex:1;font-family:monospace;font-size:.78rem" data-astro-cid-v63rqogn><button class="btn" id="sa-copy-scopes" type="button" data-astro-cid-v63rqogn>コピー</button></div></div> <a class="btn btn-primary" href="https://admin.google.com/ac/owl/domainwidedelegation" target="_blank" rel="noopener" data-astro-cid-v63rqogn>ドメイン全体の委任の設定を開く ↗</a> <ol class="dwd-steps" data-astro-cid-v63rqogn> <li data-astro-cid-v63rqogn>開いた画面（「<strong data-astro-cid-v63rqogn>API クライアント</strong>」のドメイン全体の委任）で <strong data-astro-cid-v63rqogn>「新しく追加」</strong> をクリック</li> <li data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>「クライアント ID」</strong> 欄に、上の<strong data-astro-cid-v63rqogn>クライアントID</strong>を貼り付け</li> <li data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>「OAuth スコープ（カンマ区切り）」</strong> 欄に、上の<strong data-astro-cid-v63rqogn>スコープ</strong>を貼り付け</li> <li data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>「承認」</strong>（または「Authorize」）をクリック</li> <li data-astro-cid-v63rqogn>一覧に追加されれば完了（反映まで1〜2分待つことがあります）</li> </ol> <div class="wstep-nav" data-astro-cid-v63rqogn><button class="btn btn-primary" type="button" data-next="4" data-astro-cid-v63rqogn>承認した → 次へ</button></div> </div> </section> <section class="wstep" data-step="4" data-astro-cid-v63rqogn> <header class="wstep-h" data-astro-cid-v63rqogn><span class="wstep-n" data-astro-cid-v63rqogn>4</span><span class="wstep-t" data-astro-cid-v63rqogn>連携を確認</span><span class="wstep-badge" data-astro-cid-v63rqogn></span></header> <div class="wstep-b" data-astro-cid-v63rqogn> <p class="muted" data-astro-cid-v63rqogn>承認が反映されたら、下のボタンで実際に接続できるかを確認します（手順3の承認直後は1〜2分かかることがあります）。</p> <button class="btn btn-primary" id="sa-test" data-astro-cid-v63rqogn>② 連携を確認</button> <div id="sa-test-result" style="margin-top:.5rem" data-astro-cid-v63rqogn></div> <div class="row" style="margin-top:1rem" data-astro-cid-v63rqogn><button class="btn btn-ghost" id="sa-disconnect" type="button"${addAttribute(!saInfo, "hidden")} data-astro-cid-v63rqogn>連携を解除</button><button class="btn btn-ghost" id="sa-restart" type="button" data-astro-cid-v63rqogn>最初から設定し直す</button></div> </div> </section> </div> </div> <h2 style="margin-top:1.8rem" data-astro-cid-v63rqogn>Google ドライブの取り込み</h2> <p class="muted" data-astro-cid-v63rqogn>ドライブのファイルを <a href="/import" data-astro-cid-v63rqogn>書類の取り込み</a> で使えるようにします。<strong data-astro-cid-v63rqogn>専用の連携作業は不要</strong>です——上の <strong data-astro-cid-v63rqogn>①WIF</strong> か下の <strong data-astro-cid-v63rqogn>②OAuth</strong> で「<strong data-astro-cid-v63rqogn>ドライブ</strong>」を選べば、そのまま使えます。</p> <div class="dstate" data-astro-cid-v63rqogn> <div class="dstate-row" data-astro-cid-v63rqogn><span${addAttribute(driveReady ? "di ok" : "di no", "class")} data-astro-cid-v63rqogn>${driveReady ? "✓" : "—"}</span><span data-astro-cid-v63rqogn>取り込みの利用：<strong data-astro-cid-v63rqogn>${driveReady ? "使えます" : "未設定"}</strong>${driveReady && driveViaLabel ? `（${driveViaLabel} 経由）` : ""}</span></div> </div> ${driveReady ? renderTemplate`<div class="banner banner-ok" data-astro-cid-v63rqogn>ドライブを取り込めます。<a href="/drive" data-astro-cid-v63rqogn>ドライブ画面</a>で「メタ情報を同期」→ <a href="/import" data-astro-cid-v63rqogn>書類の取り込み</a>で取り込んでください。</div>` : renderTemplate`<div class="banner banner-info" data-astro-cid-v63rqogn>
まだドライブは使えません。次の<strong data-astro-cid-v63rqogn>どちらか</strong>で「ドライブ」を有効にしてください（別々に連携する必要はありません）：
<ul class="dwd-steps" style="margin-top:.4rem" data-astro-cid-v63rqogn> <li data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>会社・団体（WIF）の方</strong>：上の<strong data-astro-cid-v63rqogn>手順2</strong>で利用機能の「ドライブ」にチェック →（手順3で）委任承認。</li> <li data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>個人（OAuth）の方</strong>：下の<strong data-astro-cid-v63rqogn>「Google アカウントで連携」</strong>で「ドライブ」にチェックして連携。</li> </ul> </div>`}<h2 id="goauth" style="margin-top:1.8rem" data-astro-cid-v63rqogn>個人向け：Google アカウントで連携（OAuth）</h2> <p class="muted" data-astro-cid-v63rqogn>
基本は<strong data-astro-cid-v63rqogn>上の Workspace 連携（WIF）</strong>です。Cloud Shell の設定が難しい場合や、Workspace を使わない場合の<strong data-astro-cid-v63rqogn>代替</strong>として、<strong data-astro-cid-v63rqogn>団体の管理者 Google アカウント</strong>で標準的な OAuth 連携ができます。<strong data-astro-cid-v63rqogn>カレンダー／Meet／ドライブ／Gmail</strong> に対応します。
</p> <div class="banner banner-info" style="font-size:.88rem" data-astro-cid-v63rqogn> <strong data-astro-cid-v63rqogn>かんたんに言うと：</strong>会社・団体（Workspace・有料）の方は <strong data-astro-cid-v63rqogn>WIF</strong>＝メンバー<strong data-astro-cid-v63rqogn>みんなの分</strong>をまとめて AI に任せられます。個人（無料の Gmail）の方は <strong data-astro-cid-v63rqogn>OAuth</strong>＝<strong data-astro-cid-v63rqogn>自分ひとり分</strong>を連携できます。下の表は両者の違いの詳細です。
</div> <div class="gcmp" data-astro-cid-v63rqogn> <table class="gcmp-t" data-astro-cid-v63rqogn> <thead data-astro-cid-v63rqogn><tr data-astro-cid-v63rqogn><th data-astro-cid-v63rqogn></th><th data-astro-cid-v63rqogn>① Workspace 連携（WIF）<span class="gcmp-tag ok" data-astro-cid-v63rqogn>基本</span></th><th data-astro-cid-v63rqogn>② Google アカウント連携（OAuth）<span class="gcmp-tag" data-astro-cid-v63rqogn>代替</span></th></tr></thead> <tbody data-astro-cid-v63rqogn> <tr data-astro-cid-v63rqogn><th data-astro-cid-v63rqogn>誰のデータを<br data-astro-cid-v63rqogn>扱えるか</th><td data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>団体メンバー全員</strong>を代理操作可。<br data-astro-cid-v63rqogn><span class="gcmp-ex" data-astro-cid-v63rqogn>例：田中さん・鈴木さん両方の予定を見て会議を設定／退職者のメールを本人不在でも確認</span></td><td data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>連携した本人1人のデータのみ</strong>。<br data-astro-cid-v63rqogn><span class="gcmp-ex" data-astro-cid-v63rqogn>例：管理者自身の予定・Gmail は扱えるが、他メンバーの予定は一切見えない</span></td></tr> <tr data-astro-cid-v63rqogn><th data-astro-cid-v63rqogn>メンバーが<br data-astro-cid-v63rqogn>増えたとき</th><td data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>追加設定ゼロ</strong>。承認済みなら新入社員も自動で対象。<br data-astro-cid-v63rqogn><span class="gcmp-ex" data-astro-cid-v63rqogn>例：4月に10人入社しても、各人の操作は不要</span></td><td data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>1人ずつ個別に連携が必要</strong>。<br data-astro-cid-v63rqogn><span class="gcmp-ex" data-astro-cid-v63rqogn>例：新メンバーごとに本人がOAuth同意し直す</span></td></tr> <tr data-astro-cid-v63rqogn><th data-astro-cid-v63rqogn>エージェント<br data-astro-cid-v63rqogn>用途の適性</th><td data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>団体横断の自動化に最適</strong>。<br data-astro-cid-v63rqogn><span class="gcmp-ex" data-astro-cid-v63rqogn>例：全員の空きを見て日程調整、各人宛メールをAIが下書き、議事録を全会議から収集</span></td><td data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>個人用・単一アカウント向き</strong>。<br data-astro-cid-v63rqogn><span class="gcmp-ex" data-astro-cid-v63rqogn>例：自分の予定整理、自分のメール下書きまで</span></td></tr> <tr data-astro-cid-v63rqogn><th data-astro-cid-v63rqogn>初期設定</th><td data-astro-cid-v63rqogn>Cloud Shell ＋ 管理コンソールで委任承認（1回）。やや手間だが以後は不要。</td><td data-astro-cid-v63rqogn>OAuth クライアント作成＋同意のみ。Cloud Shell 不要で手軽。</td></tr> <tr data-astro-cid-v63rqogn><th data-astro-cid-v63rqogn>必要な権限</th><td data-astro-cid-v63rqogn><strong data-astro-cid-v63rqogn>Google Workspace ＋ 特権管理者</strong>（委任承認のため）。Workspace 無しでは使えません。</td><td data-astro-cid-v63rqogn>管理者でなくても可。Workspace が無くても（個人Gmailでも）使えます。</td></tr> <tr data-astro-cid-v63rqogn><th data-astro-cid-v63rqogn>Google 審査</th><td data-astro-cid-v63rqogn>不要（サービスアカウント＝アプリ審査の対象外）。</td><td data-astro-cid-v63rqogn>Gmail／ドライブ等の機微スコープは<strong data-astro-cid-v63rqogn>審査対象</strong>。同意画面を「内部(Internal)」にすれば審査不要。</td></tr> <tr data-astro-cid-v63rqogn><th data-astro-cid-v63rqogn>鍵・更新</th><td data-astro-cid-v63rqogn>キーレス（鍵を発行しない）。失効リスクが小さい。</td><td data-astro-cid-v63rqogn>refresh_token を保持。<strong data-astro-cid-v63rqogn>本人のパスワード変更・権限取消で失効</strong>しうる。</td></tr> </tbody> </table> <p class="muted" style="font-size:.8rem;margin:.5rem 0 0" data-astro-cid-v63rqogn> <strong data-astro-cid-v63rqogn>OAuth の主なデメリット：</strong>連携した本人のデータに限られ、団体メンバー全員を横断する自動化はできない／メンバーごとに個別連携が必要／本人の Google 権限変更で失効しうる／Gmail・ドライブは Google 審査が必要（同意画面「内部」で回避可）。
</p> </div> <div class="banner banner-info" style="font-size:.85rem" data-astro-cid-v63rqogn> <strong data-astro-cid-v63rqogn>Gmail・ドライブ等の機微スコープ</strong>は Google の審査対象です。同じ Workspace 組織内だけで使うなら、OAuth 同意画面の<strong data-astro-cid-v63rqogn>ユーザーの種類を「内部（Internal）」</strong>にすると<strong data-astro-cid-v63rqogn>審査不要</strong>になります（外部公開アプリにする場合のみ審査が必要）。
</div> ${oauthConnected ? renderTemplate`<div class="banner banner-ok" data-astro-cid-v63rqogn>
...
先に <strong data-astro-cid-v63rqogn>OAuth クライアントID／シークレット</strong>を <a href="/settings/keys" data-astro-cid-v63rqogn>連携設定（APIキー）</a> で登録してください（Google Cloud の「APIとサービス → 認証情報」で作成。リダイレクトURIは <code data-astro-cid-v63rqogn>${Astro2.url.origin}/api/google/callback</code>）。
        ...
        (function () {
          ...
          if (handoff && wiz.dataset.configured !== "1") {
            let filled = false;
            const tick = async () => {
              if (filled) return;
              try {
