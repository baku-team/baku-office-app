...
import { googleStatus, SCOPE_GROUPS } from "./google_DiEBjPne.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_C1TyftTU.mjs";
import { getRetentionDays } from "./storage_Cvzvo6pu.mjs";
const LIMITED_USE = [
