...
import { setMaxUploadMb, setRetentionDays } from "./storage_BbJRuC4n.mjs";
import { setAiEngine, setWorkersAiModel, setBookkeepingMode, setCustomPrompt, setNotifyWebhook, setWorkersPaid } from "./settings_j1AROY7x.mjs";
import { setAutonomy, saveAutonomyConfig } from "./autonomy_C7Or1U9e.mjs";
import { setStorageLimits } from "./storage-usage_D0x6iHeS.mjs";
import { s as setEnabledPartIds, p as partCatalog, e as enabledPartIds } from "./parts_D1i9CXVc.mjs";
import { setTheme } from "./theme_DPHiRbLD.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_xFLd2b3e.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_PF1LwimL.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_C0FxI2g-.mjs");
