...
import { googleStatus, SCOPE_GROUPS } from "./google_CGR1ugZH.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_BiDkfFSy.mjs";
import { getRetentionDays } from "./storage_DV5PW-A4.mjs";
const LIMITED_USE = [
