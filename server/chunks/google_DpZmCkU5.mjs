...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_Cmhn0ct_.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_DLyyVPzV.mjs";
const SCOPE_GROUPS = {
  calendar: {
