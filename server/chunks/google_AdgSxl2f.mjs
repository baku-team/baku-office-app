...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BNfwKBey.mjs";
import { n as nowSec } from "./accounting_BipJ8jvJ.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_CHlUOG19.mjs";
const SCOPE_GROUPS = {
  calendar: {
