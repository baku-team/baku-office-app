...
import { googleStatus, SCOPE_GROUPS } from "./google_C21LUKSj.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_1ZlBbWQC.mjs";
import { getRetentionDays } from "./storage_B9Y_ZULI.mjs";
const LIMITED_USE = [
