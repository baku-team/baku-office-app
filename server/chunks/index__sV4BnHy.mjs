...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_-spfSM1I.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_xwffYkn2.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_ChySSoB-.mjs"),
    import("./scheduled-tasks_Cz7ggorm.mjs")
  ]);
