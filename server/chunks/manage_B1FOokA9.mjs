...
import { moderate, setPublicEnabled, setRegisterMode, getPublicPageAny, deletePublicPage } from "./public-pages_nVpmJrxF.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b.action === "rebuild") {
    ...
    const { rebuildPublicPage } = await import("./cf-adapter_96IoWiWF.mjs").then((n) => n.C);
