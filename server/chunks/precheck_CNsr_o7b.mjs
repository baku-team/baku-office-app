...
import { validateDefinition } from "./appdef_Bm7gf-0K.mjs";
import { g as getAppDesign } from "./external-apps_BeTYyH2S.mjs";
import { p as preflight } from "./preflight_d1Ums5jP.mjs";
import { r as runDraftApp } from "./app-runtime_DbXWXp_p.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_BeTYyH2S.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
