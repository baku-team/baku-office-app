...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_CXgE4FGk.mjs";
import { n as nowSec } from "./accounting_BipJ8jvJ.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_DkW3XfbM.mjs";
const SCOPE_GROUPS = {
  calendar: {
