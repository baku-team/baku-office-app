...
import { googleStatus, SCOPE_GROUPS } from "./google_BiYwH0Bk.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_xoQnZ-Ug.mjs";
import { getRetentionDays } from "./storage_B8-hnGVx.mjs";
const LIMITED_USE = [
