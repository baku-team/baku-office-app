...
import { getSession, canDevelopApps } from "./auth_CNSCg6Zs.mjs";
import { l as loadDraft, c as checkDefinition, a as checkTransitions, b as checkSandbox, d as checkFabrication, e as checkRun, f as finalizePrecheck } from "./precheck_D1fpXD0w.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_CZwKXiCg.mjs").then((n) => n.C)).recheckDraft(ctx, draftId);
  } catch {
  }
