...
import { validateDefinition } from "./appdef_CYElB2E7.mjs";
import { g as getAppDesign } from "./external-apps_3q9Cmcyt.mjs";
import { p as preflight } from "./preflight_D6feEOxF.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_D6qQ5_Ac.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_3q9Cmcyt.mjs").then((n) => n.z)).recheckDraft(ctx, draftId);
  } catch {
  }
