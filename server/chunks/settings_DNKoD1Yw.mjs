...
import { setMaxUploadMb, setRetentionDays } from "./storage_B0ooiN1b.mjs";
...
import { setAutonomy, saveAutonomyConfig } from "./autonomy_BKdZWV3m.mjs";
import { setStorageLimits } from "./storage-usage_T8hrbjzD.mjs";
...
import { installApp, uninstallApp, installedAppIds, appCatalog } from "./apps_Bd5lhL2K.mjs";
import { fetchAndInstall, uninstallExternal, listExternalApps, listDrafts, submitDraft, deleteDraft } from "./external-apps_CR2wNE1U.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "agent_approval") {
    const { setApprovalMode } = await import("./approvals_BCYYCqNo.mjs");
