...
import { entitlementForGate, getApiKey } from "./client_Dx3CMt_7.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_BEezImrg.mjs";
import { searchDirectory } from "./directory_BpBtGMRz.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_D6iItoV9.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_DUiQLzG_.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_DfetuwAq.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_D_sgBedd.mjs";
import { createDraft } from "./external-apps_Co6rxvy3.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_CQBv3XB_.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_CbvjHDq8.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_Dx3CMt_7.mjs");
