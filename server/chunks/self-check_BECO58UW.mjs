...
import { APP_SCHEMA, validateDefinition } from "./appdef_DkBpW8rV.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_8YmkCTHi.mjs";
import { p as preflight } from "./preflight_DvOhvy-f.mjs";
