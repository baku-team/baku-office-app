...
import { entitlementForGate, getApiKey } from "./client_icI3Uf5x.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_C3WfRTl-.mjs";
import { searchDirectory } from "./directory_BDOwJ2jo.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_BKdZWV3m.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_DymXVEW2.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_CV_oj2mJ.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_C17frjp1.mjs";
import { createDraft } from "./external-apps_CR2wNE1U.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_B4WBlRLS.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage__IUbXlIy.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_BCYYCqNo.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_icI3Uf5x.mjs");
