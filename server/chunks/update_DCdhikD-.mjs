...
const $$Update = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { pollHost, APP_VERSION } = await import("./client_BZYsk0AP.mjs");
  const { hasDeployHook, cmpVersion } = await import("./update_BSmliX-9.mjs");
