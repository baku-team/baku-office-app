...
import { APP_SCHEMA, validateDefinition } from "./appdef_BrFbYECV.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_ZgdMwRke.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_BsuDyowk.mjs");
