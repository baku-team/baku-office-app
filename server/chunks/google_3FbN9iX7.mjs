...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_BNXMhaMG.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_B2CQeuLi.mjs";
const SCOPE_GROUPS = {
  calendar: {
