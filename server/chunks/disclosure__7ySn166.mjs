...
import { googleStatus, SCOPE_GROUPS } from "./google_Z7RbyoZm.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_9RFhZMXX.mjs";
import { getRetentionDays } from "./storage_BlGYdbwv.mjs";
const LIMITED_USE = [
