...
import { v as validateDefinition } from "./appdef_FywQemou.mjs";
import { g as getAppDesign } from "./external-apps_WS9MhPJy.mjs";
import { p as preflight } from "./preflight_RVI1vb0r.mjs";
import { r as runDraftApp } from "./app-runtime_CdUAGt5U.mjs";
...
`));
  ...
  (async () => {
    try {
      ...
      await (await import("./diag_B7sefss8.mjs")).logDiag(env, "error", "precheck", `失敗(draft=${draftId}): ${msg}`).catch(() => {
      });
