...
import { entitlementForGate, getApiKey } from "./client_CyRmMA6L.mjs";
...
import { callPartner, groupRelayCall, callPublic, sendInquiry } from "./a2a_CJ3ige8R.mjs";
import { searchDirectory } from "./directory_CT3MxhqV.mjs";
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from "./autonomy_8JOsEvWt.mjs";
import { DEFAULT_MODELS, workersAiModelId, claudeModelId, geminiModelId } from "./config_BOdbJfMp.mjs";
import "./index_DaxO1ug-.mjs";
import { m as makeDocument, w as webSearch } from "./media-ai_BvwY-Sfp.mjs";
import { runSkill, generateSkill, listSkills } from "./skills_ZfVffNXr.mjs";
import { createDraft } from "./external-apps_Dbevb6hy.mjs";
import { videoStatusText, invokeCapability, listCapabilities, capabilitySummary } from "./capabilities_BkqwwsDM.mjs";
import { overBudget, recordUsage, recordTokens, estimateUsd } from "./usage_Uka2N290.mjs";
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from "./approvals_oK6wYgQs.mjs";
...
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import("./client_CyRmMA6L.mjs");
