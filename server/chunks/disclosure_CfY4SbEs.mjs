...
import { googleStatus, SCOPE_GROUPS } from "./google_CYqhOBPG.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_DJXqAaUw.mjs";
import { getRetentionDays } from "./storage_DXjZvHw0.mjs";
const LIMITED_USE = [
