...
import { c as createComponent, d as renderComponent, r as renderTemplate, g as createAstro, m as maybeRenderHead } from '../chunks/astro/server_DRI6mTND.mjs';
...
const $$Activate = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (code) {
    const { hostFetch, saveToken } = await import('../chunks/client_DjSYVqc9.mjs');
