...
import { cachedEntitlement, nowSec } from '../../chunks/client_DjSYVqc9.mjs';
...
import { ownedSession, createSession, getMessages, appendMessage, ensureTitle, toTurns } from '../../chunks/chat-sessions_Da7FtWJ1.mjs';
...
（添付ファイルを保存しました: file_id=${saved.id}。請求書/領収書なら register_invoice に file_id を渡して登録してください。）`;
  ...
  if (b.background) {
    ...
    const { enqueueAgentJob } = await import('../../chunks/agent-jobs_DNK28iqQ.mjs');
