...
import { entitlementForGate, getApiKey } from './client_DjSYVqc9.mjs';
import './crypto_D21r3Dwx.mjs';
import { atLeast } from './index_Cg172zdv.mjs';
import { toolsOf, enabledParts, enabledPartIds } from './parts_BZyWMuJn.mjs';
import { getAiEngine, getCustomPrompt, maxParallelAgents, agentMaxHops } from './settings_DSJfWsdt.mjs';
import { callPartner, groupRelayCall } from './a2a_DIPiwmJ6.mjs';
import { autonomyReady, AUTONOMY_TOOLS, runAutonomyTool, AUTONOMY_POLICY } from './autonomy_CKEyr57X.mjs';
import { D as DEFAULT_MODELS, o as overBudget, r as recordUsage, c as claudeModelId, g as geminiModelId, a as recordTokens, e as estimateUsd } from './usage_ClrX51CC.mjs';
import './index_DDI9b6m9.mjs';
import { a as makeDocument, w as webSearch } from './invoices_DUrRkHPD.mjs';
import { listSkills, runSkill, generateSkill } from './skills_ChuMVBl6.mjs';
import { createDraft } from './external-apps_BEIw-YML.mjs';
import { listCapabilities, capabilitySummary, videoStatusText, invokeCapability } from './capabilities_Bq8GiFu1.mjs';
import { getApprovalMode, previewFor, createApproval, A2A_OUTWARD } from './approvals_DvreX_Lk.mjs';
...
const UNATTENDED_BLOCK_MULTI = /* @__PURE__ */ new Set(["call_partner", "broadcast_group", "call_group_member"]);
async function runAgent(ctx, owner, text, image, baseUrl = "", role = "member", opts = {}) {
  ...
  const { disabledBuiltins } = await import('./client_DjSYVqc9.mjs');
...
${typeof r.result === "string" ? r.result : JSON.stringify(r.result)}` : `連携に失敗：${r.error ?? ""}`;
  ...
  await recordTokens(env, provider, usageAcc);
  return out;
}
...
export { runApprovedTool as a, lineReply as b, fetchLineImage as f, linePush as l, runAgent as r, verifyLineSignature as v };
