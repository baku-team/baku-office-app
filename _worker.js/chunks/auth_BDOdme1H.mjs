...
async function revokeSessions(env, uid) {
  await env.LICENSE.put(`${REVOKE_PREFIX}${uid}`, String(Math.floor(Date.now() / 1e3)), {
...
export { SESSION_DAYS, canAccess, clearSessionCookie, getSession, makeSessionCookie, requireOrgAdmin, revokeSessions, sameOrigin, sessionExp, signPending, verifyPending };
