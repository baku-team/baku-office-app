...
import { getApiKey, saveApiKey, deleteApiKey } from './client_DjSYVqc9.mjs';
...
async function googleAccessToken(env) {
  ...
  if (!r.ok) return null;
  await env.LICENSE.put(LAST_USED_KEY, String(nowSec()));
...
export { SCOPE_GROUPS, disconnectGoogle, exchangeGoogleCode, googleAccessToken, googleAuthUrl, googleConfigured, googleConnected, googleFetch, googleStatus, normalizeGroups };
