...
import { registeredParts, enabledPartIds, setEnabledPartIds } from './parts_BZyWMuJn.mjs';
import { disabledBuiltins } from './client_DjSYVqc9.mjs';
...
export { MANDATORY_APPS, appCatalog, installApp, installedAppIds, makeAppsApi, uninstallApp };
